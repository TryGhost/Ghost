...
shortcuts = {
    ...
    copyHTML: function (textEditor, selection) {
        ...
        if (selection.text) {
            ...
            generatedHTML = converter.makeHtml(textEditor.getValue());
        }

        // Talk to Ember
        textEditor.sendAction('openModal', 'copy-html', {generatedHTML: generatedHTML});
    },
...
TextEditorShortcuts = Ember.Mixin.create({
