...
Mindless.begin('Ghost edit draft flow works correctly', 8, function suite(test) {
...
//Mindless.begin('Ghost edit published flow works correctly', 6, function suite(test) {
//
//
//
//});