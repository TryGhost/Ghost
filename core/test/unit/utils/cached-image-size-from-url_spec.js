...
describe('getCachedImageSizeFromUrl', function () {
    ...
    it('should read from cache, if dimensions for image are fetched already', function () {
        ...
        return getCachedImageSizeFromUrl(url).then(function () {
    ...
    it('can handle image-size errors', function () {
        var url = 'http://mysite.com/content/image/mypostcoverimage.jpg';
    ...
    it('should return null if url is undefined', function () {
        var url = null,
            result;
