var config = require('../../../../server/config'),
    getAuthorFacebookUrl = require(config.paths.corePath + '/server/data/meta/author_fb_url'),
...
describe('getAuthorFacebookUrl', function () {
    ...
    it('should return null if context does not contain author facebook url and is a post', function () {
        var facebookUrl = getAuthorFacebookUrl({
            context: ['post'],
            post: {
                author: {
    ...
    it('should return author facebook url if author and has url', function () {
        var facebookUrl = getAuthorFacebookUrl({
            context: ['author'],
            author: {
                facebook: 'https://www.facebook.com/user'
    ...
    it('should return null if context does not contain author facebook url and is a author', function () {
        var facebookUrl = getAuthorFacebookUrl({
            context: ['author'],
            author: {
                facebook: ''
