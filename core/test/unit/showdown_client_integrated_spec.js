...
describe('Showdown client side converter', function () {
    ...
    describe('strike through - ~~strike me~~', function () {
    ...
    describe('GFM newline handling', function () {
    ...
    describe('GFM autolinking', function () {
    ...
    describe('Ghost Image Preview', function () {
