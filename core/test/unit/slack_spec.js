    ...
    slackObjNoUrl = JSON.stringify(
        {
            ...
            key: 'slack',
            value: '[{"url":"/", "channel":"", "username":"", "icon_emoji":":ghost:", "isActive":"true"}]',
            type: 'blog',
    ...
    slackObjWithUrl = JSON.stringify(
        {
            ...
            uuid: '50f50671-6e7c-4636-85e0-2962967764fa',
            key: 'slack',
            value: '[{"url":"https://hooks.slack.com/services/a-b-c-d", "channel":"", "username":"", "icon_emoji":":ghost:", "isActive":"true"}]',
            type: 'blog',
            created_at: '2016-04-06T15:19:19.492Z',
            created_by: 1,
            updated_at: '2016-04-06T15:19:19.492Z',
    ...
    slackObjNotActive = JSON.stringify(
        {
            ...
            uuid: '50f50671-6e7c-4636-85e0-2962967764fa',
            key: 'slack',
            value: '[{"url":"https://hooks.slack.com/services/a-b-c-d", "channel":"", "username":"", "icon_emoji":":ghost:", "isActive":"false"}]',
            type: 'blog',
            created_at: '2016-04-06T15:19:19.492Z',
            created_by: 1,
            updated_at: '2016-04-06T15:19:19.492Z',
    ...
    slackObjWithChannel = JSON.stringify(
        {
            ...
            uuid: '50f50671-6e7c-4636-85e0-2962967764fa',
            key: 'slack',
            value: '[{"url":"https://hooks.slack.com/services/a-b-c-d", "channel":"test-slack_", "username":"", "icon_emoji":":ghost:", "isActive":"true"}]',
            type: 'blog',
            created_at: '2016-04-06T15:19:19.492Z',
            created_by: 1,
            updated_at: '2016-04-06T15:19:19.492Z',
    ...
    slackObjWithUser = JSON.stringify(
        {
            ...
            uuid: '50f50671-6e7c-4636-85e0-2962967764fa',
            key: 'slack',
            value: '[{"url":"https://hooks.slack.com/services/a-b-c-d", "channel":"", "username":"webhookbot", "icon_emoji":":ghost:", "isActive":"true"}]',
            type: 'blog',
            created_at: '2016-04-06T15:19:19.492Z',
            created_by: 1,
            updated_at: '2016-04-06T15:19:19.492Z',
