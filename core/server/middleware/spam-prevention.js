...
spamPrevention = {
    ...
    forgotten: function forgotten(req, res, next) {
        ...
        if (deniedRateLimit) {
            errors.logError(
                i18n.t('errors.middleware.spamprevention.forgottenPasswordIp.error', {rfa: rateForgottenAttempts, rpp: rateForgottenPeriod}),
    ...
    protected: function protected(req, res, next) {
        ...
        if (deniedRateLimit) {
            errors.logError(
                i18n.t('errors.middleware.spamprevention.forgottenPasswordIp.error', {rfa: rateProtectedAttempts, rpp: rateProtectedPeriod}),
                i18n.t('errors.middleware.spamprevention.forgottenPasswordIp.context')
            );
