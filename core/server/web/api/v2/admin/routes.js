...
module.exports = function apiRoutes() {
    ...
    // ## Sessions
    router.get('/session', mw.authAdminApi, apiv2.http(apiv2.session.read));
    ...
    router.post('/session',
        ...
        apiv2.http(apiv2.session.add)
    );
    router.del('/session', mw.authAdminApi, apiv2.http(apiv2.session.delete));
