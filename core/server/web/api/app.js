...
module.exports = function setupApiApp() {
    ...
    apiApp.use(urlUtils.getVersionPath({version: 'canary', type: 'content'}), require('./v4/content/app')());
    apiApp.use(urlUtils.getVersionPath({version: 'canary', type: 'admin'}), require('./v4/admin/app')());
