...
const metaSchema = require('../../../schema').tables.meta;
const metaAttrs = _.keys(_.omit(metaSchema, ['id']));
...
class PostsImporter extends BaseImporter {
    constructor(allDataFromFile) {
        super(allDataFromFile, {
            ...
            requiredFromFile: ['posts', 'tags', 'posts_tags', 'posts_authors', 'meta'],
     ...
     */
    sanitizeMeta(model) {
        let metaFromFile = _.find(this.requiredFromFile.meta, {post_id: model.id}) || _.pick(model, metaAttrs);
        let metaData = Object.assign({}, _.mapValues(metaSchema, () => null), metaFromFile);
        model.meta = metaData;
