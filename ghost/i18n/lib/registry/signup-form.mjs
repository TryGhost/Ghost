// Per-namespace browser entry — import as '@tryghost/i18n/registry/signup-form'.
...
const i18n = i18nFromGlob(import.meta.glob('../../locales/*/signup-form.json', {eager: true, import: 'default'}), 'signup-form');
