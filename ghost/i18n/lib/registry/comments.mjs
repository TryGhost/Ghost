// Per-namespace browser entry — import as '@tryghost/i18n/registry/comments'.
...
const i18n = i18nFromGlob(import.meta.glob('../../locales/*/comments.json', {eager: true, import: 'default'}), 'comments');
