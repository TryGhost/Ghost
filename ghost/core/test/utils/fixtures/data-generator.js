...
// Wraps content in a lexical doc with a single markdown card, matching what
// mobiledocToLexical() produced when these fixtures were stored as mobiledoc
DataGenerator.markdownToLexical = function markdownToLexical(content) {
    const lexical = {
        root: {
            children: [
                {
...
DataGenerator.Content = {
    posts: [
        ...
        },
        {
            ...
            lexical: DataGenerator.markdownToLexical('<h1>HTML Ipsum Presents</h1><img src="__GHOST_URL__/content/images/lol.jpg"><p><strong>Pellentesque habitant morbi tristique</strong> senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. <em>Aenean ultricies mi vitae est.</em> Mauris placerat eleifend leo. Quisque sit amet est et sapien ullamcorper pharetra. Vestibulum erat wisi, condimentum sed, <code>commodo vitae</code>, ornare sit amet, wisi. Aenean fermentum, elit eget tincidunt condimentum, eros ipsum rutrum orci, sagittis tempus lacus enim ac dui. <a href="#">Donec non enim</a> in turpis pulvinar facilisis. Ut felis.</p><h2>Header Level 2</h2><ol><li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</li><li>Aliquam tincidunt mauris eu risus.</li></ol><blockquote><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus magna. Cras in mi at felis aliquet congue. Ut a est eget ligula molestie gravida. Curabitur massa. Donec eleifend, libero at sagittis mollis, tellus est malesuada tellus, at luctus turpis elit sit amet quam. Vivamus pretium ornare est.</p></blockquote><h3>Header Level 3</h3><ul><li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</li><li>Aliquam tincidunt mauris eu risus.</li></ul><pre><code>#header h1 a{display: block;width: 300px;height: 80px;}</code></pre>'),
        ...
        },
        {
            ...
            lexical: DataGenerator.markdownToLexical('## testing\n\nmctesters\n\n- test\n- line\n- items'),
        ...
        },
        {
            ...
            lexical: DataGenerator.markdownToLexical('<h1>Static page test is what this is for.</h1><p>Hopefully you don\'t find it a bore.</p>'),
            type: 'page'
        },
        {
        ...
        },
        {
            ...
            slug: 'scheduled-post',
            lexical: DataGenerator.markdownToLexical('<h1>Welcome to my invisible post!</h1>'),
            status: 'scheduled',
...
DataGenerator.forKnex = (function () {
    ...
    function createPost(overrides) {
        ...
        if (!newObj.mobiledoc && !newObj.lexical) {
            newObj.lexical = DataGenerator.markdownToLexical('## markdown');
        }

        if (!newObj.html) {
            if (newObj.mobiledoc) {
                const mobiledocObj = JSON.parse(newObj.mobiledoc);
                newObj.html = mobiledocObj.cards && mobiledocObj.cards[0][1].markdown;
            } else {
                const lexicalObj = JSON.parse(newObj.lexical);
                newObj.html = lexicalObj.root.children[0] && lexicalObj.root.children[0].markdown;
            }
        }
