...
- `rm -rf casper`
- `rsync -rv --exclude '.git*' --exclude 'assets/css*' --exclude 'assets/js*' --exclude 'gulpfile.js' --exclude 'pnpm-lock.yaml' --exclude 'README.md' --exclude 'node_modules' ../../../../content/themes/casper .`
...
- `cd tests/utils/fixtures/themes`
- `rm -rf source`
- `rsync -rv --exclude '.git*' --exclude 'assets/css*' --exclude 'assets/js*' --exclude 'gulpfile.js' --exclude 'pnpm-lock.yaml' --exclude 'README.md' --exclude 'node_modules' ../../../../content/themes/source .`
