...
describe('Snippets API', function () {
    ...
    describe('URL transformations', function () {
        ...
        it('Can read Mobiledoc snippet with CDN URLs when configured', async function () {
            ...
            mobiledoc.cards.find(c => c[0] === 'image')[1].src.should.equal(`${cdnUrl}/content/images/snippet-inline.jpg`);
            ...
            mobiledoc.cards.find(c => c[0] === 'video')[1].thumbnailSrc.should.equal(`${cdnUrl}/content/images/snippet-video-thumb.jpg`);
            mobiledoc.cards.find(c => c[0] === 'audio')[1].thumbnailSrc.should.equal(`${cdnUrl}/content/images/snippet-audio-thumb.jpg`);
            assert(!snippet.mobiledoc.includes('__GHOST_URL__'));
        });
