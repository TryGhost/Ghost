...
describe('Newsletters API', function () {
    ...
    describe('Browse newsletters', function () {
    ...
    describe('Read a newsletter', function () {
    ...
    describe('Add a newsletter', function () {
    ...
    describe('Edit a newsletter', function () {
        ...
        it.skip('[Legacy] Can only set newsletter reply to to newsletter or support value', async function () {
            const id = fixtureManager.get('newsletters', 0).id;
        ...
        it.skip('[Legacy] Cannot clear newsletter sender_reply_to', async function () {
            const id = fixtureManager.get('newsletters', 0).id;
        ...
        it.skip('[Legacy] Cannot set newsletter reply-to to any email address', async function () {
            const id = fixtureManager.get('newsletters', 0).id;
        ...
        it.skip('[Legacy] Cannot set newsletter sender_email to invalid email address', async function () {
            const id = fixtureManager.get('newsletters', 0).id;
