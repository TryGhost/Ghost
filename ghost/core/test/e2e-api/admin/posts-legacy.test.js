...
describe('Posts API', function () {
    ...
    it('Cannot schedule an email only post without newsletter reference', async function () {
        ...
        await request
            ...
            .expect(422)
            .expect((response) => {
                response.body.errors[0].message.should.eql('Validation error, cannot edit post.');
                response.body.errors[0].context.should.eql('Scheduling an email requires a newsletter reference.');
            });
    });
