...
describe('Posts API', function () {
    ...
    describe('URL transformations', function () {
        ...
        it('Can read Mobiledoc post with CDN URLs when configured', async function () {
            ...
            mobiledoc.cards.find(c => c[0] === 'image')[1].src.should.equal(`${cdnUrl}/content/images/inline.jpg`);
            ...
            mobiledoc.cards.find(c => c[0] === 'video')[1].thumbnailSrc.should.equal(`${cdnUrl}/content/images/video-thumb.jpg`);
