...
describe('Frontend Routing: Preview Routes', function () {
  ...
  it('should display draft posts accessed via uuid', async function () {
    await request
      .get('/p/d52c42ae-2755-455c-80ec-70b2ec55c903/')
      ...
      .expect((res) => {
        ...
        assert.equal(
          ...
          'meta description for draft post',
        );
  ...
  it('should assume the user has access to the post if member_status is not provided', async function () {
    await request
      .get('/p/d52c42ae-2755-455c-80ec-70b2ec55c905/')
      .expect('Content-Type', /html/)
      .expect(200)
      .expect(assertCorrectFrontendHeaders)
  ...
  it('should render draft as an anonymous user with ?member_status=anonymous', async function () {
    await request
      .get('/p/d52c42ae-2755-455c-80ec-70b2ec55c905/?member_status=anonymous')
      .expect('Content-Type', /html/)
      .expect(200)
      .expect(assertCorrectFrontendHeaders)
  ...
  it('should render draft as a member with access to the post if visibility is tiers and ?member_status=paid', async function () {
    await request
      .get('/p/d52c42ae-2755-455c-80ec-70b2ec55c906/?member_status=paid')
      .expect('Content-Type', /html/)
      .expect(200)
      .expect(assertCorrectFrontendHeaders)
      .expect(assertNoPaywallRendered);
  ...
  it('should render draft using only the tier selected for the preview', async function () {
    await request
      .get('/p/d52c42ae-2755-455c-80ec-70b2ec55c906/?member_status=paid&member_tier=silver')
      .expect('Content-Type', /html/)
      .expect(200)
      .expect(assertCorrectFrontendHeaders)
      .expect(assertNoPaywallRendered);
    ...
    await request
      .get('/p/d52c42ae-2755-455c-80ec-70b2ec55c906/?member_status=paid&member_tier=missing-tier')
      .expect('Content-Type', /html/)
      .expect(200)
      .expect(assertCorrectFrontendHeaders)
      .expect(assertPaywallRendered);
  ...
  it('should reject a repeated member_tier param', async function () {
    ...
    await request
      .get(
        '/p/d52c42ae-2755-455c-80ec-70b2ec55c906/?member_status=paid&member_tier=silver&member_tier=gold',
      )
      .expect(404);
  });
  ...
  it('should render draft as free member with ?member_status=free', async function () {
    await request
      .get('/p/d52c42ae-2755-455c-80ec-70b2ec55c905/?member_status=free')
      .expect('Content-Type', /html/)
      .expect(200)
      .expect(assertCorrectFrontendHeaders)
      .expect(assertPaywallRendered);
  ...
  it('should render draft as paid member with ?member_status=paid', async function () {
    await request
      .get('/p/d52c42ae-2755-455c-80ec-70b2ec55c905/?member_status=paid')
      .expect('Content-Type', /html/)
      .expect(200)
      .expect(assertCorrectFrontendHeaders)
      .expect(assertNoPaywallRendered);
  ...
  it('should redirect draft posts accessed via uuid and edit to admin post edit screen', async function () {
    await request
      .get('/p/d52c42ae-2755-455c-80ec-70b2ec55c903/edit/')
  ...
  it('should redirect draft page accessed via uuid and edit to admin page edit screen', async function () {
    await request
      .get('/p/d52c42ae-2755-455c-80ec-70b2ec55c904/edit/')
      .expect('Content-Type', /text\/plain/)
      .expect(302)
  ...
  it('should redirect published posts to their live url', async function () {
    await request
      .get('/p/2ac6b4f6-e1f3-406c-9247-c94a0496d39d/')
      .expect(301)
  ...
  it('should redirect published posts to their live url with ?member_status=paid', async function () {
    await request
      .get('/p/2ac6b4f6-e1f3-406c-9247-c94a0496d39d/?member_status=paid')
      .expect(301)
      .expect('Location', '/short-and-sweet/')
      .expect('Cache-Control', testUtils.cacheRules.year)
      .expect(assertCorrectFrontendHeaders);
  ...
  it('should render scheduled email-only posts', async function () {
    ...
    await request
      .get(`/p/${scheduledEmail[0].get('uuid')}/`)
      .expect('Content-Type', /html/)
      .expect(200)
      .expect(assertCorrectFrontendHeaders);
  });
  ...
  it('404s unknown uuids', async function () {
    request
      .get('/p/aac6b4f6-e1f3-406c-9247-c94a0496d39f/')
      .expect(404)
      .expect(assertCorrectFrontendHeaders);
  });
});
