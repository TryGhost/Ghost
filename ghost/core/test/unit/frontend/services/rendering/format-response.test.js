...
describe('Unit - services/routing/helpers/format-response', function () {
  ...
  beforeEach(function () {
    posts = [testUtils.DataGenerator.forKnex.createPost({ slug: 'sluggy-thing' })];
    ...
    tags = [testUtils.DataGenerator.forKnex.createTag({ name: 'video', slug: 'video' })];
  });
  ...
  describe('entry', function () {
    ...
    it('should return the post object with html strings converted to SafeString', function () {
      const postObject = testUtils.DataGenerator.forKnex.createPost({
        slug: 'with-caption',
        feature_image_caption: '<a href="#">A link</a>',
      });
  ...
  describe('entries', function () {
    ...
    it('should return post objects with html strings converted to SafeString', function () {
      ...
      const featured_multiple = [
        testUtils.DataGenerator.forKnex.createPost({
          slug: 'featured-two',
          feature_image_caption: '<a href="#">Featured link two</a>',
        }),
        testUtils.DataGenerator.forKnex.createPost({
          slug: 'featured-three',
          feature_image_caption: '<a href="#">Featured link three</a>',
        }),
      ];
      ...
      const data = {
        posts: [
          testUtils.DataGenerator.forKnex.createPost({
            slug: 'one',
            feature_image_caption: '<a href="#">Link one</a>',
          }),
          testUtils.DataGenerator.forKnex.createPost({
            slug: 'two',
            feature_image_caption: '<a href="#">Link two</a>',
          }),
        ],
        data: {
          featured_single: [
            testUtils.DataGenerator.forKnex.createPost({
              slug: 'featured-one',
              feature_image_caption: '<a href="#">Featured link one</a>',
            }),
          ],
          featured_multiple,
        },
