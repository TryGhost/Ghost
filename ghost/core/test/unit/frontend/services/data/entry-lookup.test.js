...
describe('Unit - frontend/data/entry-lookup', function () {
  ...
  describe('posts', function () {
    ...
    beforeEach(function () {
      posts = [testUtils.DataGenerator.forKnex.createPost({ url: '/test/', slug: 'test' })];
    ...
    it('matches hyphen-separated date permalinks with hyphenated slugs', function () {
      ...
      return data
        .entryLookup(
          'http://127.0.0.1:2369/articles/2026-05-22-sample-hyphenated-post-title/',
          datedRouterOptions,
          locals,
        )
    ...
    it('matches edit URLs for hyphen-separated date permalinks with hyphenated slugs', function () {
      ...
      return data
        .entryLookup(
          'http://127.0.0.1:2369/articles/2026-05-22-sample-hyphenated-post-title/edit/',
          datedRouterOptions,
          locals,
        )
        .then(function (lookup) {
    ...
    it('matches generic hyphen-separated params with hyphenated slugs', function () {
      ...
      return data
        .entryLookup(
          'http://127.0.0.1:2369/articles/news-sample-hyphenated-post-title/',
          sectionRouterOptions,
          locals,
        )
        .then(function (lookup) {
          sinon.assert.calledOnce(postsReadStub);
