...
describe('{{input_password}} helper', function () {
  ...
  it('returns the correct input when a custom class is specified', function () {
    const markup =
      '<input class="test-class" type="password" name="password" autofocus="autofocus" />';
  ...
  it('returns the correct input when a custom placeholder is specified', function () {
    const markup =
      '<input class="private-login-password" type="password" name="password" autofocus="autofocus" placeholder="Test" />';
  ...
  it('returns the correct input when 1Password ignore is enabled', function () {
    const markup =
      '<input class="private-login-password" type="password" name="password" autofocus="autofocus" placeholder="Test" data-1p-ignore />';
