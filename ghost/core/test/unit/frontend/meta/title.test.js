  ...
  describe('property: og', function () {
    ...
    it('has correct fallbacks for context: author_paged', function () {
      ...
      assert.equal(
        getTitle(
          { author },
          { context: ['author', 'paged'], pagination: { total: 40, page: 3 } },
          { property: 'og' },
        ),
        'Author name - Site title (Page 3)',
      );
    ...
    it('has correct fallbacks for context: tag_paged', function () {
      ...
      assert.equal(
        getTitle(
          { tag },
          { context: ['tag', 'paged'], pagination: { total: 40, page: 3 } },
          { property: 'og' },
        ),
        'Tag meta title',
      );
