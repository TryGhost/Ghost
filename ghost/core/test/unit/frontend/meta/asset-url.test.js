...
describe('getAssetUrl', function () {
  ...
  describe('favicon', function () {
    ...
    it('should correct favicon path for custom png', function () {
      sinon
        ...
        .withArgs('icon')
        .returns('/content/images/2017/04/my-icon.png');
      const testUrl = getAssetUrl('favicon.ico');
    ...
    it('should correct favicon path for custom svg', function () {
      sinon
        .stub(settingsCache, 'get')
        .withArgs('icon')
        .returns('/content/images/2017/04/my-icon.svg');
      const testUrl = getAssetUrl('favicon.ico');
  ...
  describe('with asset CDN url configured', function () {
    ...
    it('should still handle # anchor in CDN url', function () {
      ...
      assert.equal(
        testUrl,
        'https://assets.example.com/my-site/assets/img/icons.svg?v=abc#arrow-up',
      );
    });
