...
describe('getImageDimensions', function () {
  ...
  it('should adjust image sizes to a max width', async function () {
    ...
    assert.equal(
      ...
      'http://mysite.com/content/images/size/w1200/mypostcoverimage.jpg',
    );
    assert('dimensions' in result.coverImage);
    ...
    assert.equal(
      result.ogImage.url,
      'http://mysite.com/content/images/size/w1200/super-facebook-image.jpg',
    );
    assert('dimensions' in result.ogImage);
    ...
    assert.equal(
      result.twitterImage,
      'http://mysite.com/content/images/size/w1200/super-twitter-image.jpg',
    );
  });
  ...
  it('does not append image size prefix to external images', async function () {
    ...
    assert.equal(
      result.ogImage.url,
      'http://anothersite.com/some/storage/super-facebook-image.jpg',
    );
    assert('url' in result.site.logo);
  ...
  it('appends image size prefix to CDN-hosted content images', async function () {
    ...
    assert.equal(
      result.coverImage.url,
      'https://storage.ghost.is/c/6f/a3/site/content/images/size/w1200/2026/02/cover.jpg',
    );
    assert.equal(
      result.authorImage.url,
      'https://storage.ghost.is/c/6f/a3/site/content/images/size/w1200/2026/02/author.jpg',
    );
    assert.equal(
      result.ogImage.url,
      'https://storage.ghost.is/c/6f/a3/site/content/images/size/w1200/2026/02/og.jpg',
    );
    assert.equal(
      result.twitterImage,
      'https://storage.ghost.is/c/6f/a3/site/content/images/size/w1200/2026/02/twitter.jpg',
    );
