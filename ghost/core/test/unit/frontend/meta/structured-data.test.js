...
describe('getStructuredData', function () {
    it('should return structured data from metadata per post', async function () {
    ...
    it('should return structured data from metadata with provided og and twitter images only per post', async function () {
        await new Promise((resolve, reject) => {
            const done = err => (err ? reject(err) : resolve());
            const metadata = {
                site: {
    ...
    it('should return structured data from metadata with no nulls', async function () {
        await new Promise((resolve, reject) => {
            const done = err => (err ? reject(err) : resolve());
            const metadata = {
                site: {
