...
describe('getTwitterImage', function () {
  ...
  it('has correct fallbacks for context: home', function () {
    ...
    assert(
      getTwitterImage({ context: ['home'], home: {} }).endsWith(
        '/content/images/settings-twitter.jpg',
      ),
    );
    ...
    assert(
      getTwitterImage({ context: ['home'], home: {} }).endsWith(
        '/content/images/settings-cover.jpg',
      ),
    );
  ...
  describe('CDN image URLs', function () {
    it('returns CDN twitter_image for home context', function () {
      localSettingsCache.twitter_image =
        'https://storage.ghost.is/c/6f/a3/site/content/images/2026/02/twitter.jpg';
    ...
    it('returns CDN twitter_image for post context', function () {
      const post = {
        twitter_image:
          'https://storage.ghost.is/c/6f/a3/site/content/images/2026/02/post-twitter.jpg',
        feature_image: '/content/images/post-feature.jpg',
      };
    ...
    it('falls back to CDN cover_image for settings', function () {
      localSettingsCache.twitter_image = '';
      localSettingsCache.cover_image =
        'https://storage.ghost.is/c/6f/a3/site/content/images/2026/02/cover.jpg';
