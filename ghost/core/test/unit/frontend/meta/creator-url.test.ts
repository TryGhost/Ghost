...
describe('getCreatorTwitterUrl', function () {
  ...
  it('should return null if context does not contain author twitter url and is a post', function () {
    const twitterUrl = getCreatorTwitterUrl({
      context: ['post'],
      post: {
        primary_author: {
  ...
  it('should return author twitter url if author and has url', function () {
    const twitterUrl = getCreatorTwitterUrl({
      context: ['author'],
      author: {
        twitter: 'https://twitter.com/user',
  ...
  it('should return null if context does not contain author twitter url and is a author', function () {
    const twitterUrl = getCreatorTwitterUrl({
      context: ['author'],
      author: {
        twitter: '',
