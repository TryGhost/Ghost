...
import getCoverImage from '../../../../core/frontend/meta/cover-image';
  ...
  describe('CDN image URLs', function () {
    ...
    it('should return CDN cover image url for author', function () {
      const coverImageUrl = getCoverImage({
        ...
        author: {
          cover_image:
            'https://storage.ghost.is/c/6f/a3/site/content/images/2026/02/author-cover.jpg',
        },
      });
      assert.equal(
        coverImageUrl,
    ...
    it('should return CDN feature image url for post', function () {
      const coverImageUrl = getCoverImage({
        ...
        post: {
          feature_image:
            'https://storage.ghost.is/c/6f/a3/site/content/images/2026/02/post-feature.jpg',
        },
      });
      assert.equal(
        coverImageUrl,
