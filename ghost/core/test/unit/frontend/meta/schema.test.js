...
describe('getSchema', function () {
  ...
  it('should return social platform urls unescaped (escaping happens at JSON-LD serialization)', function () {
    ...
    const expectedSameAs = buildExpectedSameAs('http://myblogsite.com/', {
      facebook: 'user=name=',
    });
    ...
    assert.deepEqual(schema.contributor, [
      {
        ...
        url: 'http://mysite.com/author/co-author/',
        sameAs: ['http://coauthorsite.com/', 'https://x.com/coauthor'],
  ...
  it('should include multiple contributors when post has more than two authors', function () {
    ...
    assert.deepEqual(schema.contributor[0], {
      ...
      name: 'Co-Author 1',
      url: 'http://mysite.com/author/co-author-1/',
      sameAs: ['http://coauthor1.com/', 'https://x.com/coauthor1'],
    });
    assert.deepEqual(schema.contributor[1], {
      '@type': 'Person',
      name: 'Co-Author 2',
      url: 'http://mysite.com/author/co-author-2/',
      sameAs: ['http://coauthor2.com/', 'https://www.facebook.com/coauthor2fb'],
    });
  });
