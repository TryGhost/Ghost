...
describe('oembed-service', function () {
    ...
    describe('processImageFromUrl', function () {
        ...
        it('stores icon from external URL and returns CDN path', async function () {
            const saveRaw = sinon.stub().resolves('https://storage.ghost.is/c/6f/a3/site/content/images/icon/favicon.ico');
            ...
            assert.equal(storedUrl, 'https://storage.ghost.is/c/6f/a3/site/content/images/icon/favicon.ico');
