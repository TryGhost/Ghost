...
describe('Email Service', function () {
    ...
    describe('checkLimits', function () {
        ...
        it('Uses custom message when emailSendingDisabledMessage is provided', async function () {
            const customService = new EmailService({
                ...
                domainWarmingService,
                emailSendingDisabledMessage: 'Custom: Email paused. Contact help@example.com'
            });
