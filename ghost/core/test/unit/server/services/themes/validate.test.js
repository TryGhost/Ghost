...
describe('Themes', function () {
  ...
  describe('Validate', function () {
    ...
    it('[success] validates a valid zipped theme', function () {
      ...
      return validate.check(testTheme.name, testTheme, { isZip: true }).then((checkedTheme) => {
    ...
    it('[success] validates a valid unzipped theme', function () {
      ...
      return validate.check(testTheme.name, testTheme, { isZip: false }).then((checkedTheme) => {
    ...
    it('[failure] can handle a corrupt zip file', async function () {
      ...
      await assert.rejects(() => validate.check(testTheme.name, testTheme, { isZip: true }), {
  ...
  describe('getThemeErrors', function () {
    ...
    it('Throws for invalid theme names', async function () {
      await assert.rejects(
        validate.getThemeErrors('invalid-theme-name'),
        /Theme "invalid-theme-name" is not loaded and cannot be checked/,
      );
    });
