...
describe('MW Version Rewrites', function () {
    ...
    it('does nothing for standard admin urls', async function () {
    ...
    it('does nothing for standard content urls', async function () {
        await new Promise((resolve, reject) => {
            const done = err => (err ? reject(err) : resolve());
            req.url = '/content/';
    ...
    it('rewrites a legacy v2 admin url', async function () {
        await new Promise((resolve, reject) => {
            const done = err => (err ? reject(err) : resolve());
    ...
    it('rewrites a legacy v2 content url', async function () {
        await new Promise((resolve, reject) => {
            const done = err => (err ? reject(err) : resolve());
    ...
    it('rewrites a legacy v3 admin url', async function () {
        await new Promise((resolve, reject) => {
            const done = err => (err ? reject(err) : resolve());
    ...
    it('rewrites a legacy v3 content url', async function () {
        await new Promise((resolve, reject) => {
            const done = err => (err ? reject(err) : resolve());
    ...
    it('rewrites a legacy v4 admin url', async function () {
        await new Promise((resolve, reject) => {
            const done = err => (err ? reject(err) : resolve());
    ...
    it('rewrites a legacy v4 content url', async function () {
        await new Promise((resolve, reject) => {
            const done = err => (err ? reject(err) : resolve());
    ...
    it('rewrites a legacy canary admin url as if it were v4', async function () {
        await new Promise((resolve, reject) => {
            const done = err => (err ? reject(err) : resolve());
    ...
    it('rewrites a legacy canary content url as if it were v4', async function () {
        await new Promise((resolve, reject) => {
            const done = err => (err ? reject(err) : resolve());
