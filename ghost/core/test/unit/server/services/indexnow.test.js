...
describe('IndexNow', function () {
    ...
    describe('ping()', function () {
        ...
        it('should handle 202 response as success', function (done) {
            loggingStub = sinon.stub(logging, 'info');
            const pingRequest = nock('https://api.indexnow.org')
                .get(/\/indexnow/)
                .reply(202);
        ...
        it('captures && logs errors from 400 requests', function (done) {
        ...
        it('captures && logs validation errors from 422 requests', function (done) {
            loggingStub = sinon.stub(logging, 'warn');
            const pingRequest = nock('https://api.indexnow.org')
                .get(/\/indexnow/)
                .reply(422);
