...
const IndexNowService = require('../../../../core/server/services/indexnow/indexnow-service');

const VALID_API_KEY = 'a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4';

// Build an IndexNowService with fully injected fakes. The real @tryghost/request
...
function createService() {
    ...
    const service = new IndexNowService(deps);
