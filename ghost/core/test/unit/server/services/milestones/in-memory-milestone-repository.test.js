...
describe('InMemoryMilestoneRepository', function () {
  ...
  it('Can return the latest milestone for members', async function () {
    ...
    const timeDiff =
      new Date(latestMemberCountMilestone.createdAt).getTime() -
  ...
  it('Can return the latest milestone for ARR', async function () {
    ...
    const timeDiff =
      new Date(latestArrMilestone.createdAt).getTime() - new Date('2023-02-01T01:00:00Z').getTime();
    assert(timeDiff === 0);
  ...
  it('Can return the latest milestone for ARR for a specific currency', async function () {
    ...
    const timeDiff =
      new Date(latestArrMilestone.createdAt).getTime() - new Date('2023-01-30T00:00:00Z').getTime();
    assert(timeDiff === 0);
  ...
  it('Can return the last sent email', async function () {
    ...
    const timeDiff =
      new Date(lastEmailSentMilestone.emailSentAt).getTime() -
      new Date('2023-02-01T01:00:00Z').getTime();
    assert(timeDiff === 0);
  });
  ...
  it('Can return the ARR milestone for a given value', async function () {
    ...
    const timeDiff =
      new Date(arrMilestoneForValue.createdAt).getTime() -
      new Date('2023-02-01T01:00:00Z').getTime();
    assert(timeDiff === 0);
  ...
  it('Can return the Members count milestone for a given value', async function () {
    ...
    const timeDiff =
      new Date(membersCountForValue.createdAt).getTime() -
