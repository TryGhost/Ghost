...
import GeolocationService from '../../../../../../../core/server/services/members/members-api/services/geolocation-service';
...
describe('lib/geolocation', function () {
  describe('getGeolocationFromIP', function () {
    ...
    it('handles non-IP addresses', async function () {
      ...
      scope = nock('https://get.geojs.io')
        .get('/v1/ip/geo/undefined.json')
        .reply(200, { test: true });
