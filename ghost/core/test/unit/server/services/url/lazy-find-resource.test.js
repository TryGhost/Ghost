...
const {
  createFindResource,
} = require('../../../../../core/server/services/url/lazy-find-resource');
...
describe('createFindResource', function () {
    ...
    it('trims the derived primary_author and primary_tag to {id, slug}', async function () {
      models.Post.findOne.resolves(
        record({
          ...
          slug: 'hello',
          authors: [
            { id: 'a1', slug: 'jane', name: 'Jane', email: 'jane@x.com' },
            { id: 'a2', slug: 'bob' },
          ],
  ...
  describe('tags and authors', function () {
    ...
    it('strips description and meta fields from a tag', async function () {
      models.TagPublic.findOne.resolves(
        record({
          id: 't1',
          slug: 'news',
          name: 'News',
    ...
    it('strips bio and contact fields from an author', async function () {
      models.Author.findOne.resolves(
        record({
          id: 'a1',
          slug: 'jane',
          name: 'Jane',
