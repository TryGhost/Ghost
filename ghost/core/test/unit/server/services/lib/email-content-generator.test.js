...
describe('Mail: EmailContentGenerator', function () {
    it('generate welcome', async function () {
        ...
        assert.match(content.html, /This email was sent from <a href="http:\/\/myblog.com" style="color: #5B6B73;">http:\/\/myblog.com<\/a> to <a href="mailto:test@example.com" style="color: #5B6B73;">test@example.com<\/a><\/p>/);
