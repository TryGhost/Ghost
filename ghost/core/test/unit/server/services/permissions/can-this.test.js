...
describe('Permissions', function () {
    ...
    describe('CanThis', function () {
        ...
        it('canThisResult gets build properly', function () {
            ...
            assert.equal(typeof canThisResult.browse, 'object');
            assert.equal(typeof canThisResult.browse.post, 'function');

            assert.equal(typeof canThisResult.edit, 'object');
            ...
            assert.equal(typeof canThisResult.add, 'object');
            ...
            assert.equal(typeof canThisResult.destroy, 'object');
                ...
                it('No context: does not allow edit post (no model)', function (done) {
                    permissions
                        ...
                        .catch(function (err) {
                            ...
                            sinon.assert.callCount(findPostSpy, 0);
                            done();
                        });
                });
                ...
                it('No context: does not allow edit post (model syntax)', function (done) {
                    permissions
                        ...
                        .catch(function (err) {
                            ...
                            sinon.assert.callCount(findPostSpy, 1);
                ...
                it('No context: does not allow edit tag (model syntax)', function (done) {
                    permissions
                        ...
                        .catch(function (err) {
                            ...
                            sinon.assert.callCount(findTagSpy, 0);
                            done();
                        });
                });
        ...
        describe('User-based permissions', function () {
            ...
            it('No permissions: cannot edit tag (no permissible function on model)', function (done) {
                ...
                permissions
                    ...
                    .catch(function (err) {
                        sinon.assert.callCount(userProviderStub, 1);
                        assert.equal(err.errorType, 'NoPermissionError');
                        done();
                    });
            });
        ...
        describe('API Key-based permissions', function () {
            ...
            it('With permissions: can edit non-specific tag (no permissible function on model)', function (done) {
                ...
                permissions.canThis({api_key: {
                    ...
                    .tag({id: 1}) // tag id in model syntax
                    .then(function (res) {
                        sinon.assert.callCount(apiKeyProviderStub, 1);
                        assert.equal(res, undefined);
                        done();
                    })
                    .catch(done);
