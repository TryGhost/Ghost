...
describe('TinybirdService', function () {
    ...
    it('should create a server token', function () {
        const serverToken = tinybirdService._serverToken;
        assert.ok(serverToken);
        const decoded = jwt.verify(serverToken, adminToken);
        assert.ok(decoded);
    ...
    describe('getServerToken', function () {
        ...
        it('should return the existing server token if it is not expired', async function () {
