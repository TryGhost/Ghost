...
import EmailContentGenerator from '../../../../../core/server/services/mail/email-content-generator';
...
describe('Mail: EmailContentGenerator', function () {
  it('generate welcome', async function () {
    ...
    assert.match(
      content.html,
      /This email was sent from <a href="http:\/\/myblog.com" style="color: #738A94;">http:\/\/myblog.com<\/a> to <a href="mailto:test@example.com" style="color: #738A94;">test@example.com<\/a><\/p>/,
    );
