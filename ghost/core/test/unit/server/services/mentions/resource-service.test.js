...
describe('ResourceService', function () {
  describe('getByURL', function () {
    it('Correctly converts post resources', async function () {
      ...
      const result = await resourceService.getByURL(new URL('https://site.com/blah/post-resource'));
    ...
    it('Does not convert tag resources', async function () {
      ...
      const result = await resourceService.getByURL(new URL('https://site.com/blah/tag-resource'));
    ...
    it('Handles non-resources', async function () {
      ...
      const result = await resourceService.getByURL(new URL('https://site.com/blah/no-resource'));
