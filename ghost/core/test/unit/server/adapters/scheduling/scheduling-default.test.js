...
describe('Scheduling Default Adapter', function () {
    ...
    describe('success', function () {
        ...
        it('reschedule: default', async function () {
        ...
        it('reschedule: simulate restart', async function () {
            await new Promise((resolve, reject) => {
                const done = err => (err ? reject(err) : resolve());
                sinon.stub(scope.adapter, '_pingUrl');
        ...
        it('ensure recursive run works', async function () {
            await new Promise((resolve, reject) => {
                const done = err => (err ? reject(err) : resolve());
        ...
        it('delete job (unschedule)', async function () {
            await new Promise((resolve, reject) => {
                const done = err => (err ? reject(err) : resolve());
                let pinged = 0;
                const jobsToDelete = {};
