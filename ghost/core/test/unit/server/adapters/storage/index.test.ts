...
const adapterManager: typeof adapterManagerInstance =
  require('../../../../../core/server/services/adapter-manager').default;
const LocalStorageBase: typeof LocalStorageBaseClass =
