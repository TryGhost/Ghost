...
describe('storage utils', function () {
  ...
  describe('fn: isInternalImage', function () {
    ...
    it('should return true for local images', function () {
      ...
      assert.equal(
        storageUtils.isInternalImage('http://myblog.com/content/images/2026/02/photo.png'),
        true,
      );
    });
    ...
    it('should return true for CDN images when urls:image is configured', function () {
      ...
      assert.equal(
        storageUtils.isInternalImage(
          'https://storage.ghost.is/c/6f/a3/test/content/images/2026/02/photo.png',
        ),
        true,
      );
    });
    ...
    it('should return false for CDN prefix-only matches', function () {
      ...
      assert.equal(
        storageUtils.isInternalImage(
          'https://storage.ghost.is/c/6f/a3/test/content/images-other/photo.png',
        ),
        false,
      );
    });
    ...
    it('should return false for external images', function () {
      ...
      assert.equal(
        storageUtils.isInternalImage('https://example.com/content/images/photo.png'),
        false,
      );
    });
