...
describe('Revue Importer', function () {
  ...
  describe('preProcess', function () {
    ...
    it('handles revue with issue and item data', function () {
      ...
      assert.deepEqual(
        result.revue.revue,
        { issues: 'id', items: '{}' },
        'revue object left as-is',
      );
      assert.deepEqual(
        result.data,
        { meta: { version: '5.0.0' }, data: { posts: [] } },
        'data object is set',
      );
    });

    it('handles revue with issue, item and subscribers data', function () {
      const result = RevueImporter.preProcess({
        revue: { revue: { issues: 'id', items: '{}', subscribers: 'email' } },
      });
      assert.deepEqual(
        result.revue.revue,
        { issues: 'id', items: '{}', subscribers: 'email' },
        'revue object left as-is',
      );
      assert.deepEqual(
        result.data,
        { meta: { version: '5.0.0' }, data: { posts: [], revue_subscribers: [] } },
        'data object is set',
      );
    });
  });
  ...
  describe('importPosts', function () {
    it('can process a published post without items', function () {
      const result = RevueImporter.importPosts({
        items: '[]',
        issues:
    ...
    it('doesnt process a post with no subject', function () {
      const result = RevueImporter.importPosts({
        items:
          '[{"title":"","issue_id":123456,"item_type":"text","url":"","description":"\u003cp\u003eGoodbye World!\u003c/p\u003e","order":0}]',
        issues:
      ...
      assert.deepEqual(result, [
        {
          comment_id: 123456,
          title:
            'Lorem Ipsum Dolor Sit Amet Consectetur Adipiscing Elit Mauris Convallis Et Metus Eu Blandit Lorem Ipsum Dolor Sit Amet Consectetur Adipiscing Elit Ut Porta Dapibus Massa Condimentum Malesuada Ipsum Scelerisque Nec Vestibulum Sed Placerat Cras',
  ...
  describe('importSubscribers', function () {
    it('can process a subscriber with only first name', function () {
      const result = RevueImporter.importSubscribers({
        subscribers:
      ...
      assert.deepEqual(result, [
        {
          email: 'joe@bloggs.me',
          name: 'Joe',
          created_at: '2022-12-01 01:02:03.123457',
          subscribed: true,
        },
      ]);
    });
    ...
    it('can process multiple subscribers', function () {
      ...
      assert.deepEqual(result, [
        ...
        },
        {
          email: 'jo@bloggs.me',
          name: 'Jo Bloggs',
          created_at: '2022-12-01 01:02:04.123457',
          subscribed: true,
        },
      ]);
    });
  ...
  describe('JSONToHTML helpers', function () {
        ...
        const result = JSONToHTML.itemsToHtml([
          {
            ...
            order: 0,
            image: 'https://s3.amazonaws.com/revue/items/images/012/345/678/web/google.png?1234556',
          },
        ]);

        assert.deepEqual(
          result,
          '<figure class="kg-card kg-image-card kg-card-hascaption"><a href="https://google.com/"><img src="https://s3.amazonaws.com/revue/items/images/012/345/678/web/google.png?1234556" class="kg-image" alt loading="lazy"></a><figcaption>Google</figcaption></figure>\n' +
        ...
        const result = JSONToHTML.itemsToHtml([
          {
            ...
            item_type: 'link',
            url: 'https://google.com/',
            description: '<p>A <b>search</b> engine.</p>',
            order: 0,
            image: 'https://s3.amazonaws.com/revue/items/images/012/345/678/web/google.png?1234556',
          },
        ]);
        ...
        const result = JSONToHTML.itemsToHtml([
          {
            ...
            image: 'https://s3.amazonaws.com/revue/items/images/012/345/678/web/google.png?1234556',
            original_image_url:
              'https://s3.amazonaws.com/revue/items/images/012/345/678/original/google.png?1234556',
          },
        ]);

        assert.deepEqual(
          result,
          '<figure class="kg-card kg-image-card kg-card-hascaption"><img src="https://s3.amazonaws.com/revue/items/images/012/345/678/web/google.png?1234556" class="kg-image" alt loading="lazy"><figcaption>Hello</figcaption></figure>',
        );
      });
        ...
        const result = JSONToHTML.itemsToHtml([
          {
            ...
            issue_id: 123456,
            item_type: 'tweet',
            url: 'https://twitter.com/Ghost/status/123456',
            description: 'Hello world',
            order: 0,
            tweet_profile_image:
              'https://s3.amazonaws.com/revue/tweet_items/profile_images/000/123/456/thumb/ABCD_normal.png?12345',
            tweet_handle: 'Ghost',
            tweet_description: '\u003cspan\u003eHello world\u003c/span\u003e',
            tweet_lang: 'en',
          },
        ]);
        ...
        const result = JSONToHTML.itemsToHtml([
          {
            ...
            order: 0,
            image:
              'https://s3.amazonaws.com/revue/items/images/012/345/678/web/maxresdefault.jpg?1667924432',
          },
        ]);

        assert.deepEqual(
          result,
          '<figure class="kg-card kg-embed-card kg-card-hascaption"><iframe width="200" height="113" src="https://www.youtube.com/embed/ABCDEF?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><figcaption>Hello World</figcaption></figure>',
        );
      });
        ...
        const result = JSONToHTML.itemsToHtml([
          {
            ...
            order: 2,
            image:
              'https://s3.amazonaws.com/revue/items/images/006/606/464/web/maxresdefault.jpg?1601883862',
          },
        ]);
    ...
    describe('cleanCsvHTML', function () {
      it('can wrap blockquote content in p tags', function () {
        const result = JSONToHTML.cleanCsvHTML(
          '<p>Hello World!</p><blockquote>Try <a href="https://example.com">This</a>!</blockquote>',
        );

        assert.deepEqual(
          result,
          '<p>Hello World!</p><blockquote><p>Try <a href="https://example.com">This</a>!</p></blockquote>',
        );
      });

      it('can remove unwanted blank paragraphs', function () {
        const result = JSONToHTML.cleanCsvHTML(
          '<p>Hello World!</p><p><br></p><p>Goodbye World!</p>',
        );
