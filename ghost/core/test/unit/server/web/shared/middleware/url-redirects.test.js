...
describe('UNIT: url redirects', function () {
    ...
    describe('expect redirect', function () {
        it('site is https, request is http', async function () {
        ...
        it('site host is !== request host', async function () {
            await new Promise((resolve, reject) => {
                const done = err => (err ? reject(err) : resolve());
                configUtils.set({
        ...
        describe(`admin redirects`, function () {
            it('url and admin url are equal, but protocol is different, request is http', async function () {
                await new Promise((resolve, reject) => {
                    const done = err => (err ? reject(err) : resolve());
                    configUtils.set({
            ...
            it('url and admin url are different, request is http', async function () {
                await new Promise((resolve, reject) => {
                    const done = err => (err ? reject(err) : resolve());
                    configUtils.set({
                        url: 'http://default.com:2368',
            ...
            it('subdirectory', async function () {
                await new Promise((resolve, reject) => {
                    const done = err => (err ? reject(err) : resolve());
                    configUtils.set({
            ...
            it('original url has search params', async function () {
                await new Promise((resolve, reject) => {
                    const done = err => (err ? reject(err) : resolve());
                    configUtils.set({
                        url: 'http://default.com:2368',
            ...
            it('ensure redirect loop won\'t happen', async function () {
                await new Promise((resolve, reject) => {
                    const done = err => (err ? reject(err) : resolve());
                    configUtils.set({
                        url: 'http://default.com:2368',
    ...
    describe('expect no redirect', function () {
        it('site is http, request is http', async function () {
            await new Promise((resolve, reject) => {
                const done = err => (err ? reject(err) : resolve());
                configUtils.set({
                    url: 'http://default.com:2368/'
        ...
        it('site is http, request is https', async function () {
            await new Promise((resolve, reject) => {
                const done = err => (err ? reject(err) : resolve());
                configUtils.set({
                    url: 'http://default.com:2368/'
        ...
        it('blog is http, request is https (trailing slash is missing)', async function () {
            await new Promise((resolve, reject) => {
                const done = err => (err ? reject(err) : resolve());
                configUtils.set({
                    url: 'http://default.com:2368/'
        ...
        it('blog is https, request is https', async function () {
            await new Promise((resolve, reject) => {
                const done = err => (err ? reject(err) : resolve());
                configUtils.set({
                    url: 'https://default.com:2368/'
        ...
        it('blog host is !== request host', async function () {
            await new Promise((resolve, reject) => {
                const done = err => (err ? reject(err) : resolve());
                configUtils.set({
                    url: 'https://default.com'
        ...
        describe(`admin redirects`, function () {
            it('admin is blog url and http, requester is http', async function () {
                await new Promise((resolve, reject) => {
                    const done = err => (err ? reject(err) : resolve());
                    configUtils.set({
                        url: 'http://default.com:2368'
            ...
            it('admin request, no custom admin.url configured', async function () {
                await new Promise((resolve, reject) => {
                    const done = err => (err ? reject(err) : resolve());
                    configUtils.set({
                        url: 'http://default.com:2368'
            ...
            it('url and admin url are different, protocol is different, request is not secure', async function () {
                await new Promise((resolve, reject) => {
                    const done = err => (err ? reject(err) : resolve());
                    configUtils.set({
            ...
            it('url and admin url are different, protocol is different, request is secure', async function () {
                await new Promise((resolve, reject) => {
                    const done = err => (err ? reject(err) : resolve());
                    configUtils.set({
                        url: 'http://ghost.org/blog/',
            ...
            it('url and admin url are different, request matches, uses a port', async function () {
                await new Promise((resolve, reject) => {
                    const done = err => (err ? reject(err) : resolve());
                    configUtils.set({
                        url: 'https://default.com:2368',
