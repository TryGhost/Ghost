...
describe('Unit: models/settings', function () {
  ...
  describe('format', function () {
    it('transforms urls when persisting to db', function () {
      ...
      let returns = setting.formatOnWrite({
        key: 'cover_image',
        value: `${siteUrl}/cover_image.png`,
        type: 'string',
      });
      assert.equal(returns.value, '__GHOST_URL__/cover_image.png');

      returns = setting.formatOnWrite({
        key: 'logo',
        value: `${siteUrl}/logo.png`,
        type: 'string',
      });
      ...
      returns = setting.formatOnWrite({
        ...
        value: `${siteUrl}/portal_button_icon.png`,
        type: 'string',
      });
      ...
      returns = setting.formatOnWrite({
        key: 'twitter_image',
        value: `${siteUrl}/twitter_image.png`,
        type: 'string',
      });
  ...
  describe('parse', function () {
    it('ensure correct parsing when fetching from db', function () {
      ...
      returns = setting.parse({
        key: 'cover_image',
        value: '__GHOST_URL__/cover_image.png',
        type: 'string',
      });
      ...
      returns = setting.parse({
        key: 'portal_button_icon',
        value: '__GHOST_URL__/portal_button_icon.png',
        type: 'string',
      });
      ...
      returns = setting.parse({
        key: 'og_image',
        value: '__GHOST_URL__/og_image.png',
        type: 'string',
      });
      ...
      returns = setting.parse({
        key: 'twitter_image',
        value: '__GHOST_URL__/twitter_image.png',
        type: 'string',
      });
    ...
    async function testInvalidSetting({ key, value, type, group }) {
      ...
      try {
        ...
        assert(
          ...
          'Setting Model should throw ValidationError',
        );
      }
    }
