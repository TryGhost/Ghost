...
describe('lib/image: blog icon', function () {
  describe('getIconUrl', function () {
    it('custom uploaded ico blog icon', function () {
      ...
      assert.deepEqual(blogIcon.getIconUrl(), [
        { relativeUrl: '/content/images/2017/04/my-icon.ico' },
        undefined,
      ]);
    });
    ...
    it('custom uploaded png blog icon', function () {
      ...
      assert.deepEqual(blogIcon.getIconUrl(), [
        { relativeUrl: '/content/images/size/w256h256/2017/04/my-icon.png' },
        undefined,
      ]);
    });
    ...
    it('custom uploaded CDN png blog icon', function () {
      ...
      assert.deepEqual(blogIcon.getIconUrl(), [
        {
          relativeUrl:
            'https://storage.ghost.is/c/6f/a3/site/content/images/size/w256h256/2026/02/my-icon.png',
        },
        undefined,
      ]);
    });
    ...
    it('CDN png blog icon with absolute: true', function () {
      ...
      assert.deepEqual(blogIcon.getIconUrl({ absolute: true }), [
        {
          relativeUrl:
            'https://storage.ghost.is/c/6f/a3/site/content/images/size/w256h256/2026/02/my-icon.png',
        },
    ...
    it('CDN svg blog icon gets format-converted to png', function () {
      ...
      assert.deepEqual(blogIcon.getIconUrl(), [
        {
          relativeUrl:
            'https://storage.ghost.is/c/6f/a3/site/content/images/size/w256h256/format/png/2026/02/my-icon.svg',
        },
        undefined,
      ]);
    });
    ...
    it('CDN ico blog icon is not resized', function () {
      ...
      assert.deepEqual(blogIcon.getIconUrl(), [
        { relativeUrl: 'https://storage.ghost.is/c/6f/a3/site/content/images/2026/02/my-icon.ico' },
        undefined,
      ]);
    });
  ...
  describe('getIconDimensions', function () {
    it('[success] returns .ico dimensions', async function () {
      ...
      const result = await blogIcon.getIconDimensions(
        path.join(__dirname, '../../../../utils/fixtures/images/favicon.ico'),
      );
      assertExists(result);
    ...
    it('[success] returns .png dimensions', async function () {
      ...
      const result = await blogIcon.getIconDimensions(
        path.join(__dirname, '../../../../utils/fixtures/images/favicon.png'),
      );
      assertExists(result);
      assert.deepEqual(result, {
        width: 100,
    ...
    it('[failure] return error message', async function () {
      ...
      await assert.rejects(
        blogIcon.getIconDimensions(
          path.join(
            __dirname,
            '../../../../utils/fixtures/images/favicon_multi_sizes_FILE_DOES_NOT_EXIST.ico',
          ),
        ),
