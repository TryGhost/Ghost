...
describe('External Request', function () {
  ...
  describe('with private ip', function () {
    ...
    it('allows configured hostname', function () {
      ...
      const requestMock = nock('http://example.com').get('/endpoint/').reply(200, 'Response body');
    ...
    it('blocks on request', function () {
      ...
      const requestMock = nock('http://some-website.com').get('/files/').reply(200, 'Response');
  ...
  describe('general behavior', function () {
    ...
    it('[failure] can handle an error with statuscode not 200', function () {
      ...
      const requestMock = nock('http://nofilehere.com').get('/files/test.txt').reply(404);
