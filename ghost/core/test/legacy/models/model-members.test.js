...
describe('Member Model', function run() {
    ...
    describe('deep offset pagination', function () {
        ...
        // Must be beforeEach, not before: the suite-level afterEach runs
        // teardownDb, so each test starts from an empty members table
