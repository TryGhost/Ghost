...
describe('Settings Model', function () {
  ...
  // itself populates the defaults, hence the teardown). Under the old
  ...
  describe('defaults', function () {
    ...
    it("doesn't overwrite any existing settings", async function () {
      ...
      await db.knex.table('settings').insert({
        id: 'test_id',
        key: 'title',
      ...
      const descriptionSetting = settingsPopulated.models.find(
        (s) => s.get('key') === 'description',
      );
