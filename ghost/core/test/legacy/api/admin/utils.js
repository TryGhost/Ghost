...
const expectedProperties = {
  ...
  setting: ['id', 'group', 'key', 'value', 'type', 'flags', 'created_at', 'updated_at'],
  ...
  permission: ['id', 'name', 'object_type', 'action_type', 'object_id', 'created_at', 'updated_at'],
  notification: ['type', 'message', 'status', 'id', 'dismissible', 'location', 'custom'],
  theme: ['name', 'package', 'active'],
  invite: ['id', 'role_id', 'status', 'email', 'expires', 'created_at', 'updated_at'],
  webhook: [
    'id',
    'event',
    'target_url',
...
module.exports = {
  ...
  getValidAdminToken(endpoint, key) {
    ...
    return jwt.sign({}, Buffer.from(key.secret, 'hex'), JWT_OPTIONS);
  },
};
