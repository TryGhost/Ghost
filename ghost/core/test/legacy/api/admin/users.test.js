...
describe('User API', function () {
  describe('As Owner', function () {
    ...
    describe('Read', function () {
      it("can't retrieve non existent user by id", async function () {
        await request
          .get(localUtils.API.getApiQuery('users/' + ObjectId().toHexString() + '/'))
      ...
      it("can't retrieve non existent user by slug", async function () {
        await request
          .get(localUtils.API.getApiQuery('users/slug/blargh/'))
          .set('Origin', config.get('url'))
          .set('Accept', 'application/json')
          .expect('Content-Type', /json/)
          .expect('Cache-Control', testUtils.cacheRules.private)
  ...
  describe('As Editor', function () {
    ...
    describe('success cases', function () {
      it('can edit himself', async function () {
        await request
          .put(localUtils.API.getApiQuery('users/' + editor.id + '/'))
          .set('Origin', config.get('url'))
          .send({
        ...
        await request
          .put(
            localUtils.API.getApiQuery(
              'users/' + testUtils.DataGenerator.Content.users[0].id + '/',
            ),
          )
          .set('Origin', config.get('url'))
          .send({
  ...
  describe('As Author', function () {
    ...
    describe('success cases', function () {
      it('can edit himself', async function () {
        await request
          .put(localUtils.API.getApiQuery('users/' + author.id + '/'))
          .set('Origin', config.get('url'))
          .send({
