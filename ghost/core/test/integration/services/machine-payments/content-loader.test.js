...
describe('Integration: machine-payments', function () {
    ...
    it('loads full paid entries and rejects members-only entries', async function () {
        const paid = await models.Post.add(testUtils.DataGenerator.forKnex.createPost({
        ...
        const membersOnly = await models.Post.add(testUtils.DataGenerator.forKnex.createPost({
