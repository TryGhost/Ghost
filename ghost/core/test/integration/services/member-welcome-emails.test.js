...
describe('Member Welcome Emails Integration', function () {
    ...
    function runMemberCreationWithWelcomeEmailsTests() {
    ...
    function runOutboxProcessingForWelcomeEmailsTests({labsEnabled}) {
        describe('Outbox processing for welcome emails', function () {
            const JOB_NAME = labsEnabled ? 'welcome-email-outbox-test-labs-on' : 'welcome-email-outbox-test-labs-off';
            let jobService;
            ...
            it('uses the expected design settings after welcome emails are loaded', async function () {
                const memberWelcomeEmailService = require('../../../core/server/services/member-welcome-emails/service');
                memberWelcomeEmailService.init();
    ...
    runMemberCreationWithWelcomeEmailsTests();
    runOutboxProcessingForWelcomeEmailsTests({labsEnabled: false});
    ...
    describe('labs flag on', function () {
        ...
        runMemberCreationWithWelcomeEmailsTests();
        runOutboxProcessingForWelcomeEmailsTests({labsEnabled: true});
    });
});
