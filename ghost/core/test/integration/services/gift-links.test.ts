...
interface GiftLinksServiceInstance {
    ensure(_postId: string, _options?: Record<string, unknown>): Promise<GiftLinkModel>;
    reset(_postId: string, _options?: Record<string, unknown>): Promise<GiftLinkModel>;
    resetAll(_options?: Record<string, unknown>): Promise<number>;
    recordRead(_giftLinkId: string): Promise<number>;
    getActive(_postId: string, _options?: Record<string, unknown>): Promise<GiftLinkModel | null>;
    getActiveByToken(_token: string, _options?: Record<string, unknown>): Promise<GiftLinkModel | null>;
}

const GiftLinksService = require('../../../core/server/services/gift-links/gift-links-service') as new (_deps: {models: unknown}) => GiftLinksServiceInstance;
...
describe('GiftLinksService (integration)', function () {
    ...
    let service: GiftLinksServiceInstance;
