    ...
    it('mobiledoc is null, html field is set, convert html -> lexical', function () {
      ...
      return dataImporter
        ...
        .then(function (result) {
          ...
          assert.equal(
            posts[0].html,
            '<h1 id="this-is-my-post-content">This is my post content.</h1>',
          );
          assert.equal(posts[0].mobiledoc, null);
          assert.equal(
            posts[0].lexical,
            '{"root":{"children":[{"children":[{"detail":0,"format":0,"mode":"normal","style":"","text":"This is my post content.","type":"extended-text","version":1}],"direction":null,"format":"","indent":0,"type":"extended-heading","version":1,"tag":"h1"}],"direction":null,"format":"","indent":0,"type":"root","version":1}}',
          );
        });
    });
    ...
    it('mobiledoc is set and html is null', function () {
      ...
      return dataImporter
        ...
        .then(function (result) {
          ...
          assert.equal(
            posts[0].lexical,
            '{"root":{"children":[{"type":"markdown","markdown":"## markdown"}],"direction":null,"format":"","indent":0,"type":"root","version":1}}',
          );
        });
    });
    ...
    it('post has "kg-card-markdown" class', function () {
      ...
      return dataImporter
        ...
        .then(function (result) {
          ...
          assert.equal(
            posts[0].lexical,
            '{"root":{"children":[{"type":"markdown","markdown":"# This is my post content"}],"direction":null,"format":"","indent":0,"type":"root","version":1}}',
          );
        });
    });
