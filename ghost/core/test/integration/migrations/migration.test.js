...
describe('Migrations', function () {
  ...
  describe('Fixtures', function () {
    ...
    function assertCompletePermissions(permissions) {
      ...
      assertHavePermission(permissions, 'Import database', [
        'Administrator',
        'Self-Serve Migration Integration',
        'DB Backup Integration',
      ]);
      assertHavePermission(permissions, 'Delete all content', [
        'Administrator',
        'DB Backup Integration',
      ]);
      assertHavePermission(permissions, 'Import content', [
        'Administrator',
        'Self-Serve Migration Integration',
      ]);
      assertHavePermission(permissions, 'Backup database', [
        'Administrator',
        'DB Backup Integration',
      ]);
      ...
      assertHavePermission(permissions, 'Browse notifications', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Add notifications', [
        'Administrator',
        'Admin Integration',
      ]);
      assertHavePermission(permissions, 'Delete notifications', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ...
      assertHavePermission(permissions, 'Browse posts', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Read posts', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Edit posts', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Add posts', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Delete posts', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Publish posts', [
        'Administrator',
        'Editor',
        'Admin Integration',
      ...
      assertHavePermission(permissions, 'Read settings', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Generate slugs', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Browse tags', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Read tags', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Edit tags', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Add tags', [
        'Administrator',
        'Editor',
        'Author',
        'Admin Integration',
      ...
      assertHavePermission(permissions, 'Delete tags', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ...
      assertHavePermission(permissions, 'Browse themes', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'View active theme details', [
        'Administrator',
        'Editor',
        'Author',
        'Admin Integration',
      ...
      assertHavePermission(permissions, 'Browse users', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Read users', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Edit users', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Add users', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Delete users', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ...
      assertHavePermission(permissions, 'Assign a role', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Browse roles', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Browse invites', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Read invites', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Edit invites', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Add invites', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Delete invites', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ...
      assertHavePermission(permissions, 'Download redirects', [
        'Administrator',
        'Admin Integration',
      ]);
      ...
      assertHavePermission(permissions, 'Email preview', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Send test email', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Browse emails', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Read emails', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Retry emails', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ...
      assertHavePermission(permissions, 'Browse snippets', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Read snippets', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Edit snippets', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Add snippets', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Delete snippets', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ...
      assertHavePermission(permissions, 'Browse labels', [
        'Administrator',
        'Editor',
        'Author',
        'Admin Integration',
      ...
      assertHavePermission(permissions, 'Read labels', [
        'Administrator',
        'Editor',
        'Author',
        'Admin Integration',
      ...
      assertHavePermission(permissions, 'Edit labels', [
        'Administrator',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Add labels', [
        'Administrator',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Delete labels', [
        'Administrator',
        'Admin Integration',
        'Super Editor',
      ]);
      ...
      assertHavePermission(permissions, 'Edit member custom fields', [
        'Administrator',
        'Admin Integration',
      ]);
      assertHavePermission(permissions, 'Delete member custom fields', [
        'Administrator',
        'Admin Integration',
      ]);
      ...
      assertHavePermission(permissions, 'Add Members', [
        'Administrator',
        'Admin Integration',
        'Self-Serve Migration Integration',
        'Super Editor',
      ...
      assertHavePermission(permissions, 'Browse Products', [
        'Administrator',
        'Editor',
        'Author',
        'Admin Integration',
      ...
      assertHavePermission(permissions, 'Read Products', [
        'Administrator',
        'Editor',
        'Author',
        'Admin Integration',
      ...
      assertHavePermission(permissions, 'Browse newsletters', [
        'Administrator',
        'Editor',
        'Author',
        'Admin Integration',
      ...
      assertHavePermission(permissions, 'Read newsletters', [
        'Administrator',
        'Editor',
        'Author',
        'Admin Integration',
      ...
      assertHavePermission(permissions, 'Browse comments', [
        'Administrator',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Read comments', [
        'Administrator',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Edit comments', [
        'Administrator',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Add comments', [
        'Administrator',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Delete comments', [
        'Administrator',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Moderate comments', [
        'Administrator',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Like comments', [
        'Administrator',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Unlike comments', [
        'Administrator',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Report comments', [
        'Administrator',
        'Admin Integration',
        'Super Editor',
      ]);
      ...
      assertHavePermission(permissions, 'Browse collections', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Read collections', [
        'Administrator',
        'Editor',
        'Author',
        'Contributor',
      ...
      assertHavePermission(permissions, 'Edit collections', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ]);
      assertHavePermission(permissions, 'Add collections', [
        'Administrator',
        'Editor',
        'Author',
        'Admin Integration',
      ...
      assertHavePermission(permissions, 'Delete collections', [
        'Administrator',
        'Editor',
        'Admin Integration',
        'Super Editor',
      ...
      assertHavePermission(permissions, 'Browse automated emails', [
        'Administrator',
        'Admin Integration',
      ]);
      assertHavePermission(permissions, 'Read automated emails', [
        'Administrator',
        'Admin Integration',
      ]);
      assertHavePermission(permissions, 'Edit automated emails', [
        'Administrator',
        'Admin Integration',
      ]);
      assertHavePermission(permissions, 'Add automated emails', [
        'Administrator',
        'Admin Integration',
      ]);
      assertHavePermission(permissions, 'Delete automated emails', [
        'Administrator',
        'Admin Integration',
      ]);
      assertHavePermission(permissions, 'Browse automations', [
        'Administrator',
        'Admin Integration',
      ]);
      ...
      assertHavePermission(permissions, 'Browse email design settings', [
        'Administrator',
        'Admin Integration',
      ]);
      assertHavePermission(permissions, 'Read email design settings', [
        'Administrator',
        'Admin Integration',
      ]);
      assertHavePermission(permissions, 'Edit email design settings', [
        'Administrator',
        'Admin Integration',
      ]);
      assertHavePermission(permissions, 'Add email design settings', [
        'Administrator',
        'Admin Integration',
      ]);
      assertHavePermission(permissions, 'Delete email design settings', [
        'Administrator',
        'Admin Integration',
      ]);
    }
