...
module.exports = function apiRoutes() {
    ...
    // ## Email Templates
    router.get('/email_templates/:slug', mw.authAdminApi, http(api.emailTemplates.read));
    router.put('/email_templates/:slug', mw.authAdminApi, http(api.emailTemplates.edit));
