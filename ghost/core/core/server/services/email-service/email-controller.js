...
const messages = {
  ...
  invalidMemberSegment:
    "memberSegment is deprecated and only accepts 'status:free' or 'status:-free' — use member_status instead.",
};
...
class EmailController {
  ...
  async _getFrameData(frame) {
    ...
    if (
      legacySegment !== null &&
      (typeof legacySegment !== 'string' || !Object.hasOwn(LEGACY_SEGMENT_STATUSES, legacySegment))
    ) {
      throw new errors.ValidationError({
