...
//
// A reorder names no field, because it happened to the list. It carries instead the two
// things the activity feed reads a bulk action by: how many fields the list held, and
// the word to use in place of the bare event.
