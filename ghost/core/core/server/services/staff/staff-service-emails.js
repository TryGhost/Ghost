...
class StaffServiceEmails {
  ...
  async notifyPaidSubscriptionCanceled(
    { member, tier, subscription, cancelNow, expiryAt, canceledAt },
    options = {},
  ) {
  ...
  async notifyDonationReceived({ donationPaymentEvent }) {
    ...
    const memberData = donationPaymentEvent.memberId
      ? this.getMemberData({
  ...
  async notifyGiftSubscriptionStarted(
    { memberId, memberName, memberEmail, tierName, cadence, duration, buyerEmail },
    options = {},
  ) {
