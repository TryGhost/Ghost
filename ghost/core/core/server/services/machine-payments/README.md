...
- **Protocol:** Machine Payments Protocol (MPP) first — Tempo USDC + Shared Payment Tokens (card / Link Agent Wallet). x402 is a later adapter behind the same payment-authorization boundary; it does not change membership.
