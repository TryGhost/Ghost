...
const PaidContentProvider = require('./paid-content-provider');
...
class MachinePaymentsService {
    constructor({
        ...
        paidContentProvider = new PaidContentProvider()
    } = {}) {
        ...
        this.paidContentProvider = paidContentProvider;
    }
    ...
    async getPaidContent(resourceType, id) {
        return await this.paidContentProvider.get(resourceType, id);
    }
