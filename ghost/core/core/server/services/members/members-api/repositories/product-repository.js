...
class ProductRepository {
   ...
   */
  constructor({ Product, Settings, StripeProduct, StripePrice, stripeAPIService }) {
  ...
  async get(data, options = {}) {
    ...
    throw new NotFoundError({
      message: 'Missing id, slug, stripe_product_id or stripe_price_id from data',
    });
  }
      ...
      if (data.monthly_price || data.yearly_price) {
        ...
        for (const newPrice of newPrices) {
          ...
          const stripeProduct = newProductId
            ? await this._StripeProduct.findOne({ stripe_product_id: newProductId }, options)
