...
module.exports = function MembersAPI({
    ...
    async function sendEmailWithMagicLink({email, requestedType, tokenData, options = {forceEmailType: false, otc: false}, referrer = null}) {
        ...
        return magicLinkService.sendMagicLink({email, type, tokenData: Object.assign({email, type}, tokenData), referrer, otc: options.otc});
    }
