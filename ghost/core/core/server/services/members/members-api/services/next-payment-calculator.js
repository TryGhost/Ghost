...
class NextPaymentCalculator {
     ...
     * @param {object} subscription - The subscription object (serialized)
     * @param {OfferDTO|null} offer - The offer attached to the subscription
     * @returns {NextPayment|null}
     */
    calculate(subscription, offer) {
