...
const messages = {
  ...
  allRedirectsSkipped:
    'None of the {total} redirect(s) in the store could be activated. Check the logged errors above.',
};
...
const defaultCreateDryRunManager = (): RedirectManagerLike =>
...
export class RedirectsService {
  ...
  constructor({
    ...
    redirectManager,
    validate,
    createDryRunManager = defaultCreateDryRunManager,
  }: RedirectsServiceDeps) {
    this.store = store;
   ...
   */
  private _loadIntoManager(
    redirects: RedirectConfig[],
    { validatePerItem, failFast }: { validatePerItem: boolean; failFast: boolean },
  ): void {
