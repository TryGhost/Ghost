...
module.exports = {
  ...
  emails: {
    ...
    preflight_email_count: { type: 'integer', nullable: true, unsigned: true },
    candidate_count: { type: 'integer', nullable: true, unsigned: true },
    preparation_excluded_count: { type: 'integer', nullable: true, unsigned: true },
  ...
  email_batches: {
    ...
    member_counters_enabled: { type: 'boolean', nullable: false, defaultTo: false },
    ...
    submission_excluded_count: { type: 'integer', nullable: true, unsigned: true },
    submitted_count: { type: 'integer', nullable: true, unsigned: true },
