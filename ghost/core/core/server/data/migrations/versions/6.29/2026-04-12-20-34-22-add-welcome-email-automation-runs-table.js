...
const welcomeEmailAutomationRunsSpec = {
  ...
  welcome_email_automation_id: {
    ...
    maxlength: 24,
    nullable: false,
    references: 'welcome_email_automations.id',
    constraintName: WELCOME_EMAIL_AUTOMATION_RUNS_AUTOMATION_FK,
    cascadeDelete: true,
  },
  member_id: {
    type: 'string',
    ...
    constraintName: WELCOME_EMAIL_AUTOMATION_RUNS_MEMBER_FK,
    cascadeDelete: true,
  },
  next_welcome_email_automated_email_id: {
    ...
    constraintName: WELCOME_EMAIL_AUTOMATION_RUNS_NEXT_EMAIL_FK,
    cascadeDelete: false,
  },
