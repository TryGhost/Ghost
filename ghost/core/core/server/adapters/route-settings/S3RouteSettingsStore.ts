...
const messages = {
  ...
  partialCredentials:
    'S3RouteSettingsStore requires both accessKeyId and secretAccessKey when either is provided',
...
const configSchema = z
  .object({
    ...
    defaultSettingsBasePath: z
      .string({ error: tpl(messages.missingDefaultSettingsBasePath) })
