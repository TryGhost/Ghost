...
const {MediaFile, MediaFiles} = require('./media-file');
const {MediaFileUsage, MediaFileUsages} = require('./media-file-usage');
const {MediaFolder, MediaFolders} = require('./media-folder');
...
exports.MediaFileUsage = MediaFileUsage;
exports.MediaFileUsages = MediaFileUsages;
