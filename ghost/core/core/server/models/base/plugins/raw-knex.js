        ...
        {},
        {
            ...
            raw_knex: {
                fetchAll: function (options) {
                    ...
                    if (exclude) {
                        let toSelect = _.keys(
                            schema.tables[tableNames[modelName]]
                        );
                    ...
                    return query.then((objects) => {
                        ...
                        if (!withRelated) {
                            return _.map(objects, (object) => {
                                object = Bookshelf.registry.models[
                                    ...
                                    serialize:
                                        Bookshelf.registry.models[modelName]
                                            .prototype.serialize,
                                    formatsToJSON:
                                        Bookshelf.registry.models[modelName]
                                            .prototype.formatsToJSON,
                                })();

                                object =
                                    Bookshelf.registry.models[
                                        modelName
                                    ].prototype.fixBools(object);
                                object =
                                    Bookshelf.registry.models[
                                        modelName
                        ...
                        _.each(withRelated, (withRelatedKey) => {
                            ...
                            props[relation.name] = (() => {
                                ...
                                let relationQuery = Bookshelf.knex(
                                ...
                                _.each(
                                    withRelatedFields[withRelatedKey],
                                    (toSelect) => {
                        ...
                        return Promise.all([props]).then(
                            (relationsToAttach) => {
                                ...
                                objects = _.map(objects, (object) => {
                                    _.each(
                                        Object.keys(relationsToAttach),
                                        (relation) => {
                                            if (
                                                !relationsToAttach[relation][
                                                    object.id
                                                ]
                                            ) {
                                                object[relation] = [];
