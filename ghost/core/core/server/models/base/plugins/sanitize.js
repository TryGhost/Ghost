  ...
  Bookshelf.Model = Bookshelf.Model.extend(
    {
      ...
      permittedAttributes: function permittedAttributes() {
        return Object.keys(schema.tables[this.tableName] || {}).filter(
          (key) => key.indexOf('@@') === -1,
        );
      },
    },
    {
            ...
            _.each(relations, (relation, indexInArr) => {
              _.each(relation, (relationValue, relationProperty) => {
                if (
                  ...
                  schema.tables[this.prototype.relationshipBelongsTo[property]][relationProperty]
                    .type === 'dateTime' &&
      ...
      filterOptions: function filterOptions(unfilteredOptions, methodName, filterConfig) {
        ...
        const permittedOptions = new Set([
          ...this.permittedOptions(methodName, options),
