      ...
      reassignByAuthor: async function reassignByAuthor(unfilteredOptions) {
        ...
        const reassignPost = async () => {
          ...
          try {
            ...
            const primaryPostsWithOwnerCoauthorIds = primaryPostsWithOwnerCoauthor.map(
              (post) => post.post_id,
            );
            ...
            const postsWithoutOwnerCoauthorIds = primaryPostsWithoutOwnerCoauthor.map(
              (post) => post.post_id,
            );
            ...
            await knex('posts_authors').transacting(trx).where('author_id', authorId).del();
          } catch (err) {
