...
import type {IFormat as NconfFormat, Provider as NconfProvider} from 'nconf';
 ...
 */
export function makePathsAbsolute(nconf: NconfProvider, obj: object, parent: string) {
...
export function doesContentPathExist(contentPath: string): void {
...
*/
export function checkUrlProtocol(url: string): void {
 ...
 */
export function sanitizeDatabaseProperties(nconf: NconfProvider): void {
...
export const jsoncFormat: NconfFormat = {
    parse: function (text) {
