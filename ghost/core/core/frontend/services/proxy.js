...
module.exports = {
  ...
  // so both answer "does this reader see it?" the same way. Lazy for the same
  // reason as `members` above.
  get announcementBarService() {
    return require('../../server/services/announcement-bar-service');
  },
