...
function servePublicFiles(siteApp) {
    ...
    // Staff admin toolbar
    siteApp.get('/public/admin-toolbar.min.js', createPublicFileMiddleware('static', 'public/admin-toolbar.min.js', 'application/javascript', config.get('caching:publicAssets:maxAge')));
