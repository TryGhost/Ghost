...
export default tseslint.config(
  ...
  // ============================================================
  {
    ...
    rules: {
      'local-filenames/match-regex': [
        'error',
        '^(?:\\d{4}(?:-\\d{2}){4,5}|\\d{2})(?:-[a-zA-Z0-9]+){2,}$',
        true,
      ],
    },
  },
    ...
    rules: {
      'no-restricted-syntax': [
        'error',
        {
          ...
          message:
            '`created_by` is not allowed - The action log should be used to record user actions.',
        },
        {
          selector: 'Property[key.name="updated_by"]',
          message:
            '`updated_by` is not allowed - The action log should be used to record user actions.',
        },
      ],
    },
  },
