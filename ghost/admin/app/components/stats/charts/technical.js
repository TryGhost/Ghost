...
export default class TechnicalComponent extends Component {
    ...
    ReactComponent = (props) => {
        ...
        case 'browsers':
            endpoint = `${this.config.stats.endpoint}/v0/pipes/_top_browsers__v${apiVersion || TB_VERSION}.json`;
            indexBy = 'browser';
            tableHead = 'Browser';
            break;
        case 'os':
            endpoint = `${this.config.stats.endpoint}/v0/pipes/_top_os__v${apiVersion || TB_VERSION}.json`;
            indexBy = 'os';
            tableHead = 'OS';
            break;
        default:
            endpoint = `${this.config.stats.endpoint}/v0/pipes/_top_devices__v${apiVersion || TB_VERSION}.json`;
            indexBy = 'device';
            tableHead = 'Device';
        }
