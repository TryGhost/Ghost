...
@classic
export default class ReactEditorController extends Controller {
        ...
        try {
            ...
            if (isNew && post.get('id')) {
                if (!this.leaveEditorTransition) {
                    this.replaceRoute('react-editor.edit', post);
                }
                return true;
            }
    ...
    *backgroundLoaderTask() {
    ...
    async willTransition(transition) {
        ...
        let fromNewToEdit = this.router.currentRouteName === 'react-editor.new'
            && transition.targetName === 'react-editor.edit'
        ...
        if (!fromNewToEdit && transition.targetName !== 'react-editor.edit') {
            this.reset();
        }
    }
