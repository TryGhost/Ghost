...
const adminXApps = ['admin-x-settings', 'admin-x-activitypub', 'posts', 'stats'];
    ...
    config(env) {
        ...
        if (!this.env) {
            ...
            if (this.env === 'production') {
                ...
                this.packageConfig[`adminXActivitypubCustomUrl`] = 'https://cdn.jsdelivr.net/ghost/admin-x-activitypub@~1.0/dist/admin-x-activitypub.js'
            }
