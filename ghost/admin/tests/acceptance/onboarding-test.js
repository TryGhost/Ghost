...
describe('Acceptance: Onboarding', function () {
    ...
    describe('checklist (owner)', function () {
        ...
        it('analytics does not show checklist by default', async function () {
        ...
        it('analytics shows the checklist after accessing setup/done', async function () {
        ...
        it('checklist clears after skipping', async function () {
            await visit('/setup/done');
            await visit('/analytics');
