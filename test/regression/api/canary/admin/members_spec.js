    ...
    it('Fails to import members with stripe_customer_id', function () {
        return request
            ...
            .then((res) => {
                ...
                jsonResponse.meta.stats.invalid[0].error.should.match(/Cannot link Stripe Customer without a Stripe connection/);
                jsonResponse.meta.stats.invalid[1].error.should.match(/Cannot link Stripe Customer without a Stripe connection/);
