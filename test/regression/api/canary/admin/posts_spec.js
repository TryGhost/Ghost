...
describe('Posts API', function () {
    ...
    describe('Browse', function () {
        ...
        it('can filter by fields coming from meta table non null meta_description', function (done) {
        ...
        it('can filter by fields coming from meta table by value', function (done) {
        ...
        it('can order by fields coming from meta table', function (done) {
    ...
    describe('Edit', function () {
        ...
        it('changes to meta fields triggers a cache invalidation', function () {
            return request
                .get(localUtils.API.getApiQuery(`posts/${testUtils.DataGenerator.Content.posts[0].id}/`))
                .set('Origin', config.get('url'))
                .expect(200)
