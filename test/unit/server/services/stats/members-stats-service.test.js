...
/**
 * @typedef {MembersStatsService.MemberStatusDelta} MemberStatusDelta
 * @typedef {MembersStatsService.TotalMembersByStatus} TotalMembersByStatus
 */
...
describe('MembersStatsService', function () {
    describe('getCountHistory', function () {
        ...
        /**
         * @type {TotalMembersByStatus}
         */
        const currentCounts = {paid: 0, free: 0, comped: 0};
        /**
         * @type {MemberStatusDelta[]}
         */
        const events = [];
