...
async function main(): Promise<void> {
    ...
    const shippingDetails = (completed as unknown as {shipping?: {name?: string; address?: unknown}}).shipping;
    const customFields = (completed as unknown as {custom_fields?: Array<{key: string; text?: {value?: string}}>}).custom_fields ?? [];
    const missing = [
