...
export class CommentsSection {
  ...
  async waitForCommentsToLoad(): Promise<void> {
    ...
    await this.commentsFrame
      .getByTestId('content-box')
  ...
  getCommentByText(text: string): Locator {
    return this.commentsFrame.getByTestId('comment-content').getByText(text, { exact: true });
  }
  ...
  async deleteComment(commentToManageText: string): Promise<void> {
    ...
    await this.deletePopupFrame
      .getByTestId('delete-popup-confirm')
