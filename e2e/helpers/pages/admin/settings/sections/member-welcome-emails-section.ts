...
export class MemberWelcomeEmailsSection extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.customizeModalPublicationTitleToggle = this.customizeModal
      .getByText('Publication title')
      .locator('..')
      .getByRole('switch');
    ...
    this.customizeModalBodyFontSelect = this.customizeModal
      .getByText('Body font')
      .locator('..')
      .getByRole('combobox');
    ...
    this.customizeModalButtonColorAutoSwatch = this.customizeModal.getByRole('button', {
      name: 'Auto',
    });
  ...
  async saveCustomizeModal(): Promise<void> {
    const saveResponse = this.page.waitForResponse(
      (resp) =>
        resp.url().includes('/automated_emails/design') && resp.request().method() === 'PUT',
    );
