...
export class PortalAccountPage extends PortalPage {
  ...
  constructor(page: Page) {
    ...
    this.billingInfoHeading = this.portalFrame.getByRole('heading', {
      name: 'Billing info & receipts',
    });
    this.cancellationNotice = this.portalFrame.getByText(
      /Your subscription has been canceled and will expire on/i,
    );
    ...
    this.resumeSubscriptionButton = this.portalFrame.getByRole('button', {
      name: 'Resume subscription',
    });
    this.canceledBadge = this.portalFrame.getByText('Canceled', { exact: true });
    this.emailNewsletterHeading = this.portalFrame.getByRole('heading', {
