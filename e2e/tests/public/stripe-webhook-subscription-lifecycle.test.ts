...
test.describe('Portal - Stripe Subscription Lifecycle via Webhooks', () => {
  ...
  test('cancel-at-period-end webhook - shows canceled state in portal', async ({
    page,
    stripe,
  }) => {
  ...
  test('subscription-deleted webhook - shows free membership in portal', async ({
    page,
    stripe,
  }) => {
