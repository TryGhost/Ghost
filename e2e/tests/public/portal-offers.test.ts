...
import {
  ...
  createPortalSignupOffer,
  expect,
  redeemOfferViaPortal,
  test,
...
async function expectOfferLandingPage(
  offerPage: PortalOfferPage,
  expected: OfferLandingExpectation,
): Promise<void> {
...
async function expectTrialOfferRedemption(
...
test.describe('Ghost Public - Portal Offers', () => {
  ...
  test('archived offer link opens site - does not open portal offer flow', async ({
    page,
    stripe,
  }) => {
  ...
  test('free trial offer opens in portal - redemption shows free trial state', async ({
    page,
    stripe,
  }) => {
  ...
  test('one-time discount offer opens in portal - redemption shows discounted plan label', async ({
    page,
    stripe,
  }) => {
    const offer = await createPortalSignupOffer(page.request, stripe!, {
  ...
  test('repeating discount offer opens in portal - redemption shows discounted plan label', async ({
    page,
    stripe,
  }) => {
    const offer = await createPortalSignupOffer(page.request, stripe!, {
  ...
  test('forever discount offer opens in portal - redemption shows discounted plan label', async ({
    page,
    stripe,
  }) => {
    const offer = await createPortalSignupOffer(page.request, stripe!, {
