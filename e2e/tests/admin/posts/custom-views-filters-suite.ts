...
/**
 * Shared between the Ember implementation (postsListX off) and the React
 * implementation (postsListX on); same page objects and selectors.
 */
export function defineCustomViewsFiltersTests() {
