...
interface RunMembersExportTestsOptions {
    suiteName: string;
...
export function runMembersExportTests({suiteName, labs, createPage}: RunMembersExportTestsOptions) {
    test.describe(suiteName, () => {
        ...
        test('exports all members to CSV', async ({page}) => {
            ...
            const membersPage = createPage(page);
