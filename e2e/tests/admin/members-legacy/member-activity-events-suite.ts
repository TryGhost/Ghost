...
/**
 * Member detail activity feed tests, shared between the Ember implementation
 * (labs flag off, the default) and the React implementation (labs flag
 * `memberDetailsX` on).
 *
 * Tests are order-independent: each signup happens with a unique email
 * generated by the portal signup flow.
 */
export function defineMemberActivityEventsTests() {
