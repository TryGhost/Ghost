...
// Runs the shared editor suite against the Ember implementation. The flag is
// pinned off (not just defaulted) so that when editorX eventually GAs, this
...
test.describe('Ghost Admin - Editor', () => {
    defineEditorTests();
});
