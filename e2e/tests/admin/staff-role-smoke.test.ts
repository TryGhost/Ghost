...
test.describe('Ghost Admin - Staff role smoke', () => {
  ...
  test('administrator first login - lands on analytics with full navigation', async ({
    browser,
    baseURL,
    ghostAccountAdministrator,
  }) => {
  ...
  test('editor first login - lands on site view with content navigation', async ({
    browser,
    baseURL,
    ghostAccountEditor,
  }) => {
  ...
  test('super editor first login - lands on site view with members navigation', async ({
    browser,
    baseURL,
    ghostAccountSuperEditor,
  }) => {
    await withIsolatedPage(browser, { baseURL }, async ({ page }) => {
  ...
  test('author first login - lands on site view with posts and pages navigation', async ({
    browser,
    baseURL,
    ghostAccountAuthor,
  }) => {
