...
async function retrieveLatestEmailMessage(
...
test.describe('Ghost Admin - Welcome Email Customize Button', () => {
  ...
  test('escape behavior - shows unsaved changes confirmation for welcome email customization', async ({
    page,
  }) => {
    const welcomeEmailsSection = new MemberWelcomeEmailsSection(page);
    ...
    await expect(welcomeEmailsSection.customizeModalFooterTextarea).toHaveValue(
      'Unsaved footer change',
    );
  ...
  test('escape behavior - closes welcome email customization confirmation without closing the customize modal', async ({
    page,
  }) => {
    const welcomeEmailsSection = new MemberWelcomeEmailsSection(page);
  ...
  test('escape behavior - closes welcome email color picker without bypassing unsaved changes confirmation', async ({
    page,
  }) => {
    const welcomeEmailsSection = new MemberWelcomeEmailsSection(page);
  ...
  test('escape behavior - closes welcome email font select without bypassing unsaved changes confirmation', async ({
    page,
  }) => {
    const welcomeEmailsSection = new MemberWelcomeEmailsSection(page);
  ...
  test('free member welcome email customization - is applied to delivered email', async ({
    page,
    browser,
    baseURL,
  }) => {
    ...
    await welcomeEmailsSection.customizeModalFooterTextarea.fill(
      'Custom footer text for welcome members',
    );
