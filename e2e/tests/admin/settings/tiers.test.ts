...
test.describe('Ghost Admin - Tiers', () => {
  ...
  test('create tier not enabled in portal - tier visible but unchecked in portal settings', async ({
    page,
  }) => {
  ...
  test('archive and unarchive tier - tier moves between active and archived tabs', async ({
    page,
  }) => {
    const settingsPage = new SettingsPage(page);
