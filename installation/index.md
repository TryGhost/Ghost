...
The way that [Node.js](http://nodejs.org) makes this possible, is by wrapping up the JavaScript engine from Google's Chrome browser and making it installable anywhere. This means that you can get Ghost installed on your computer to try it out very quickly and easily.
    The following sections detail how to install Ghost locally on [Mac](http://support.ghost.org/installing-ghost-mac/),  [Windows](http://support.ghost.org/installing-ghost-windows/) or [Linux](http://support.ghost.org/installing-ghost-linux/) or alternatively will help you get Ghost deployed on a [server or hosting](http://support.ghost.org/deploying-ghost/) account.
...
<div class="text-center install-ghost">
    <a href="http://support.ghost.org/installing-ghost-mac/" class="btn btn-success btn-large">Mac</a>
    <a href="http://support.ghost.org/installing-ghost-windows/" class="btn btn-success btn-large">Windows</a>
    <a href="http://support.ghost.org/installing-ghost-linux/" class="btn btn-success btn-large">Linux</a>
</div>
...
<div class="text-center install-ghost">
    <a href="http://support.ghost.org/deploying-ghost/" class="btn btn-success btn-large">Get Ghost Live</a>
</div>
