// Vendored from /e2e/tests/admin/posts/custom-views.test.ts
import {CustomViewModal, PostsPage, SidebarPage} from '../../../helpers/pages';
import {PostFactory, TagFactory, createPostFactory, createTagFactory} from '../../../helpers/data-factory';
