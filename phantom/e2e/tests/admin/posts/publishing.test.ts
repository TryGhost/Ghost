// Vendored from /e2e/tests/admin/posts/publishing.test.ts (mailgunEnabled
// is implicit: phantom's mail provider is always wired in e2e mode).
import type {APIRequestContext, Page} from '@playwright/test';
import {PageEditorPage, PostEditorPage, PostPage, PostsPage} from '../../../helpers/pages';
