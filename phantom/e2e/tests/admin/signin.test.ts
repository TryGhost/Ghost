// Vendored from /e2e/tests/admin/signin.test.ts (deep-link redirect cases)
import {Page} from '@playwright/test';
import {LoginPage, PostsPage, TagsPage} from '../../helpers/pages';
import {expect, test} from '../../helpers/fixture';

// These flows manage their own sessions; using the shared storage state would
// revoke it server-side for every later test when logout() runs.
