...
Download the latest version of Ghost from [Ghost.org/download/](http://ghost.org/download/). Unpack the archive to a folder where you'd like to run Ghost - anywhere will do!
