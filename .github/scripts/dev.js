...
const adminXApps = '@tryghost/admin-x-demo,@tryghost/admin-x-settings,@tryghost/admin-x-playground';
...
const COMMANDS_ADMINX = [{
    ...
    cwd: path.resolve(__dirname, '../../apps/admin-x-settings', '../../apps/admin-x-playground'),
    prefixColor: '#C35831',
    env: {}
}];
