...
async function main() {
  ...
  console.log(
    `Review summary: verdict=${review.verdict}, comments=${review.stats.commentsRaised}, lines=${review.stats.linesReviewed}, files=${review.stats.filesReviewed}`,
  );
  if (review.usage) {
    console.log(
      `Token usage: input=${review.usage.input_tokens}, output=${review.usage.output_tokens}`,
    );
  }
