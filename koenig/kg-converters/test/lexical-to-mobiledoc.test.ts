...
import { lexicalToMobiledoc } from '../src/index.js';
    ...
    it('converts a paragraph with a link', function () {
      ...
      assert.equal(
        ...
        JSON.stringify({
          ...
          atoms: [],
          cards: [],
          markups: [['a', ['href', 'https://koenig.ghost.org']]],
          sections: [
            [
              1,
              'p',
    ...
    it('converts a paragraph with a link with a format starting and ending inside', function () {
      ...
      assert.equal(
        ...
        JSON.stringify({
          ...
          atoms: [],
          cards: [],
          markups: [['a', ['href', 'https://koenig.ghost.org']], ['strong']],
          sections: [
            [
              1,
              'p',
    ...
    it('converts a paragraph with a link where format starts before and ends inside', function () {
      ...
      assert.equal(
        ...
        JSON.stringify({
          ...
          atoms: [],
          cards: [],
          markups: [['strong'], ['a', ['href', 'https://koenig.ghost.org']]],
          sections: [
            [
              1,
              'p',
    ...
    it('converts a paragraph with a link surrounded by and containing formats', function () {
      ...
      assert.equal(
        ...
        JSON.stringify({
          ...
          atoms: [],
          cards: [],
          markups: [['strong'], ['a', ['href', 'https://koenig.ghost.org']], ['em']],
          sections: [
            [
              1,
              'p',
    ...
    it('converts headings with links and formatting', function () {
      ...
      assert.equal(
        ...
        JSON.stringify({
          ...
          atoms: [],
          cards: [],
          markups: [['a', ['href', 'https://koenig.ghost.org']], ['em']],
          sections: [
            [
              1,
              'h1',
    ...
    it('converts blockquotes', function () {
      ...
      assert.equal(
        ...
        JSON.stringify({
          ...
          cards: [],
          markups: [],
          sections: [[1, 'blockquote', [[0, [], 0, 'Blockquote text']]]],
        }),
      );
    });
    ...
    it('converts asides', function () {
      ...
      assert.equal(
        ...
        JSON.stringify({
          ...
          cards: [],
          markups: [],
          sections: [[1, 'aside', [[0, [], 0, 'Aside text']]]],
        }),
      );
    });
    ...
    it('converts unordered lists', function () {
      ...
      assert.equal(
        ...
        JSON.stringify({
          ...
          cards: [],
          markups: [],
          sections: [[3, 'ul', [[[0, [], 0, 'one']], [[0, [], 0, 'two']], [[0, [], 0, 'three']]]]],
        }),
      );
    });
    ...
    it('converts ordered lists', function () {
      ...
      assert.equal(
        ...
        JSON.stringify({
          ...
          cards: [],
          markups: [],
          sections: [[3, 'ol', [[[0, [], 0, 'one']], [[0, [], 0, 'two']], [[0, [], 0, 'three']]]]],
        }),
      );
    });
