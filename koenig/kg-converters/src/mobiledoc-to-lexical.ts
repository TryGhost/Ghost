...
export function mobiledocToLexical(serializedMobiledoc: string | null | undefined): string {
  if (
    serializedMobiledoc === null ||
    serializedMobiledoc === undefined ||
    serializedMobiledoc === ''
  ) {
...
function convertMarkupSectionToLexical(
  section: MobiledocSection,
  mobiledoc: MobiledocDocument,
): LexicalNode {
...
function populateLexicalNodeWithMarkers(
    ...
    if (value !== undefined) {
      ...
      if (openLinkMarkup) {
        ...
        linkNode =
          linkNode !== undefined
            ? linkNode
            : createEmptyLexicalNode('a', { url: href, rel: rel || null });
...
function createEmptyLexicalNode(
  tagName: string,
...
function convertListSectionToLexical(
  child: MobiledocSection,
  mobiledoc: MobiledocDocument,
): LexicalNode {
...
function convertCardSectionToLexical(
  child: MobiledocSection,
  mobiledoc: MobiledocDocument,
): LexicalNode {
