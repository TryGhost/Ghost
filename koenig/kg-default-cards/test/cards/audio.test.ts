...
describe('Audio card', function () {
  ...
  it('transforms content urls relative to absolute', function () {
    ...
    expect(transformed.src as string).toBe(
      'https://ghost.org/uploads/2017/11/file_example_MP3.mp3',
    );
  });
