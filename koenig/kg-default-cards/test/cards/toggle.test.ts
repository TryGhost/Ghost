...
describe('Toggle card', function () {
  ...
  describe('email render', function () {
    it('generates an email-friendly toggle in a paragraph', function () {
      ...
      expect(serializer.serialize(card.render(opts))).toBe(
        '<div class="kg-toggle-card"><h4 style="font-size: 1.375rem !important; font-weight: 600; margin-bottom: 8px; margin-top:0px">This is toggle heading</h4><div style="font-size: 1rem !important; line-height: 1.5; margin-bottom: -1.5em;">This is toggle content</div></div>',
      );
    });
  });
  ...
  it('transforms content urls relative to absolute', function () {
    ...
    expect(transformed.content as string).toBe(
      '<a href="https://ghost.org/#/portal/signup">Sign up</a>',
    );
  });
  ...
  it('transforms content urls to transform ready', function () {
    ...
    expect(transformed.content as string).toBe(
      '<a href="__GHOST_URL__/#/portal/signup">Sign up</a>',
    );
  });
});
