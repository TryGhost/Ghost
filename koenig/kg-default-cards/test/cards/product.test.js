...
describe('Product card', function () {
    ...
    describe('email render', function () {
        it('generates an email-friendly product card', function () {
            ...
            const html = `<table cellspacing="0" cellpadding="0" border="0" style="width:100%; padding:20px; border:1px solid #DDE1E5; border-radius: 5px; margin: 0 0 1.5em; width: 100%;"><tr><td align="center" colspan="2" style="padding-top:0; padding-bottom:0; margin-bottom:0; padding-bottom:0;"><img src="https://example.com/images/ok.jpg" style="border: none; padding-bottom: 16px;" border="0"></td></tr><tr><td valign="top"><h4 style="font-size: 22px !important; margin-top: 0 !important; margin-bottom: 0 !important; font-weight: 700;">Product title!</h4></td><td class="text-align:right;" align="right" valign="top">star3</td></tr><tr><td style="padding-top:0; padding-bottom:0; margin-bottom:0; padding-bottom:0;"><div style="padding-top: 16px; opacity: 0.7; font-size: 17px; line-height: 1.4; margin-bottom: -24px;">This product is ok</div></td></tr><tr><td td colspan="2" style="padding-top:0; padding-bottom:0; margin-bottom:0; padding-bottom:0;"><div class="btn btn-accent" style="box-sizing: border-box;display: table;width: 100%;padding-top: 16px;"><tr><td style="font-size: 18px;vertical-align: top;border-radius: 5px;text-align: center;"><a href="https://example.com/product/ok" style="overflow-wrap: anywhere;border: solid 1px;border-radius: 5px;box-sizing: border-box;cursor: pointer;display: inline-block;font-size: 14px;font-weight: bold;margin: 0;padding: 12px 25px;text-decoration: none;color: #FFFFFF; width: 100%; text-align: center;">Click me</a></td></tr></div></td></tr></table>`;
        ...
        it('generates the same card when the star-rating is disabled', function () {
            ...
            const html = `<table cellspacing="0" cellpadding="0" border="0" style="width:100%; padding:20px; border:1px solid #DDE1E5; border-radius: 5px; margin: 0 0 1.5em; width: 100%;"><tr><td align="center" colspan="2" style="padding-top:0; padding-bottom:0; margin-bottom:0; padding-bottom:0;><img src="https://example.com/images/ok.jpg" style="border: none; padding-bottom: 16px;" border="0"></td></tr><tr><td valign="top"><h4 style="font-size: 22px !important; margin-top: 0 !important; margin-bottom: 0 !important; font-weight: 700;">Product title!</h4></td></tr><tr><td style="padding-top:0; padding-bottom:0; margin-bottom:0; padding-bottom:0;"><div style="padding-top: 16px; opacity: 0.7; font-size: 17px; line-height: 1.4; margin-bottom: -24px;">This product is ok</div></td></tr><tr><td><div class="btn btn-accent" style="box-sizing: border-box;display: table;width: 100%;padding-top: 16px;"><tr><td style="font-size: 18px;vertical-align: top;border-radius: 5px;text-align: center;"><a href="https://example.com/product/ok" style="overflow-wrap: anywhere;border: solid 1px;border-radius: 5px;box-sizing: border-box;cursor: pointer;display: inline-block;font-size: 14px;font-weight: bold;margin: 0;padding: 12px 25px;text-decoration: none;color: #FFFFFF; width: 100%; text-align: center;">Click me</a></td></tr></div></td></tr></table>`;
        ...
        it('renders without an image if the attribute isn\'t there', function () {
            ...
            const html = `<table cellspacing="0" cellpadding="0" border="0" style="width:100%; padding:20px; border:1px solid #DDE1E5; border-radius: 5px; margin: 0 0 1.5em; width: 100%;"><tr><td valign="top"><h4 style="font-size: 22px !important; margin-top: 0 !important; margin-bottom: 0 !important; font-weight: 600;">Product title!</h4></td></tr><tr><td colspan="2" style="padding-top:0; padding-bottom:0; margin-bottom:0; padding-bottom:0;"><div style="padding-top: 16px; opacity: 0.7; font-size: 17px; line-height: 1.4; margin-bottom: -24px;">This product is ok</div></td></tr></table>`;
