...
describe('Header card', function () {
  ...
  it('renders a minimal header card', function () {
    ...
    expect(serializer.serialize(card.render(opts))).toBe(
      `<div class="kg-card kg-header-card kg-width-full kg-size-small kg-style-dark" style="" data-kg-background-image=""><h2 class="kg-header-card-header" id="hi">hi</h2></div>`,
    );
  });
