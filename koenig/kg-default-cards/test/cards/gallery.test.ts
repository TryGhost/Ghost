...
describe('Gallery card', function () {
  ...
  it('renders images with blank alt text', function () {
    ...
    expect(serializer.serialize(card.render(opts))).toEqual(
      '<figure class="kg-card kg-gallery-card kg-width-wide kg-card-hascaption"><div class="kg-gallery-container"><div class="kg-gallery-row"><div class="kg-gallery-image"><img src="/content/images/2018/08/NatGeo01-9.jpg" width="3200" height="1600" loading="lazy" alt></div></div></div><figcaption>Test caption</figcaption></figure>',
    );
  });
  ...
  it('transforms urls absolute to relative', function () {
    ...
    expect(images[0].src).toBe('/content/images/2018/08/NatGeo01-9.jpg');

    expect(images[0].caption).toBe('A link to <a href="/post">an internal post</a>');

    expect(images[1].src).toBe('/content/images/2018/08/NatGeo02-10.jpg');

    expect(images[1].caption).toBe('A link to <a href="/post">an internal post</a>');
  ...
  it('transforms urls relative to absolute', function () {
    ...
    expect(images[0].src).toBe('http://127.0.0.1:2369/content/images/2018/08/NatGeo01-9.jpg');

    expect(images[1].src).toBe('http://127.0.0.1:2369/content/images/2018/08/NatGeo02-10.jpg');
