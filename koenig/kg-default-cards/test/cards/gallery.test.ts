...
describe('Gallery card', function () {
    ...
    describe('sizes', function () {
        it('is included for images over 720px', function () {
            ...
            expect(output).toMatch(/photo\?w=2000 2000w" sizes="\(min-width: 720px\) 720px"/);
        });
        ...
        it('uses "wide" media query for large single-image galleries', function () {
            ...
            expect(serializer.serialize(card.render(opts))).toMatch(/standard\.jpg 2000w" sizes="\(min-width: 1200px\) 1200px"/);
        });
        ...
        it('uses "standard" media query for medium single-image galleries', function () {
            ...
            expect(serializer.serialize(card.render(opts))).toMatch(/standard\.jpg 1000w" sizes="\(min-width: 720px\) 720px"/);
        });
    ...
    describe('email target', function () {
        it('adds width/height and uses resized images', function () {
            ...
            expect(output.match(/width="600"/g)!.length).toBe(3);
            ...
            expect(output).toMatch(/https:\/\/images\.unsplash\.com\/unsplash\.jpg\?w=1200/);
        });
    ...
    it('transforms urls absolute to relative', function () {
        ...
        expect(images[0].caption)
            .toBe('A link to <a href="/post">an internal post</a>');

        expect(images[1].src)
            .toBe('/content/images/2018/08/NatGeo02-10.jpg');

        expect(images[1].caption)
            .toBe('A link to <a href="/post">an internal post</a>');
    ...
    it('transforms urls relative to absolute', function () {
        ...
        expect(images[1].src)
            .toBe('http://127.0.0.1:2369/content/images/2018/08/NatGeo02-10.jpg');
