...
describe('Callout card', function () {
    describe('front-end render', function () {
        it('renders the callout nodes with card wrapper element', function () {
            ...
            serializer.serialize(card.render(opts)).should.equal('<div class="kg-card kg-card-callout kg-card-callout-"><div class="kg-callout-emoji">⚠️</div><div class="kg-callout-text gh-content">This is a callout</div></div>');
        });
        ...
        it('renders the callout nodes without the emoji element', function () {
            ...
            serializer.serialize(card.render(opts)).should.equal('<div class="kg-card kg-card-callout kg-card-callout-"><div class="kg-callout-text gh-content">This is a callout</div></div>');
        });
    });
