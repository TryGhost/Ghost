...
describe('Bookmark card', function () {
    ...
    it('skips icon when missing', function () {
        ...
        serializer.serialize(card.render(opts))
            .should.containEql('<figure class="kg-card kg-bookmark-card kg-card-hascaption"><a class="kg-bookmark-container" href="http://example.com"><div class="kg-bookmark-content"><div class="kg-bookmark-title">Title</div><div class="kg-bookmark-description">Description</div><div class="kg-bookmark-metadata"><span class="kg-bookmark-publisher">Publisher</span><span class="kg-bookmark-author">Author</span></div></div><div class="kg-bookmark-thumbnail"><img src="http://exampple.com/thumbnail.png" alt=""></div></a><figcaption>Caption</figcaption></figure>');
    });
    ...
    it('skips thumbnail when missing', function () {
        ...
        serializer.serialize(card.render(opts))
            .should.containEql('<figure class="kg-card kg-bookmark-card kg-card-hascaption"><a class="kg-bookmark-container" href="http://example.com"><div class="kg-bookmark-content"><div class="kg-bookmark-title">Title</div><div class="kg-bookmark-description">Description</div><div class="kg-bookmark-metadata"><img class="kg-bookmark-icon" src="http://example.com/icon.png" alt=""><span class="kg-bookmark-publisher">Publisher</span><span class="kg-bookmark-author">Author</span></div></div></a><figcaption>Caption</figcaption></figure>');
    });
    ...
    it('skips author when missing', function () {
        ...
        serializer.serialize(card.render(opts))
            .should.containEql('<figure class="kg-card kg-bookmark-card kg-card-hascaption"><a class="kg-bookmark-container" href="http://example.com"><div class="kg-bookmark-content"><div class="kg-bookmark-title">Title</div><div class="kg-bookmark-description">Description</div><div class="kg-bookmark-metadata"><img class="kg-bookmark-icon" src="http://example.com/icon.png" alt=""><span class="kg-bookmark-publisher">Publisher</span></div></div><div class="kg-bookmark-thumbnail"><img src="http://exampple.com/thumbnail.png" alt=""></div></a><figcaption>Caption</figcaption></figure>');
    });
    ...
    it('skips publisher when missing', function () {
        ...
        serializer.serialize(card.render(opts))
            .should.containEql('<figure class="kg-card kg-bookmark-card kg-card-hascaption"><a class="kg-bookmark-container" href="http://example.com"><div class="kg-bookmark-content"><div class="kg-bookmark-title">Title</div><div class="kg-bookmark-description">Description</div><div class="kg-bookmark-metadata"><img class="kg-bookmark-icon" src="http://example.com/icon.png" alt=""><span class="kg-bookmark-author">Author</span></div></div><div class="kg-bookmark-thumbnail"><img src="http://exampple.com/thumbnail.png" alt=""></div></a><figcaption>Caption</figcaption></figure>');
    });
    ...
    it('skips caption when missing', function () {
        ...
        serializer.serialize(card.render(opts))
            .should.containEql('<figure class="kg-card kg-bookmark-card"><a class="kg-bookmark-container" href="http://example.com"><div class="kg-bookmark-content"><div class="kg-bookmark-title">Title</div><div class="kg-bookmark-description">Description</div><div class="kg-bookmark-metadata"><img class="kg-bookmark-icon" src="http://example.com/icon.png" alt=""><span class="kg-bookmark-publisher">Publisher</span><span class="kg-bookmark-author">Author</span></div></div><div class="kg-bookmark-thumbnail"><img src="http://exampple.com/thumbnail.png" alt=""></div></a></figure>');
    });
