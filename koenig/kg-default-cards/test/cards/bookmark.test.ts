...
describe('Bookmark card', function () {
  ...
  it('keeps description element when description is blank', function () {
    ...
    expect(serializer.serialize(card.render(opts))).toContain(
      '<figure class="kg-card kg-bookmark-card"><a class="kg-bookmark-container" href="http://example.com"><div class="kg-bookmark-content"><div class="kg-bookmark-title">Test bookmark</div><div class="kg-bookmark-description"></div><div class="kg-bookmark-metadata"></div></div></a></figure>',
    );
  });
  ...
  it('transforms urls absolute to relative', function () {
    ...
    expect(transformed.url as string).toBe('/post');

    expect((transformed.metadata as Record<string, string>).url).toBe('/post');
  ...
  it('transforms urls relative to absolute', function () {
    ...
    expect(transformed.url as string).toBe('http://127.0.0.1:2369/post');

    expect((transformed.metadata as Record<string, string>).url).toBe('http://127.0.0.1:2369/post');
