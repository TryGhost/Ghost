...
describe('Button card', function () {
  describe('front-end render', function () {
    it('generates an anchor element with card wrapper element', function () {
      ...
      expect(serializer.serialize(card.render(opts))).toBe(
        '<div class="kg-card kg-button-card kg-align-left"><a href="https://ghost.org/" class="kg-btn kg-btn-accent">Click me!</a></div>',
      );
    });
    ...
    it('adds center classes when center aligned', function () {
      ...
      expect(serializer.serialize(card.render(opts))).toBe(
        '<div class="kg-card kg-button-card kg-align-center"><a href="https://ghost.org/" class="kg-btn kg-btn-accent">Click me!</a></div>',
      );
    });
  });
  ...
  describe('email render', function () {
    it('generates an email-friendly button in a paragraph', function () {
      ...
      expect(serializer.serialize(card.render(opts))).toBe(
        '<p><div class="btn btn-accent"><table border="0" cellspacing="0" cellpadding="0" align="left"><tr><td align="center"><a href="https://ghost.org/">Click me!</a></td></tr></table></div></p>',
      );
    });
    ...
    it('handles center alignment', function () {
      ...
      expect(serializer.serialize(card.render(opts))).toBe(
        '<p><div class="btn btn-accent"><table border="0" cellspacing="0" cellpadding="0" align="center"><tr><td align="center"><a href="https://ghost.org/">Click me!</a></td></tr></table></div></p>',
      );
    });
  });
