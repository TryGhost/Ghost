...
describe('Markdown card', function () {
  ...
  it('transforms urls absolute to relative', function () {
    ...
    expect(transformed.markdown as string).toBe('A link to [an internal post](/post)');
  });
  ...
  it('transforms urls relative to absolute', function () {
    ...
    expect(transformed.markdown as string).toBe(
      'A link to [an internal post](http://127.0.0.1:2369/post)',
    );
  });
