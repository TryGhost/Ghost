...
const markdownCard: Card = {
  ...
  absoluteToRelative(payload, options) {
    payload.markdown =
      payload.markdown &&
      markdownAbsoluteToRelative(payload.markdown as string, options.siteUrl, options);
    return payload;
  },
  ...
  toTransformReady(payload, options) {
    payload.markdown =
      payload.markdown &&
      markdownToTransformReady(payload.markdown as string, options.siteUrl, options);
    return payload;
  },
};
