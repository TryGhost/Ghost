...
const calloutCard: Card = {
  ...
  absoluteToRelative(payload, options) {
    payload.calloutText =
      payload.calloutText &&
      htmlAbsoluteToRelative(payload.calloutText as string, options.siteUrl, options);
    return payload;
  },
  ...
  toTransformReady(payload, options) {
    payload.calloutText =
      payload.calloutText &&
      htmlToTransformReady(payload.calloutText as string, options.siteUrl, options);
    return payload;
  },
};
