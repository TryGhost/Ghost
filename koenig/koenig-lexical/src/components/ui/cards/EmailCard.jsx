...
export function EmailCard({htmlEditor, htmlEditorInitialState, isEditing}) {
    return (
        <div className="w-full">
            ...
            {isEditing &&
                <div className="-mx-3 mt-3 flex items-center justify-center bg-grey-100 dark:bg-grey-950 p-2 font-sans text-sm font-normal leading-none text-grey-600 dark:text-grey-800">
