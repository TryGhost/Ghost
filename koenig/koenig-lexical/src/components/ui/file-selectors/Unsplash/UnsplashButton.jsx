...
function UnsplashButton({icon, label, ...props}) {
    ...
    return (
        <a className="flex h-8 shrink-0 cursor-pointer items-center rounded-md bg-white py-2 px-3 font-sans text-sm font-medium leading-6 text-grey-700 opacity-90 transition-all ease-in-out first-of-type:mr-3 hover:opacity-100"
            type="button" 
