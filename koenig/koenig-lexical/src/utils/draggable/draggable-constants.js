...
export const CONTAINER_SELECTOR = `[data-${_.kebabCase(CONTAINER_DATA_ATTR)}]`;

export const DRAGGABLE_DATA_ATTR = 'koenigDndDraggable';
export const DRAGGABLE_SELECTOR = `[data-${_.kebabCase(DRAGGABLE_DATA_ATTR)}]`;

export const DROPPABLE_DATA_ATTR = 'koenigDndDroppable';
export const DROPPABLE_SELECTOR = `[data-${_.kebabCase(DROPPABLE_DATA_ATTR)}]`;

export const DRAG_DISABLED_DATA_ATTR = 'koenigDndDisabled';
export const DRAG_DISABLED_SELECTOR = `[data-${_.kebabCase(DRAG_DISABLED_DATA_ATTR)}]`;
