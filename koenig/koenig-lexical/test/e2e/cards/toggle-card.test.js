...
test.describe('Toggle card', async () => {
    ...
    test('can import serialized toggle card nodes with br', async function () {
        const contentParam = encodeURIComponent(JSON.stringify({
            root: {
                children: [{
                    type: 'toggle',
                    heading: '<span>Heading</span><br /><span>Part 2!</span>', // heading shouldn't have wrapper element like <p> or <h4>
                    content: '<p dir="ltr"><span>Content</span></p><p dir="ltr"><span>More Content</span></p>'
                }],
                direction: null,
                format: '',
                indent: 0,
                                    ...
                                    <div class="koenig-lexical-heading">
                                        <div data-kg="editor">
                                            <div
                                                ...
                                                aria-readonly="true"
                                            >
                                                <p dir="ltr"><span data-lexical-text="true">Heading</span>
                                                <br />
                                                <span data-lexical-text="true">Part 2!</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="mt-2 w-full visible">
                                <div>
                                    <div data-kg="editor">
                                        ...
                                        >
                                            <p dir="ltr"><span data-lexical-text="true">Content</span></p>
                                            <p dir="ltr"><span data-lexical-text="true">More Content</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
