...
export function renderVideoNode(node: VideoNodeData, options: VideoRenderOptions = {}) {
    ...
    if (options.target === 'email') {
        ...
        htmlString = cardTemplate({node, options, cardClasses});
    }
...
function cardTemplate({node, options, cardClasses}: {node: VideoNodeData, options: VideoRenderOptions, cardClasses: string}) {
