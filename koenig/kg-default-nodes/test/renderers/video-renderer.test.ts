...
describe('renderers/video-renderer', function () {
    ...
    describe('web', function () {
        ...
        it('omits the poster when spacer images are disabled', function () {
            const result = renderForWeb(getTestData(), {
                imageOptimization: {spacerImage: {urlTemplate: ''}}
            });
        ...
        it('renders null dimensions when width and height are null', function () {
            ...
            assert.ok(!result.html.includes(' poster='));
        });
    ...
    describe('email', function () {
        ...
        it('omits the hidden spacer image when spacer images are disabled', function () {
            const result = renderForEmail(getTestData(), {
                imageOptimization: {spacerImage: {urlTemplate: ''}}
            });
