...
describe('renderers/file-renderer', function () {
    ...
    describe('email', function () {
        ...
        it('escapes HTML in all fields', function () {
            const result = renderForEmail(getTestData({
            ...
            assert.ok(result.html.includes('file&lt;.html'));
            assert.ok(result.html.includes('Title with '));
            assert.ok(result.html.includes('Caption with '));
        });
        ...
        it('links to the file when postUrl is missing', function () {
            const result = renderForEmail(getTestData(), {postUrl: undefined});

            assert.ok(result.html.includes('href="/content/files/2023/03/IMG_0196.jpeg"'));
