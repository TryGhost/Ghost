const {dom, createDocument, html} = require('../utils');
...
describe('AudioNode', function () {
    ...
    describe('data access', function () {
        ...
        it('has setters for all properties', editorTest(function () {
            ...
            audioNode.src.should.equal('/content/audio/2022/12/koenig-lexical.mp3');
            ...
            audioNode.thumbnailSrc.should.equal('/content/images/2022/12/koenig-lexical.png');
        }));
    ...
    describe('clone', function () {
        it('returns a copy of the current node', editorTest(function () {
            const audioNode = $createAudioNode(dataset);
            const audioNodeDataset = audioNode.getDataset();
            const clone = AudioNode.clone(audioNode);
    ...
    describe('importDOM', function () {
        it('parses audio card', editorTest(function () {
            ...
            nodes[0].src.should.equal('/content/audio/2022/11/koenig-lexical.mp3');
            nodes[0].thumbnailSrc.should.equal('/content/images/2022/11/koenig-audio-lexical.jpg');
