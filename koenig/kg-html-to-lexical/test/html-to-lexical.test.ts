...
describe('HTMLtoLexical', function () {
    ...
    describe('HTML from Lexical cards', function () {
        // note: some cards are not intended to convert from html: HTML and email-only cards
        ...
        it('can convert a post containing one of each card type', function () {
            const html = `
                <figure class="kg-card kg-image-card kg-card-hascaption"><img src="__GHOST_URL__/content/images/2023/10/image--1-.png" class="kg-image" alt="" loading="lazy" width="882" height="242" srcset="__GHOST_URL__/content/images/size/w600/2023/10/image--1-.png 600w, __GHOST_URL__/content/images/2023/10/image--1-.png 882w" sizes="(min-width: 720px) 720px"><figcaption><span style="white-space: pre-wrap;">image</span></figcaption></figure><p>markdown</p>
    html<figure class="kg-card kg-gallery-card kg-width-wide kg-card-hascaption"><div class="kg-gallery-container"><div class="kg-gallery-row"><div class="kg-gallery-image"><img src="__GHOST_URL__/content/images/2023/10/4b061cbc7f034c4d475797e8f3d37f68.jpg" width="736" height="736" loading="lazy" alt="" srcset="__GHOST_URL__/content/images/size/w600/2023/10/4b061cbc7f034c4d475797e8f3d37f68.jpg 600w, __GHOST_URL__/content/images/2023/10/4b061cbc7f034c4d475797e8f3d37f68.jpg 736w" sizes="(min-width: 720px) 720px"></div><div class="kg-gallery-image"><img src="__GHOST_URL__/content/images/2023/10/2560px-Mandolin_guitar_band_crystal_palace.jpg" width="2000" height="1526" loading="lazy" alt="" srcset="__GHOST_URL__/content/images/size/w600/2023/10/2560px-Mandolin_guitar_band_crystal_palace.jpg 600w, __GHOST_URL__/content/images/size/w1000/2023/10/2560px-Mandolin_guitar_band_crystal_palace.jpg 1000w, __GHOST_URL__/content/images/size/w1600/2023/10/2560px-Mandolin_guitar_band_crystal_palace.jpg 1600w, __GHOST_URL__/content/images/size/w2400/2023/10/2560px-Mandolin_guitar_band_crystal_palace.jpg 2400w" sizes="(min-width: 720px) 720px"></div></div></div><figcaption><p dir="ltr"><span style="white-space: pre-wrap;">gallery</span></p></figcaption></figure><hr><figure class="kg-card kg-bookmark-card kg-card-hascaption"><a class="kg-bookmark-container" href="https://ghost.org/"><div class="kg-bookmark-content"><div class="kg-bookmark-title">Ghost: The Creator Economy Platform</div><div class="kg-bookmark-description">The world’s most popular modern publishing platform for creating a new media platform. Used by Apple, SkyNews, Buffer, Kickstarter, and thousands more.</div><div class="kg-bookmark-metadata"><img class="kg-bookmark-icon" src="https://ghost.org/favicon.ico" alt=""><span class="kg-bookmark-author">Ghost - The Professional Publishing Platform</span></div></div><div class="kg-bookmark-thumbnail"><img src="https://ghost.org/images/meta/ghost.png" alt=""></div></a><figcaption><p dir="ltr"><span style="white-space: pre-wrap;">bookmark</span></p></figcaption></figure><!--members-only--><div class="kg-card kg-button-card kg-align-center"><a href="__GHOST_URL__/" class="kg-btn kg-btn-accent">button</a></div><div class="kg-card kg-callout-card kg-callout-card-blue"><div class="kg-callout-emoji">💡</div><div class="kg-callout-text">callout</div></div><div class="kg-card kg-toggle-card" data-kg-toggle-state="close">
                <div class="kg-toggle-heading">
                    <h4 class="kg-toggle-heading-text"><span style="white-space: pre-wrap;">toggle header</span></h4>
                ...
                <div class="kg-toggle-content"><p dir="ltr"><span style="white-space: pre-wrap;">toggle content</span></p></div>
            </div><figure class="kg-card kg-video-card kg-width-regular kg-card-hascaption" data-kg-thumbnail="http://localhost:2368/content/media/2023/10/CleanShot-2023-03-24-at-11.10.13_thumb.jpg" data-kg-custom-thumbnail="">
                <div class="kg-video-container">
                    <video src="__GHOST_URL__/content/media/2023/10/CleanShot-2023-03-24-at-11.10.13.mp4" poster="https://img.spacergif.org/v1/884x744/0a/spacer.png" width="884" height="744" playsinline="" preload="metadata" style="background: transparent url('__GHOST_URL__/content/media/2023/10/CleanShot-2023-03-24-at-11.10.13_thumb.jpg') 50% 50% / cover no-repeat;"></video>
            ...
            </figure><div class="kg-card kg-audio-card"><img src="" alt="audio-thumbnail" class="kg-audio-thumbnail kg-audio-hide"><div class="kg-audio-thumbnail placeholder"><svg width="24" height="24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.5 15.33a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm-2.25.75a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0ZM15 13.83a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm-2.25.75a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0Z"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M14.486 6.81A2.25 2.25 0 0 1 17.25 9v5.579a.75.75 0 0 1-1.5 0v-5.58a.75.75 0 0 0-.932-.727.755.755 0 0 1-.059.013l-4.465.744a.75.75 0 0 0-.544.72v6.33a.75.75 0 0 1-1.5 0v-6.33a2.25 2.25 0 0 1 1.763-2.194l4.473-.746Z"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M3 1.5a.75.75 0 0 0-.75.75v19.5a.75.75 0 0 0 .75.75h18a.75.75 0 0 0 .75-.75V5.133a.75.75 0 0 0-.225-.535l-.002-.002-3-2.883A.75.75 0 0 0 18 1.5H3ZM1.409.659A2.25 2.25 0 0 1 3 0h15a2.25 2.25 0 0 1 1.568.637l.003.002 3 2.883a2.25 2.25 0 0 1 .679 1.61V21.75A2.25 2.25 0 0 1 21 24H3a2.25 2.25 0 0 1-2.25-2.25V2.25c0-.597.237-1.169.659-1.591Z"></path></svg></div><div class="kg-audio-player-container"><audio src="__GHOST_URL__/content/media/2023/10/redal660320d1_02_Im_Thinking_Tonight_of_My_Blue_Eyes.mp3" preload="metadata"></audio><div class="kg-audio-title">Redal660320d1 02 Im Thinking Tonight of My Blue Eyes</div><div class="kg-audio-player"><button class="kg-audio-play-icon"><svg viewBox="0 0 24 24"><path d="M23.14 10.608 2.253.164A1.559 1.559 0 0 0 0 1.557v20.887a1.558 1.558 0 0 0 2.253 1.392L23.14 13.393a1.557 1.557 0 0 0 0-2.785Z"></path></svg></button><button class="kg-audio-pause-icon kg-audio-hide"><svg viewBox="0 0 24 24"><rect x="3" y="1" width="7" height="22" rx="1.5" ry="1.5"></rect><rect x="14" y="1" width="7" height="22" rx="1.5" ry="1.5"></rect></svg></button><span class="kg-audio-current-time">0:00</span><div class="kg-audio-time">/<span class="kg-audio-duration">152.607347</span></div><input type="range" class="kg-audio-seek-slider" max="100" value="0"><button class="kg-audio-playback-rate">1×</button><button class="kg-audio-unmute-icon"><svg viewBox="0 0 24 24"><path d="M15.189 2.021a9.728 9.728 0 0 0-7.924 4.85.249.249 0 0 1-.221.133H5.25a3 3 0 0 0-3 3v2a3 3 0 0 0 3 3h1.794a.249.249 0 0 1 .221.133 9.73 9.73 0 0 0 7.924 4.85h.06a1 1 0 0 0 1-1V3.02a1 1 0 0 0-1.06-.998Z"></path></svg></button><button class="kg-audio-mute-icon kg-audio-hide"><svg viewBox="0 0 24 24"><path d="M16.177 4.3a.248.248 0 0 0 .073-.176v-1.1a1 1 0 0 0-1.061-1 9.728 9.728 0 0 0-7.924 4.85.249.249 0 0 1-.221.133H5.25a3 3 0 0 0-3 3v2a3 3 0 0 0 3 3h.114a.251.251 0 0 0 .177-.073ZM23.707 1.706A1 1 0 0 0 22.293.292l-22 22a1 1 0 0 0 0 1.414l.009.009a1 1 0 0 0 1.405-.009l6.63-6.631A.251.251 0 0 1 8.515 17a.245.245 0 0 1 .177.075 10.081 10.081 0 0 0 6.5 2.92 1 1 0 0 0 1.061-1V9.266a.247.247 0 0 1 .073-.176Z"></path></svg></button><input type="range" class="kg-audio-volume-slider" max="100" value="100"></div></div></div><div class="kg-card kg-file-card"><a class="kg-file-card-container" href="__GHOST_URL__/content/files/2023/10/20170622_WCR_Sensory_Lexicon_2-0-1.pdf" title="Download" download=""><div class="kg-file-card-contents"><div class="kg-file-card-title">20170622_WCR_Sensory_Lexicon_2-0-1</div><div class="kg-file-card-caption"></div><div class="kg-file-card-metadata"><div class="kg-file-card-filename">20170622_WCR_Sensory_Lexicon_2-0-1.pdf</div><div class="kg-file-card-filesize">1 MB</div></div></div><div class="kg-file-card-icon"><svg viewBox="0 0 24 24"><defs><style>.a{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}</style></defs><title>download-circle</title><polyline class="a" points="8.25 14.25 12 18 15.75 14.25"></polyline><line class="a" x1="12" y1="6.75" x2="12" y2="18"></line><circle class="a" cx="12" cy="12" r="11.25"></circle></svg></div></a></div><div class="kg-card kg-product-card">
                <div class="kg-product-card-container">
                    <img src="__GHOST_URL__/content/images/2023/10/CleanShot-2023-07-19-at-12.57.37@2x.png" width="724" height="76" class="kg-product-card-image" loading="lazy">
            ...
            assert.deepEqual(outputNodeTypes, [
                ...
                'paragraph', // html parses as paragraph/text content
                'gallery',
                'horizontalrule',
                'bookmark',
                'paywall',
