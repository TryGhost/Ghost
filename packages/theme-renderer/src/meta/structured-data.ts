...
// Copied from ghost/core/core/frontend/meta/structured-data.js @ 407e032dc7 — transforms: imports→seam
import socialUrls from '@tryghost/social-urls';

function getStructuredData(metaData: any) {
  ...
  return Object.keys(structuredData).reduce(function (data: any, key) {
