...
// Copied from ghost/core/core/frontend/meta/url.js @ 407e032dc7 — transforms: imports→seam
import errors from '@tryghost/errors';
import {logging} from '../seam/shared.ts';
import {urlService, urlUtils} from '../seam/proxy.ts';
...
function warnMissingUrl(data: any) {
...
function getUrl(data: any, absolute?: boolean) {
