...
// Copied from ghost/core/core/frontend/helpers/body_class.js @ 407e032dc7 — transforms: imports→seam
// # Body Class Helper
// Usage: `{{body_class}}`
//
// Output classes for the body element
import {settingsCache} from '../seam/proxy.ts';
import {generateCustomFontBodyClass, isValidCustomFont, isValidCustomHeadingFont} from '@tryghost/custom-fonts';
...
export default function body_class(this: any, options: any) { // eslint-disable-line camelcase
    let classes: any[] = [];
    ...
    const classesString = classes.join(' ').trim();

    return new SafeString(classesString);
}
