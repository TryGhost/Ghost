...
// Copied from ghost/core/core/frontend/helpers/pagination.js @ 407e032dc7 — transforms: imports→seam
// ### Pagination Helper
// `{{pagination}}`
// Outputs previous and next buttons, along with info about the current page
import { hbs, templates } from '../seam/handlebars-env.ts';
...
export default function pagination(this: any, options: any) {
  options = options || {};
