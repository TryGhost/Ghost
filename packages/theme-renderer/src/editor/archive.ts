...
export const cloneThemeFiles = (files: Record<string, ThemeEditorFile>): Record<string, ThemeEditorFile> => {
...
export const packThemeArchive = async ({files, rootPrefix}: ThemeEditorSnapshot): Promise<Blob> => {
    const zip = new JSZip();
