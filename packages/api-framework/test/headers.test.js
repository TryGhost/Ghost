...
describe('Headers', function () {
    ...
    describe('config.disposition', function () {
        it('json', function () {
            return shared.headers
                .get({}, { disposition: { type: 'json', value: 'value' } }, new Frame())
                .then((result) => {
                    assert.deepEqual(result, {
        ...
        it('csv', function () {
            return shared.headers
                .get({}, { disposition: { type: 'csv', value: 'my.csv' } }, new Frame())
                .then((result) => {
                    assert.deepEqual(result, {
        ...
        it('file', async function () {
            const result = await shared.headers.get(
                {},
                { disposition: { type: 'file', value: 'my.txt' } },
                new Frame(),
            );
            assert.deepEqual(result, {
        ...
        it('yaml', function () {
            return shared.headers
                .get('yaml file', { disposition: { type: 'yaml', value: 'my.yaml' } }, new Frame())
                .then((result) => {
                    assert.deepEqual(result, {
    ...
    describe('config.cacheInvalidate', function () {
        it('default', function () {
            return shared.headers.get({}, { cacheInvalidate: true }, new Frame()).then((result) => {
                assert.deepEqual(result, {
                    'X-Cache-Invalidate': '/*',
                });
            });
        ...
        it('custom value', function () {
            return shared.headers
                .get({}, { cacheInvalidate: { value: 'value' } }, new Frame())
                .then((result) => {
                    assert.deepEqual(result, {
