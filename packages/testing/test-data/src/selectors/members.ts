...
export const memberDetailTitle = 'member-detail-title';
export const memberDetailEngagement = 'member-detail-engagement';
export const memberActions = 'member-actions';
export const memberSubscriptionToggle = 'member-subscription-toggle';
export const memberSigninUrl = 'member-signin-url';
