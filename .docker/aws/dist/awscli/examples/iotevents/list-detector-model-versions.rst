...
For more information, see `ListDetectorModelVersions <https://docs.aws.amazon.com/iotevents/latest/apireference/API_ListDetectorModelVersions>`__ in the *AWS IoT Events API Reference*.
