...
function ActionButton({
    ...
    return (
        <button className={className} style={Style.button} onClick={onClick ? e => onClick(e) : undefined} disabled={disabled} type='submit' tabIndex={tabindex} data-test-button={dataTestId}>
