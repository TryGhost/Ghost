...
import {getCurrencySymbol, formatNumber, getStripeAmount, isCookiesDisabled} from '../../utils/helpers';
...
const BetaGiftPage = () => {
    ...
    // Both uses sit in front of a noun ("6 month membership"), so this is the
    // attributive form. The picker and the gift card face use the standalone
    // one ("6 months").
    const activeDurationLabel = getGiftDurationAttributiveLabel({cadence: 'month', duration: activeDuration});
