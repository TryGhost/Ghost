...
describe('App', function () {
    ...
    test('parses a valid preview hash', () => {
        window.location.hash = '#/portal/preview?button=true&isFree=true&isMonthly=true&isYearly=false&signupCheckboxRequired=false&signupGiftPromotion=true&accountGiftPromotion=false&previewTheme=dark';
