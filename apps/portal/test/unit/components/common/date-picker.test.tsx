...
const renderPicker = (props: Record<string, unknown> = {}, contextOverrides: Record<string, unknown> = {}): RenderPickerUtils => {
...
const dayButton = ({getByText}: RenderPickerUtils, day: number) => getByText(String(day), {selector: 'button.gh-portal-datepicker-day-button'});
