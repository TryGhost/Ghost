import {getFreeProduct, getProductData, getSiteData} from '../../../../src/utils/fixtures-generator';
...
describe('SignupPage', () => {
    ...
    test.each([
        ...
        },
        {
            ...
            site: {...getSiteData({labs: {giftSubCustomization: true}}), portal_signup_gift_promotion: false}
        },
        {
        ...
        },
        {
            ...
            site: {...getSiteData({labs: {giftSubCustomization: true}, portalPlans: ['free']}), portal_signup_gift_promotion: true}
        }
