...
const setup = (overrides) => {
  const { mockDoActionFn, ...utils } = render(<PaidAccountActions />, {
    overrideContext: {
      ...overrides,
    },
  });
...
describe('PaidAccountActions', () => {
  ...
  describe('PlanUpdateButton', () => {
    ...
    test('renders "Continue" for a gift member whose tier is still active', () => {
      ...
      expect(
        container.querySelector('[data-test-button="continue-gift-subscription"]'),
      ).toBeInTheDocument();
    ...
    test('renders nothing for a free member', () => {
      ...
      expect(
        container.querySelector('[data-test-button="manage-billing"]'),
      ).not.toBeInTheDocument();
    });
  });
  ...
  describe('Billing section', () => {
    ...
    test('billing section row is keyboard-activatable and opens manage billing', () => {
      ...
      const billingRow = container
        .querySelector('[data-test-button="manage-billing"]')
        .closest('section');
