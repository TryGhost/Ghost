...
import {getMemberData, getSiteData, getSubscriptionData} from '../../../../../src/utils/fixtures-generator';
...
const paidMember = (overrides = {}) => getMemberData({
    paid: true,
    status: 'paid',
...
const setup = ({site = paidSite(), member = paidMember()} = {}) => render(
    <GiveGiftCard />,
