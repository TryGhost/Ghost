...
describe('Helpers - ', () => {
  ...
  describe('isPaidMembersOnly - ', () => {
    test('returns true for paid-members-only site', () => {
      const isPaidMembersOnlySite = isPaidMembersOnly({
        site: FixturesSite.singleTier.paidMembersOnly,
      });
  ...
  describe('hasAvailablePrices - ', () => {
    ...
    test('returns true for a site with multiple tiers', () => {
      const hasAvailablePricesCheck = hasAvailablePrices({
    ...
    test('returns false for a site with no plans', () => {
      const hasAvailablePricesCheck = hasAvailablePrices({
        site: FixturesSite.singleTier.withoutPlans,
      });
  ...
  describe('getActiveInterval', () => {
    ...
    test('returns undefined when portalPlans is empty', () => {
      expect(
        getActiveInterval({ portalPlans: [], portalDefaultPlan: null, selectedInterval: null }),
      ).toBeUndefined();
    });
  });
