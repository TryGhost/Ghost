...
// `build:watch`, so the dir is missing on the first ~1s of a fresh clone.
// Defining configurePreviewServer is Vite's documented opt-out from that
// guard; the underlying sirv server already 404s for missing files.
