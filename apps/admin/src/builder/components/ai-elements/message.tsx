...
export const MessageContent = ({from, status, className, children, ...props}: HTMLAttributes<HTMLDivElement> & {
    from: 'user' | 'assistant';
...
export const MessageResponse = memo(({className, children, ...props}: ComponentProps<typeof Streamdown>) => (
    <Streamdown
        className={cn('size-full min-w-0 wrap-break-word [&>*:first-child]:mt-0 [&>*:last-child]:mb-0', className)}
        {...props}
