...
import { type CommentsOverviewTopMember } from '@tryghost/admin-x-framework/api/stats';
...
const renderRows = (
  members: CommentsOverviewTopMember[],
  onRowClick: (memberId: string) => void,
) => (
...
const OverviewTopMembers: React.FC<OverviewTopMembersProps> = ({
  members,
  range,
  isLoading,
  onRowClick,
