...
const PlaceholderRow = forwardRef<HTMLDivElement>(function PlaceholderRow(props, ref) {
  return (
    <div ref={ref} {...props} aria-hidden="true" className="relative flex flex-col">
                    ...
                    <div className="flex min-w-0 flex-col gap-3">
                      <div>
                        <CommentHeader
                          ...
                          onPostClick={
                            item.post?.id ? () => onAddFilter('post', item.post!.id) : undefined
                          }
                        ...
                        {item.in_reply_to_snippet && (
                          <div
                            className={`mb-1 line-clamp-1 max-w-3xl ${item.status === 'hidden' && 'opacity-50'}`}
                          >
                            ...
                            <Link
                              ...
                              to={
                                buildThreadLink(
                                  searchParams,
                                  item.in_reply_to_id || item.parent_id,
                                ) || ''
                              }
                              onClick={(e) => {
                                e.stopPropagation();
