...
function CommentRow({
  ...
  return (
    <div className={`flex w-full flex-row ${containerClassName}`}>
      ...
      <div className="grow">
        <div className="w-full" data-testid={`comment-thread-row-${comment.id}`}>
          <div className="flex min-w-0 flex-col">
            ...
            {comment.in_reply_to_snippet && isSelectedComment && (
              <div
                className={`mb-1 line-clamp-1 text-sm ${comment.status === 'hidden' && 'opacity-50'}`}
              >
                ...
                <Link
                  ...
                  to={
                    buildThreadLink(searchParams, comment.in_reply_to_id || comment.parent_id) || ''
                  }
            ...
            <div className="mt-4 flex flex-row flex-wrap items-center gap-3">
              ...
              <CommentMetrics comment={comment} dislikesEnabled={dislikesEnabled} />
