    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="gap-5">
        <DialogHeader>
          ...
          <DialogDescription>
            {memberName || 'This member'} won&apos;t be able to comment in the future. You can
            re-enable commenting anytime.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <Label htmlFor="hide-comments">Hide all previous comments</Label>
        </div>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleConfirm}>Disable comments</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
