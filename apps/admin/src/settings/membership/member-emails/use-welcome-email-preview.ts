...
import {
  ...
  getWelcomeEmailValidationErrors,
} from './welcome-email-validation';
...
export const useWelcomeEmailPreview = ({
  automatedEmailId,
  previewWelcomeEmail,
  setErrors,
}: {
  ...
  previewWelcomeEmail: (
    payload: WelcomeEmailDraft & { id: string },
  ) => Promise<WelcomeEmailPreviewResponse>;
