    ...
    <Stack gap="xl">
      ...
      <Stack gap="md">
        ...
        <Field orientation="horizontal">
          <FieldContent>
            <FieldLabel htmlFor="transistor-portal-enabled">
              Enable Transistor integration
            </FieldLabel>
            <FieldDescription>
              Show a section on the account page for members to access private podcasts
            </FieldDescription>
          </FieldContent>
          <Switch
            checked={enabled}
            id="transistor-portal-enabled"
            onCheckedChange={(checked) => updateSetting('transistor_portal_enabled', checked)}
          />
        </Field>
      </Stack>
      {enabled && (
        <FieldGroup className="gap-6">
          <Field>
            <FieldLabel htmlFor="transistor-heading">Heading</FieldLabel>
            <Input
              id="transistor-heading"
              placeholder="Podcasts"
              value={heading}
              onChange={(e) => updateSetting('transistor_portal_heading', e.target.value)}
            />
            <FieldDescription>The heading displayed above the Transistor section</FieldDescription>
          </Field>
          <Field>
            <FieldLabel htmlFor="transistor-description">Description</FieldLabel>
            <Input
              id="transistor-description"
              placeholder="Access your RSS feeds"
              value={description}
              onChange={(e) => updateSetting('transistor_portal_description', e.target.value)}
            />
            <FieldDescription>A short description of what members can do</FieldDescription>
          </Field>
          <Field>
            <FieldLabel htmlFor="transistor-button-text">Button text</FieldLabel>
            <Input
              id="transistor-button-text"
              placeholder="Manage"
              value={buttonText}
              onChange={(e) => updateSetting('transistor_portal_button_text', e.target.value)}
            />
            <FieldDescription>The text displayed on the button</FieldDescription>
          </Field>
          <Field>
            <FieldLabel htmlFor="transistor-url-template">URL template</FieldLabel>
            <Input
              id="transistor-url-template"
            ...
            />
            <FieldDescription>
              Use {'{memberUuid}'} as a placeholder for the member ID
            </FieldDescription>
          </Field>
        </FieldGroup>
      )}
