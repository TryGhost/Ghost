...
/**
 * The rendered-preview iframe for the welcome email modal, ported from the
 * legacy member-emails/welcome-email-preview-frame.tsx: sizes the iframe to
 * its document height and keeps it hidden until measured.
 */
export function WelcomeEmailPreviewFrame({ previewState }: { previewState: WelcomeEmailPreviewFrameState }) {
