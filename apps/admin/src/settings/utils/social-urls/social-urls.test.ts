...
const FIXTURES: PlatformFixture[] = [
  ...
  },
  {
    ...
    valid: [
      ...
      [
        'facebook.com/profile.php?id=100086939887650',
        'https://www.facebook.com/profile.php?id=100086939887650',
      ],
    ],
    invalid: [
    ...
    handles: [
      ...
      [
        'pages/some-facebook-page/857469375913?ref=ts',
        'https://www.facebook.com/pages/some-facebook-page/857469375913?ref=ts',
      ],
    ],
    invalidHandles: [['my page', FACEBOOK_ERROR]],
    urlHandles: [
  ...
  },
  {
    ...
    valid: [
      ...
      [
        'youtube.com/channel/UC4QobU6STFB0P71PMvOGN5A',
      ...
      [
        'youtube.com/@%E6%97%A5%E6%9C%AC%E8%AA%9E%E3%83%8F%E3%83%B3%E3%83%89%E3%83%AB',
        'https://www.youtube.com/@日本語ハンドル',
      ],
  ...
  },
  {
    ...
    valid: [
      ...
      [
        'linkedin.com/company/ghost-foundation',
        'https://www.linkedin.com/company/ghost-foundation',
      ],
      [
        'https://www.linkedin.com/company/ghost-foundation/',
        'https://www.linkedin.com/company/ghost-foundation',
  ...
  },
  {
    ...
    valid: [
      ...
      [
        'www.bsky.app/profile/did:plc:g67wcylkodj4rrrgh26eifkq',
        'https://bsky.app/profile/did:plc:g67wcylkodj4rrrgh26eifkq',
      ],
      [
        'did:plc:g67wcylkodj4rrrgh26eifkq',
        'https://bsky.app/profile/did:plc:g67wcylkodj4rrrgh26eifkq',
      ],
      [
        'did:plc:THISWILLBELOWERCASED4567',
        'https://bsky.app/profile/did:plc:thiswillbelowercased4567',
      ],
      ...
      [
        'thisusernameistoolongforblueskybutisadomain.com',
        'https://bsky.app/profile/thisusernameistoolongforblueskybutisadomain.com',
      ],
  ...
  },
  {
    ...
    valid: [
      ...
      [
        'mastodon.xyz/@Flipboard@flipboard.social',
        'https://mastodon.xyz/@Flipboard@flipboard.social',
      ],
...
describe('sanitiseMastodonUrl', () => {
  it('strips the protocol', () => {
    assert.equal(
      sanitiseMastodonUrl('https://mastodon.xyz/@Flipboard@flipboard.social'),
      'mastodon.xyz/@Flipboard@flipboard.social',
    );
    assert.equal(
      sanitiseMastodonUrl('https://mastodon.social/@user@other.instance'),
      'mastodon.social/@user@other.instance',
    );
  });
});
