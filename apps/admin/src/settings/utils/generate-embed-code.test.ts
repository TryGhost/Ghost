...
describe('generateCode', function () {
  ...
  it('generates a basic embed script', function () {
    assert.equal(
      generateCode(genOptions),
      '<div style="min-height: 58px;max-width: 440px;margin: 0 auto;width: 100%"><script src="https://example.com" data-button-color="#000000" data-button-text-color="#FFFFFF" data-site="https://example.com" data-locale="af" async></script></div>',
    );
  });
  ...
  it('generates a basic embed script with labels', function () {
    ...
    assert.equal(
      generateCode(genOptions),
      '<div style="min-height: 58px;max-width: 440px;margin: 0 auto;width: 100%"><script src="https://example.com" data-label-1="label1" data-label-2="label2" data-button-color="#000000" data-button-text-color="#FFFFFF" data-site="https://example.com" data-locale="af" async></script></div>',
    );
  });
  ...
  it('renders a full preview', function () {
    ...
    assert.equal(
      generateCode(genOptions),
      '<div data-preview-layout="all-in-one" style="height: 100vh"><script src="https://example.com" data-background-color="#000000" data-text-color="#FFFFFF" data-button-color="#000000" data-button-text-color="#FFFFFF" data-title="" data-description="" data-site="https://example.com" data-locale="af" async></script></div>',
    );
  });
  ...
  it('generates text color based on background color - light background, black text', function () {
    ...
    assert.equal(
      generateCode(genOptions),
      '<div style="height: 40vmin;min-height: 360px"><script src="https://example.com" data-background-color="#ffffff" data-text-color="#000000" data-button-color="#000000" data-button-text-color="#FFFFFF" data-title="" data-description="" data-site="https://example.com" data-locale="af" async></script></div>',
    );
  });
  ...
  it('generates text color based on background color - black background, light text', function () {
    ...
    assert.equal(
      generateCode(genOptions),
      '<div style="height: 40vmin;min-height: 360px"><script src="https://example.com" data-background-color="#000000" data-text-color="#FFFFFF" data-button-color="#000000" data-button-text-color="#FFFFFF" data-title="" data-description="" data-site="https://example.com" data-locale="af" async></script></div>',
    );
  });
});
