...
export const renderSenderEmail = (
  newsletter: Pick<Newsletter, 'sender_email'>,
  config: Config,
...
export const renderReplyToEmail = (
  newsletter: Pick<Newsletter, 'sender_email' | 'sender_reply_to'>,
  config: Config,
...
export const renderReplyToEmailPlaceholder = (
  newsletter: Pick<Newsletter, 'sender_email' | 'sender_reply_to'>,
  config: Config,
  supportEmailAddress: string | undefined,
  defaultEmailAddress: string | undefined,
  ...
  if (newsletter.sender_reply_to === 'newsletter') {
    return (
      renderSenderEmail(newsletter, config, defaultEmailAddress) ||
      supportEmailAddress ||
      defaultEmailAddress ||
      ''
    );
