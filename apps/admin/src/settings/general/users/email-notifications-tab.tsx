      ...
      <div>
        ...
        <div className="mt-3 flex flex-col gap-4">
          <Field orientation="horizontal">
            ...
            <Switch
              checked={Boolean(user.comment_notifications)}
              id="comment-notifications"
              onCheckedChange={(checked) =>
                setUserData({ ...user, comment_notifications: checked })
              }
            />
          </Field>
          {hasAdminAccess(user) && (
            <Field orientation="horizontal">
              <FieldContent>
                ...
                <FieldDescription>
                  Every time another publisher recommends you to their audience
                </FieldDescription>
              </FieldContent>
              <Switch
                checked={Boolean(user.recommendation_notifications)}
                id="recommendation-notifications"
                onCheckedChange={(checked) =>
                  setUserData({ ...user, recommendation_notifications: checked })
                }
              />
            </Field>
          )}
          ...
          <div>
            ...
            <div className="mt-3 flex flex-col gap-4">
              <Field orientation="horizontal">
                ...
                <Switch
                  checked={Boolean(user.free_member_signup_notification)}
                  id="free-member-signup-notifications"
                  onCheckedChange={(checked) =>
                    setUserData({ ...user, free_member_signup_notification: checked })
                  }
                />
              </Field>
              {hasStripeEnabled && (
                <>
                  <Field orientation="horizontal">
                    <FieldContent>
                      <FieldLabel htmlFor="paid-subscription-started-notifications">
                        New paid members
                      </FieldLabel>
                      <FieldDescription>
                    ...
                    <Switch
                      checked={Boolean(user.paid_subscription_started_notification)}
                      id="paid-subscription-started-notifications"
                      onCheckedChange={(checked) =>
                        setUserData({ ...user, paid_subscription_started_notification: checked })
                      }
                    />
                  </Field>
                  <Field orientation="horizontal">
                    <FieldContent>
                      <FieldLabel htmlFor="paid-subscription-canceled-notifications">
                    ...
                    <Switch
                      checked={Boolean(user.paid_subscription_canceled_notification)}
                      id="paid-subscription-canceled-notifications"
                      onCheckedChange={(checked) =>
                        setUserData({ ...user, paid_subscription_canceled_notification: checked })
                      }
                    />
                  </Field>
                </>
          ...
          <div>
            ...
            <div className="mt-3 flex flex-col gap-4">
              <Field orientation="horizontal">
                ...
                <Switch
                  checked={Boolean(user.milestone_notifications)}
                  id="milestone-notifications"
                  onCheckedChange={(checked) =>
                    setUserData({ ...user, milestone_notifications: checked })
                  }
                />
              </Field>
              {hasStripeEnabled && (
                <Field orientation="horizontal">
                  ...
                  <Switch
                    checked={Boolean(user.donation_notifications)}
                    id="donation-notifications"
                    onCheckedChange={(checked) =>
                      setUserData({ ...user, donation_notifications: checked })
                    }
                  />
                </Field>
              )}
              {hasStripeEnabled && (
                <Field orientation="horizontal">
                  <FieldContent>
                    <FieldLabel htmlFor="gift-subscription-notifications">
                      Gift subscriptions
                    </FieldLabel>
                    <FieldDescription>
                  ...
                  <Switch
                    checked={Boolean(user.gift_subscription_notifications)}
                    id="gift-subscription-notifications"
                    onCheckedChange={(checked) =>
                      setUserData({ ...user, gift_subscription_notifications: checked })
                    }
                  />
                </Field>
              )}
...
const EmailNotificationsTab: React.FC<{ user: User; setUserData: (user: User) => void }> = ({
  user,
  setUserData,
}) => {
  return (
