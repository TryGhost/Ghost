    ...
    <SettingGroupContent>
      ...
      <Field data-invalid={Boolean(errors?.name) || undefined}>
        ...
        {errors?.name ? (
          ...
          <FieldDescription>Use your real name so people can recognize you</FieldDescription>
        )}
      </Field>
      <Field>
      ...
      <Field data-invalid={Boolean(errors?.location) || undefined}>
        ...
        {errors?.location ? (
          ...
          <FieldDescription>Where in the world do you live?</FieldDescription>
        )}
      </Field>
      <Field data-invalid={Boolean(errors?.bio) || undefined}>
        ...
        {errors?.bio ? (
          ...
          <FieldDescription>
            Recommended: {formatNumber(250)} characters. You&lsquo;ve used{' '}
            <span className="font-bold">{formatNumber(user.bio?.length || 0)}</span>
          </FieldDescription>
        )}
      </Field>
