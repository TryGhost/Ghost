...
function VersionLink({ label, version }: { label: string; version: string }) {
  ...
  return (
    <div>
      <strong>{label}:</strong>{' '}
      {link ? (
        <a className="text-green" href={link} rel="noopener noreferrer" target="_blank">
          {version}
        </a>
      ) : (
        version
      ...
      <div className="flex flex-col gap-4 pb-7">
        ...
        <div className="mt-3 flex flex-col gap-1.5">
          ...
          {showSystemInfo() && (
            <>
              ...
              <div>
                <strong>Mail:</strong> {config.mail ? config.mail : 'Native'}
              </div>
            </>
          )}
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <a
            ...
            target="_blank"
          >
            <LucideIcon.Code className="size-4" /> Get involved
          </a>
        </div>
        <Separator />
