...
describe('Staff passwords', () => {
  it("validates and changes another staff user's password", async () => {
    ...
    const passwordApi = fakeAdminEndpoint('PUT', '/users/password/', {
      password: [{ message: 'Password updated' }],
    });
    ...
    await save.click();
    await expect
      .element(modal.getByText('Sorry, you cannot use an insecure password.'))
      .toBeVisible();
