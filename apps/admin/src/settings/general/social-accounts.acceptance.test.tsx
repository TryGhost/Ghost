...
const editedSocialSettings = [
  ...
  { key: 'twitter', value: '@tw', label: 'X', displayValue: 'https://x.com/tw' },
  {
    ...
    value: 'ghost-team',
    label: 'LinkedIn',
    displayValue: 'https://www.linkedin.com/in/ghost-team',
  },
  {
    key: 'bluesky',
    value: 'ghost.bsky.social',
    label: 'Bluesky',
    displayValue: 'https://bsky.app/profile/ghost.bsky.social',
  },
  {
    key: 'threads',
    value: '@ghostteam',
    label: 'Threads',
    displayValue: 'https://www.threads.net/@ghostteam',
  },
  {
    key: 'mastodon',
    value: 'mastodon.social/@ghost',
    label: 'Mastodon',
    displayValue: 'https://mastodon.social/@ghost',
  },
  {
    key: 'tiktok',
    value: '@ghostteam',
    label: 'TikTok',
    displayValue: 'https://www.tiktok.com/@ghostteam',
  },
  {
    key: 'youtube',
    value: '@ghostteam',
    label: 'YouTube',
    displayValue: 'https://www.youtube.com/@ghostteam',
  },
  {
    key: 'instagram',
    value: 'ghostteam',
    label: 'Instagram',
    displayValue: 'https://www.instagram.com/ghostteam',
  },
] as const;
...
describe('Social account settings', () => {
  it('edits all publication social URLs', async () => {
    ...
    await expect
      .element(section.getByLabelText('Facebook'))
      .toHaveValue('https://www.facebook.com/ghost');
