...
// Ghost logo images
import OrbBlack1 from '@/settings/app/assets/images/logos/orb-black-1.png';
import OrbBlack2 from '@/settings/app/assets/images/logos/orb-black-2.png';
import OrbBlack3 from '@/settings/app/assets/images/logos/orb-black-3.png';
import OrbBlack4 from '@/settings/app/assets/images/logos/orb-black-4.png';
import OrbBlack5 from '@/settings/app/assets/images/logos/orb-black-5.png';

// Integration app images
import GoogleDocsIcon from '@/settings/app/assets/images/integrations/google-docs.svg';
import MailchimpIcon from '@/settings/app/assets/images/integrations/mailchimp.svg';
import PatreonIcon from '@/settings/app/assets/images/integrations/patreon.svg';
import PaypalIcon from '@/settings/app/assets/images/integrations/paypal.svg';
import SlackIcon from '@/settings/app/assets/images/integrations/slackicon.png';
import TypeformIcon from '@/settings/app/assets/images/integrations/typeform.svg';
import ZeroBounceIcon from '@/settings/app/assets/images/integrations/zero-bounce.png';
