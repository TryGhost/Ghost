...
import useSearchService, {type ComponentId, type SearchService} from '@/settings/app/utils/search';
import {type ReactNode, createContext, useContext, useState} from 'react';
import {ScrollSectionProvider} from '@/settings/app/hooks/use-scroll-section';
import {type ZapierTemplate} from '@/settings/app/components/settings/advanced/integrations/zapier-modal';
import {officialThemes} from '@/settings/app/data/official-themes';
import {zapierTemplates} from '@/settings/app/data/zapier-templates';
