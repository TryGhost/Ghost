  ...
  return (
    <TopLevelGroup
      customButtons={
        <Button
          className="mt-[-5px]"
          disabled={!checkStripeEnabled(settings, config)}
          size="sm"
          type="button"
          variant="ghost"
          onClick={openOfferListModal}
        >
          Manage offers
        </Button>
      }
      description={
        <>
          Create discounts & coupons to boost new subscriptions and retain existing members.
          <span> </span>
          <a
            className="text-green"
            href="https://ghost.org/help/offers"
