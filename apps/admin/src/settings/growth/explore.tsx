...
const Explore: React.FC<{ keywords: string[] }> = ({ keywords }) => {
  ...
  const toggleSetting = async (key: string, checked: boolean) => {
    const updatedSetting: Setting[] = [{ key, value: checked }];
      ...
      {exploreEnabled ? (
        <SettingGroupContent columns={1}>
          ...
          <Field orientation="horizontal">
            <FieldContent>
              <FieldLabel htmlFor="explore-growth-toggle">
          ...
          >
            <div className="relative w-full max-w-[320px] rounded-lg bg-white p-6 text-black shadow-lg">
              ...
              {icon ? (
                <div
                  className="size-9 rounded-sm bg-cover bg-center"
                  style={{
                ...
                <div
                  className="flex aspect-square size-10 items-center justify-center overflow-hidden rounded-full p-1 text-white"
                  style={{
              ...
              >
                ...
                {shareGrowthData ? (
                  <span
                    className="rounded-sm bg-black px-2 py-0.5 text-sm font-semibold text-white"
                    data-testid="explore-members-count"
                  >
          ...
          <div className="-mx-5 -mb-5 flex items-center justify-between gap-4 rounded-b-xl border-t border-[rgba(142,66,255,0.1)] bg-gradient-to-tr from-[rgba(142,66,255,0.07)] to-[rgba(142,66,255,0.02)] p-6 px-7 md:-mx-7 md:-mb-7">
            ...
            <Button
              className="border border-purple bg-transparent text-purple hover:bg-purple/5 hover:text-purple"
              type="button"
              variant="outline"
              onClick={() => {
