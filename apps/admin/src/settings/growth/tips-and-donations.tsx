...
const TipsAndDonations: React.FC<{ keywords: string[] }> = ({ keywords }) => {
  ...
  const {
    ...
    onValidate: () => {
      return {
        donationsSuggestedAmount: validateCurrencyAmount(
    ...
    >
      <SettingGroupContent columns={1}>
        <Field
          ...
          data-invalid={Boolean(errors.donationsSuggestedAmount) || undefined}
        >
          ...
          {errors.donationsSuggestedAmount && (
            <FieldError>{errors.donationsSuggestedAmount}</FieldError>
          )}
        </Field>
        <CopyField value={donateUrl}>
          ...
          <CopyFieldContent>
            ...
            <CopyFieldActions>
              <Button
                data-testid="preview-shareable-link"
                size="sm"
                type="button"
                variant="ghost"
                onClick={openPreview}
              ...
              <CopyFieldCopyButton copiedLabel="Copied" data-testid="copy-shareable-link">
                Copy link
              </CopyFieldCopyButton>
            </CopyFieldActions>
          </CopyFieldContent>
      ...
      <div className="items-center-mt-1 flex">
        All tips and donations are subject to Stripe&apos;s{' '}
        <a
          className="ml-1 font-medium text-green"
          href="https://ghost.org/help/tips-donations/"
