...
const getActiveRetentionOfferByCadence = (
  offers: Offer[],
...
const getLatestRetentionOfferDateByCadence = (
  offers: Offer[],
  cadence: RetentionCadence,
): string | null => {
  const timestamps = offers
    .filter(
      (offer) =>
        offer.redemption_type === 'retention' && offer.cadence === cadence && offer.created_at,
    )
