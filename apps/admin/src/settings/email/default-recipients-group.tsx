...
import { type SegmentOption, type SegmentOptions, useDefaultRecipientsOptions } from "./use-default-recipients-options";
...
/**
 * The Default recipients group, ported from the legacy
 * email/default-recipients.tsx: the recipient-choice select plus the
 * tier/label/offer segment picker (with saved-filter hydration and retry).
 */

type RecipientValueArgs = {
...
export function DefaultRecipientsGroup({ keywords }: { keywords: string[] }) {
