...
export const parseEditingThemeRoute = (
  path: string,
): { themeName: string | null; isInvalid: boolean } => {
...
export const isDefaultThemeName = (themeName: string) =>
  ['casper', 'source'].includes(themeName.toLowerCase());
