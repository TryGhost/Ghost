...
const OfficialThemes: React.FC<{
  ...
  useEffect(() => {
    ...
    const loopInterval = setInterval(() => {
      setVisibleVariantIdx(
        (visibleVariantIdx + 1) % (getAllVariants(variantLoopTheme).length || 0),
      );
  ...
  return (
    <ModalPage>
          ...
          return (
            ...
            >
                  ...
                  <>
                    {variants.map((variant, idx) => (
                      <img
                        ...
                        className={clsx(
                          'size-full object-contain opacity-0 transition-opacity duration-500',
                          {
                            'opacity-100':
              ...
              <div className="relative mt-3">
                <Text as="h4" className="md:text-xl" leading="heading" size="lg" weight="bold">
                  {theme.name}
                </Text>
                {showVariants ? (
                  variants.map((variant, idx) => (
      ...
      <div
        className="mx-[-8vmin] mt-[8vmin] mb-[-8vmin] bg-black px-[8vmin] py-16 text-center text-lg text-white"
        style={{
      ...
      >
        ...
        <a
          className="inline-block font-semibold text-lime"
