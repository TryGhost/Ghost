        ...
        <TopLevelGroup
            customButtons={(
                <Inline align='center' gap='sm'>
                    {hasDesignBuilder && <Button size='sm' type='button' variant='ghost' onClick={openBuilder}>Build with AI</Button>}
                    <Button size='sm' type='button' variant='ghost' onClick={openPreviewModal}>Customize</Button>
                </Inline>
            )}
