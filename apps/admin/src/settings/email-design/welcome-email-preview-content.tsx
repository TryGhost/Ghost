import CoverImage from '@/settings/assets/images/email-design-user-image.jpg';
import React from 'react';
import { cn } from '@tryghost/shade/utils';
import {
  resolveAllColors,
  resolveButtonCorners,
  resolveFontFamily,
  resolveImageCorners,
} from './design-utils';
...
const WelcomeEmailPreviewContent: React.FC = () => {
  ...
  return (
    <div className="mx-auto w-full max-w-[600px] px-10 pt-16">
      <h3 className={titleFontClasses} style={{ color: colors.sectionTitleColor }}>
        Your welcome email
      </h3>
      ...
      >
        ...
        <p className="mt-0 mb-8">
          Use the settings on the right to shape the design — from colors and typography to layout
          and buttons — so it feels like a natural extension of your brand.
        </p>

        {/* Image */}
        <div className={cn('h-[unset] w-full max-w-[600px] bg-cover bg-no-repeat')}>
          <img
        ...
        <div
          className="mt-1 w-full max-w-[600px] pb-8 text-center text-body-sm"
        ...
        <p className="mt-0 mb-6">
          Welcome emails set the tone for your relationship with new members. We’ve optimized this
          template to look great across devices and inboxes, so your first impression lands exactly
          how you want it.
        </p>
      </div>
      ...
      >
        <p className="mt-0 mb-6">
          ...
          that walks through all the available settings, along with a few examples of what’s
          possible.
        </p>
      </div>
