...
export const settingsRouteChildren: RouteObject[] = [
    ...
    {path: 'staff/invite', lazy: lazyComponent(() => import('./app/components/settings/general/invite-user-modal'))},
    {path: 'staff/:slug', lazy: lazyComponent(() => import('./app/components/settings/general/user-detail-modal'))},
    {path: 'staff/:slug/edit', lazy: lazyComponent(() => import('./app/components/settings/general/user-detail-modal'))},
    {path: 'staff/:slug/social-links', lazy: lazyComponent(() => import('./app/components/settings/general/user-detail-modal'))},
    {path: 'staff/:slug/email-notifications', lazy: lazyComponent(() => import('./app/components/settings/general/user-detail-modal'))},
    {path: 'portal/edit', lazy: lazyComponent(() => import('./app/components/settings/membership/portal/portal-modal'))},
    {path: 'tiers/add', lazy: lazyComponent(() => import('./app/components/settings/membership/tiers/tier-detail-modal'))},
    {path: 'tiers/:tierId', lazy: lazyComponent(() => import('./app/components/settings/membership/tiers/tier-detail-modal'))},
    {path: 'stripe-connect', lazy: lazyComponent(() => import('./app/components/settings/membership/stripe/stripe-connect-modal'))},
    ...
    {path: 'about', lazy: lazyComponent(() => import('./app/components/settings/general/about'))},
