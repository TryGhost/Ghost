...
const StripeButton: React.FC<StripeButtonProps> = ({
  ...
  if (href) {
    return (
      <Button className={classNames} variant={variant ?? null} asChild {...props}>
  ...
  return (
    <Button className={classNames} type="button" variant={variant ?? null} {...props}>
      {label}
    </Button>
  );
};
