import WebhooksTable from '@/settings/advanced/integrations/webhooks-table';
...
describe('WebhooksTable', () => {
  ...
  it('keeps the add action and bottom separator inside a populated webhook section', () => {
    ...
    expect(
      table.compareDocumentPosition(addButton) & Node.DOCUMENT_POSITION_FOLLOWING,
    ).toBeTruthy();
    expect(
      addButton.compareDocumentPosition(separator) & Node.DOCUMENT_POSITION_FOLLOWING,
    ).toBeTruthy();
