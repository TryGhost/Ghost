...
import {
  ...
  useCreateWebhook,
  useEditWebhook,
} from '@tryghost/admin-x-framework/api/webhooks';
      ...
      <div className="mt-5">
        <FieldGroup className="gap-8">
          ...
          <Field data-invalid={Boolean(errors.event) || undefined}>
            ...
            >
              <SelectTrigger
                aria-describedby={errors.event ? eventErrorId : undefined}
                aria-invalid={Boolean(errors.event) || undefined}
                aria-label="Event"
          ...
          <Field data-invalid={Boolean(errors.target_url) || undefined}>
            ...
            <Input
              aria-invalid={Boolean(errors.target_url) || undefined}
