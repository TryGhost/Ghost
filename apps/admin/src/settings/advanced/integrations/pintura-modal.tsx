...
function PinturaModal() {
  ...
  const handleUpload = async (file: File, form: 'js' | 'css') => {
    try {
      ...
      const updates: Setting[] = [{ key: `pintura_${form}_url`, value: url }];
          ...
          <div className="mb-7 flex flex-col items-stretch justify-between gap-4 rounded-sm bg-grey-50 p-4 md:flex-row md:p-7 dark:bg-grey-950">
            <div className="md:basis-1/2">
              ...
              <p>
                ...
                pqina.nl/pintura/ to activate this feature.
              </p>
            </div>
            <div className="flex grow flex-col items-end justify-between gap-2 md:basis-1/2">
              ...
              <a
                className="-mb-1 font-medium text-green"
                href="https://pqina.nl/pintura/ghost/?ref=ghost.org"
              ...
              <>
                <div className="flex flex-col justify-between gap-1 md:flex-row md:items-center">
                  ...
                  <Dropzone
                    ...
                    disabled={uploadingState.js}
                    variant="button"
                    onDropAccepted={(files) => void handleUpload(files[0], 'js')}
                  >
                ...
                <div className="flex flex-col justify-between gap-1 md:flex-row md:items-center">
                  ...
                  <Dropzone
                    accept={{ 'text/css': ['.css'] }}
                    disabled={uploadingState.css}
                    variant="button"
                    onDropAccepted={(files) => void handleUpload(files[0], 'css')}
                  >
