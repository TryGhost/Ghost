...
import { resolveWelcomeEmailSenderDetails } from '@/settings/utils/welcome-email-sender-details';
...
export const useWelcomeEmailSenderDetails = (
  automatedEmails: AutomatedEmailSenderFields[] = [],
  { config, defaultEmailAddress, siteTitle, supportEmailAddress }: WelcomeEmailSenderDetailsOptions,
) => {
  ...
  return useMemo(
    () =>
      resolveWelcomeEmailSenderDetails({
        automatedEmails,
        config,
        defaultEmailAddress,
