...
const MESSAGES: Record<PostActionMessageKey, MessageForms> = {
    ...
    unpublished: {single: '{Type} reverted to a draft', multiple: '{count} {type}s reverted to drafts'},
    ...
    accessUpdated: {single: '{Type} access updated', multiple: '{Type} access updated for {count} {type}s'},
