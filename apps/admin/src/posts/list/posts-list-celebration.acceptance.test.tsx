...
describe("Posts list publish celebration", () => {
    ...
    it("celebrates a post the editor just published", async () => {
        ...
        fakePosts([published]);
        localStorage.setItem("ghost-last-published-post", JSON.stringify({ id: published.id, type: "post" }));
    ...
    it("celebrates a page the editor just published", async () => {
        ...
        fakePages([page]);
        fakePosts([]);
        localStorage.setItem("ghost-last-published-post", JSON.stringify({ id: page.id, type: "page" }));
    ...
    it("says All set! for a scheduled post rather than celebrating a publish", async () => {
        ...
        fakePosts([scheduled]);
        localStorage.setItem("ghost-last-scheduled-post", JSON.stringify({ id: scheduled.id, type: "post" }));
