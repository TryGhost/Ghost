import { cleanTrackedUrl, getLinkById } from '@/posts/analytics/utils/link-helpers';
...
describe('link-helpers', () => {
  ...
  it('should not remove extraneous params', () => {
    const url =
      'https://example.com/to?ref=test&attribution_id=test&attribution_type=test&utm_source=test';
    const cleanedUrl = cleanTrackedUrl(url, true);
