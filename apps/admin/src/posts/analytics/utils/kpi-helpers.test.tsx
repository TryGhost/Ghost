...
import { getWebKpiValues } from '@/posts/analytics/utils/kpi-helpers';

describe('kpi-helpers', () => {
  describe('getWebKpiValues', () => {
    it('handles missing data gracefully', () => {
      expect(getWebKpiValues(null)).toEqual({
        visits: '0',
        views: '0',
        bounceRate: '0%',
        duration: '0s',
      });
      expect(getWebKpiValues(undefined)).toEqual({
        visits: '0',
        views: '0',
        bounceRate: '0%',
        duration: '0s',
      });
      expect(getWebKpiValues([])).toEqual({
        visits: '0',
        views: '0',
        bounceRate: '0%',
        duration: '0s',
    ...
    it('calculates accurate KPI aggregations', () => {
      ...
      expect(getWebKpiValues(data)).toEqual({
        visits: '250',
        views: '500',
        bounceRate: '44%',
        duration: '1m 36s',
      ...
      const data = [
        {
          visits: 333,
          pageviews: 666,
          bounce_rate: 0.333333,
          avg_session_sec: 66.666,
          date: '2023-01-01',
        },
      ];
