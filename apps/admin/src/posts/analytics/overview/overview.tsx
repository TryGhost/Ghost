...
import {centsToDollars, formatQueryDate, getRangeDates, getRangeForStartDate} from '@tryghost/shade/app';
...
const Overview: React.FC = () => {
    ...
    useEffect(() => {
        if (!isPostLoading && post && isPublishedOnly(post) && !webAnalyticsEnabled && showGrowthSection) {
