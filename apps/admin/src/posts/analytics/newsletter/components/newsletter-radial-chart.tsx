...
export const NewsletterRadialChart: React.FC<NewsletterRadialChartProps> = ({
  ...
  return (
    <ChartContainer className={cn('mx-auto', className)} config={config}>
      ...
      >
        ...
        <Recharts.RadialBar cornerRadius={10} dataKey="value" minPointSize={-2} background>
          {data.length > 1 && (
            <Recharts.LabelList
                ...
                formatter={(value, _, props) => {
                  ...
                  return (
                    <div className="flex items-center gap-1">
                      ...
                      <div className="ml-3 font-mono text-xs">
                        {formatPercentage(normalizePercentageValue(value))}
                      </div>
                    </div>
                  );
                }}
