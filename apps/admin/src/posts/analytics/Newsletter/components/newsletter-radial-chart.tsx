import {type ChartConfig, ChartContainer, ChartTooltip, ChartTooltipContent} from '@tryghost/shade/components';
                ...
                <ChartTooltip
                    content={<ChartTooltipContent
                        formatter={(value, _, props) => {
                            const payload = props.payload as {color?: string; datatype?: string} | undefined;
                            return (
                                <div className='flex items-center gap-1'>
                                    <div className='size-2 rounded-full opacity-50' style={{backgroundColor: payload?.color}}></div>
                                    <div className='text-xs text-muted-foreground'>{payload?.datatype}</div>
