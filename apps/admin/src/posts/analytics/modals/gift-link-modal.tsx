...
import {
  type GiftLinkResource,
  useCreateGiftLink,
  useEnsureGiftLink,
} from '@tryghost/admin-x-framework/api/gift-links';
...
const GiftLinkModal: React.FC<GiftLinkModalProps> = ({
  open,
  onOpenChange,
  postId,
  resource = 'posts',
          ...
          <>
            <DialogHeader className="gap-3">
              <div className="flex items-center gap-2">
                ...
                {usage && (
                  <Badge data-testid="gift-link-views" variant="secondary">
            ...
            <ShareModal.CopyURLBox
              ...
              copyURL={ensuring ? 'Generating link…' : giftLinkUrl}
            >
        ...
        {resetState === 'confirm' && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Are you sure you want to reset this link? Anyone with the current link will lose
                access to this {postType}.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
              <Button
