...
import {STATS_LABEL_MAPPINGS, UNKNOWN_LOCATION_VALUES} from '@/posts/analytics/utils/constants';
    ...
    const options = useMemo(() => {
        ...
        return items
            ...
            .map((item) => {
                ...
                const rawValue = typeof rawItemValue === 'string' || typeof rawItemValue === 'number' || typeof rawItemValue === 'boolean' ? String(rawItemValue) : '';
