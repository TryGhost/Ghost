...
//
// Two zones on one row: navigation and identity at the left — back arrow, then
// the title and its status — and the screen's actions at the right. The
// arrangement is shared with the other lanes; only the surface differs.
//
