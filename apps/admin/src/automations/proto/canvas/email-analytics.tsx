...
export const EmailStatsFooter: React.FC<StatsProps & { divider?: boolean }> = ({
  ...
  <div
    className={cn(
      ...
      divider && 'mt-3 border-t border-border-default pt-3',
    )}
  >
...
const PerformanceRing: React.FC<{
  ...
  return (
    <ChartContainer
      className={`absolute inset-0 aspect-square ${tracked ? '' : 'opacity-30'}`}
...
const PerformanceChart: React.FC<{
  ...
  <div className="relative mx-auto aspect-square size-[240px]">
    <PerformanceRing
      color="blue"
      datatype="Opened"
      innerRadius={RING_RADII.opened.innerRadius}
      outerRadius={RING_RADII.opened.outerRadius}
    ...
    <PerformanceRing
      color="teal"
      datatype="Clicked"
      innerRadius={RING_RADII.clicked.innerRadius}
      outerRadius={RING_RADII.clicked.outerRadius}
...
}> = ({ label, color, tracked = true, children }) => (
...
export const EmailPerformance: React.FC<StatsProps & { actionId?: string }> = ({
  stats,
  opensTracked = true,
  clicksTracked = true,
  actionId,
        ...
        <Box className="rounded-lg border border-border-default px-4 py-3">
          ...
          <Stack gap="sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Kpi color="var(--chart-blue)" label="Opened" tracked={opensTracked}>
                {formatPercentage(openRate)}
              </Kpi>
              <Kpi color="var(--chart-teal)" label="Clicked" tracked={clicksTracked}>
