...
> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="p-6 text-sm text-destructive">Something went wrong loading the editor.</div>
      );
    }
...
const EmailEditor: React.FC<EmailEditorProps> = ({ value, placeholder, className, onChange }) => {
