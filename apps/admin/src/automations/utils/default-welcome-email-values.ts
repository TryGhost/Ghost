...
const DEFAULT_FREE_LEXICAL_CONTENT =
...
const DEFAULT_PAID_LEXICAL_CONTENT =
...
export const getDefaultWelcomeEmailValues = (
...
export const getDefaultWelcomeEmailRecord = (
  emailType: WelcomeEmailType,
  siteTitle: string | null | undefined,
): AutomatedEmail => ({
  id: '',
