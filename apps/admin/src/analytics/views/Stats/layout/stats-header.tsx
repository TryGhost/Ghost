...
const StatsHeader:React.FC<StatsHeaderProps> = ({
    ...
    return (
        <>
            <header className='z-40 -mx-6 bg-white/70 backdrop-blur-md transition-colors dark:bg-background'>
                <div
            ...
            <Navbar className='sticky top-0 z-40 transform-gpu flex-col items-start gap-y-0 border-none bg-white/70 pt-9 pb-6 backdrop-blur-md lg:flex-row lg:items-center transition-colors dark:bg-background'>
                <NavbarNavigation>
