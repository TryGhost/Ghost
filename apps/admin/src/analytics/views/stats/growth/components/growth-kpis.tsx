...
import { formatDisplayDateWithRange, formatNumber } from '@tryghost/shade/utils';
import {
  centsToDollars,
...
const isValidTab = (tab: string | null | undefined): tab is KpiTab => {
  return (
    tab === 'total-members' || tab === 'free-members' || tab === 'paid-members' || tab === 'mrr'
  );
};
...
const PaidMembersTooltipContent = ({
  active,
  payload,
  range,
  color,
      ...
      <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-2">
              <div className="flex grow items-center justify-between gap-5">
                ...
                <div className="font-mono text-xs">
                  {gift !== undefined && gift > 0 ? formatNumber(gift) : '0'}
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div className="flex grow items-center justify-between gap-5">
                ...
                <div className="font-mono text-xs">
                  {comped !== undefined && comped > 0 ? formatNumber(comped) : '0'}
                </div>
              </div>
            </div>
            <Separator />
        ...
        <div className="flex items-center gap-2">
          <span
            ...
            style={{ backgroundColor: color || 'var(--chart-purple)' }}
          ></span>
          <div className="flex grow items-center justify-between gap-5">
      ...
      {paidMembersEnabled && (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            <DropdownMenuItem onClick={() => handleTabChange('total-members')}>
              Total members
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => handleTabChange('free-members')}>
              Free members
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => handleTabChange('paid-members')}>
              Paid members
            </DropdownMenuItem>
