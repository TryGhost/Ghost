...
const PaidMembersChangeChart: React.FC<PaidMembersChangeChartProps> = ({
  ...
  const paidChangeChartData = useMemo(() => {
    ...
    if (subscriptionData && subscriptionData.length > 0) {
      ...
      const signupsData = sanitizeChartData(
        subscriptionData,
        range,
        'signups',
        'sum',
      ...
      const cancellationsData = sanitizeChartData(
        subscriptionData,
        range,
        'cancellations',
        'sum',
      ...
      const subscribedData = sanitizeChartData(
        memberData,
        range,
        'paid_subscribed',
        'sum',
      ...
      const canceledData = sanitizeChartData(
        memberData,
        range,
        'paid_canceled',
        'sum',
  ...
  const totals = useMemo(() => {
    ...
    const totalCancelled = paidChangeChartData.reduce(
      (sum, item) => sum + Math.abs(item.cancelled),
      0,
    );
                            ...
                            <div className="flex w-full items-center justify-between gap-4">
                              <div className="flex items-center gap-1">
                                ...
                                <span className="text-sm text-muted-foreground">
                                  {paidChangeChartConfig[name as keyof typeof paidChangeChartConfig]
                                    ?.label || name}
                                </span>
                              </div>
