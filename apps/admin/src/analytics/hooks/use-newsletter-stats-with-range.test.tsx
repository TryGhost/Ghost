...
const { useNewsletterStats, useSubscriberCount, useNewsletterBasicStats, useNewsletterClickStats } =
...
describe('Newsletter Stats Hooks', () => {
  ...
  describe('useNewsletterStatsWithRange', () => {
    ...
    it('accepts custom order parameter', () => {
      const wrapper = TestWrapper;
      const { result } = renderHook(() => useNewsletterStatsWithRange(30, 'open_rate desc'), {
        wrapper,
      });
    ...
    it('accepts newsletter ID parameter', () => {
      ...
      const { result } = renderHook(
        () => useNewsletterStatsWithRange(30, 'date desc', 'newsletter-123'),
        { wrapper },
      );
  ...
  describe('useSubscriberCountWithRange', () => {
    ...
    it('accepts newsletter ID parameter', () => {
      const wrapper = TestWrapper;
      const { result } = renderHook(() => useSubscriberCountWithRange(30, 'newsletter-123'), {
        wrapper,
      });
  ...
  describe('useNewsletterStatsWithRange - shouldFetch parameter', () => {
    it('returns empty state when shouldFetch is false', () => {
      ...
      const { result } = renderHook(
        () => useNewsletterStatsWithRange(30, 'date desc', undefined, false),
        { wrapper },
      );
    ...
    it('calls real API when shouldFetch is true', () => {
      const wrapper = TestWrapper;
      const { result } = renderHook(
        () => useNewsletterStatsWithRange(30, 'date desc', undefined, true),
        { wrapper },
      );
  ...
  describe('useSubscriberCountWithRange - shouldFetch parameter', () => {
    it('returns empty state when shouldFetch is false', () => {
      ...
      const { result } = renderHook(() => useSubscriberCountWithRange(30, undefined, false), {
        wrapper,
      });
    ...
    it('calls real API when shouldFetch is true', () => {
      const wrapper = TestWrapper;
      const { result } = renderHook(() => useSubscriberCountWithRange(30, undefined, true), {
        wrapper,
      });
  ...
  describe('useNewsletterBasicStatsWithRange', () => {
    ...
    it('accepts custom range and order parameters', () => {
      const wrapper = TestWrapper;
      const { result } = renderHook(() => useNewsletterBasicStatsWithRange(7, 'open_rate desc'), {
        wrapper,
      });
    ...
    it('accepts newsletter ID parameter', () => {
      const wrapper = TestWrapper;
      const { result } = renderHook(
        () => useNewsletterBasicStatsWithRange(30, 'date desc', 'newsletter-456'),
        { wrapper },
      );
    ...
    it('returns empty state when shouldFetch is false', () => {
      ...
      const { result } = renderHook(
        () => useNewsletterBasicStatsWithRange(30, 'date desc', undefined, false),
        { wrapper },
      );
  ...
  describe('useNewsletterClickStatsWithRange', () => {
    it('builds search params with newsletter ID', () => {
      const wrapper = TestWrapper;
      const { result } = renderHook(() => useNewsletterClickStatsWithRange('newsletter-789'), {
        wrapper,
      });
    ...
    it('builds search params with post IDs', () => {
      ...
      const { result } = renderHook(() => useNewsletterClickStatsWithRange(undefined, postIds), {
        wrapper,
      });
    ...
    it('builds search params with both newsletter ID and post IDs', () => {
      ...
      const { result } = renderHook(
        () => useNewsletterClickStatsWithRange('newsletter-789', postIds),
        { wrapper },
      );
    ...
    it('returns empty state when shouldFetch is false', () => {
      ...
      const { result } = renderHook(
        () => useNewsletterClickStatsWithRange('newsletter-123', [], false),
        { wrapper },
      );
  ...
  describe('useNewsletterStatsWithRangeSplit', () => {
    ...
    it('handles missing click stats with default values', () => {
      ...
      const basicStatsData = {
        stats: [{ post_id: 'post-1', open_rate: 0.5, subject: 'Subject 1' }],
    ...
    it('disables click stats when no post IDs available', () => {
      ...
      renderHook(() => useNewsletterStatsWithRangeSplit(30, 'date desc', 'newsletter-123', true), {
        wrapper,
      });
    ...
    it('accepts custom parameters and passes them correctly', () => {
      ...
      renderHook(
        () => useNewsletterStatsWithRangeSplit(7, 'click_rate desc', 'newsletter-456', true),
        { wrapper },
      );
