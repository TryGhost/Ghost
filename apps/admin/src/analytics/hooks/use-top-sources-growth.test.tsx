...
vi.mock('@/shared/analytics/audience', () => ({
...
const mockGetAudienceQueryParam = vi.mocked(
  await import('@/shared/analytics/audience'),
...
describe('useTopSourcesGrowth', () => {
  ...
  it('returns the result from useTopSourcesGrowthAPI', () => {
    mockSuccess(mockUseTopSourcesGrowthAPI, {
      stats: [
        { source: 'Google', signups: 100, date: '2024-01-01', paid_conversions: 10, mrr: 1000 },
      ],
    });
