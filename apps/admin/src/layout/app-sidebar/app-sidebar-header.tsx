        ...
        <SidebarHeader {...props}>
            <div className="flex flex-col items-stretch gap-5">
                ...
                {showSearch && (
                    <Button
                        variant="outline"
                        className="flex h-(--control-height) items-center justify-between rounded-full border-transparent pr-2 text-base text-muted-foreground shadow-xs hover:bg-background hover:text-gray-700 hover:shadow-sm dark:border-gray-900/50 dark:bg-gray-900/30 dark:hover:border-gray-900/80 dark:hover:text-gray-400 [&_svg]:stroke-2"
