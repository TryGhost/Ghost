...
export function MobileNavBar() {
    ...
    return (
        <div className="sticky flex flex-shrink-0 justify-center max-w-[100vw] bottom-0 w-full h-[var(--mobile-navbar-height)] bg-sidebar/80 backdrop-blur-md border-t border-sidebar-border px-5 z-50">
