...
function NavContent({ ...props }: React.ComponentProps<typeof SidebarGroup>) {
    ...
    const isMembersForwardRouteActive = location.pathname.startsWith('/members-forward');
    const isMembersBaseRouteActive = routing.isRouteActive(['members', 'member', 'member.new', 'members-activity']) || isMembersForwardRouteActive;
