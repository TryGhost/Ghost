      ...
      <DialogContent className="gap-5">
        ...
        {showPicker ? (
          <>
            <div aria-label="Unsubscribe scope" className="flex flex-col gap-3" role="radiogroup">
              <label className="flex cursor-pointer items-start gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {formatNumber(memberCount)} {memberLabel} will be unsubscribed from{' '}
              ...
              <label className="flex cursor-pointer items-start gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-muted-foreground">
                    Select which newsletters to unsubscribe {formatNumber(memberCount)}{' '}
                    {memberLabel} from.
                  </span>
                </div>
              </label>
            ...
            {mode === 'selected' && (
              <div ref={pickerRef} className="relative space-y-2">
                <label className="text-sm font-semibold" htmlFor="newsletter-search">
                  Newsletters
                </label>
                <div
          ...
          <p className="text-sm text-muted-foreground">
            Are you sure you want to unsubscribe {formatNumber(memberCount)} {memberLabel} from all
            newsletters? They will no longer receive any email newsletters from you.
          </p>
        )}
        ...
        <DialogFooter>
          ...
          <Button disabled={isDisabled} variant="destructive" onClick={handleConfirm}>
