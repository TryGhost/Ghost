      ...
      meta: {
        stats: {
          ...
          invalid: [
            ...
            {
              email: 'x',
              errors: ['Value in [members.note] exceeds maximum length of 2000 characters.'],
              error: 'Value in [members.note] exceeds maximum length of 2000 characters.',
            },
            {
              email: 'y',
              errors: ['Value in [members.subscribed] must be one of true, false, 0 or 1.'],
              error: 'Value in [members.subscribed] must be one of true, false, 0 or 1.',
            },
            {
              email: 'z',
              errors: ['Validation (isEmail) failed for email'],
            ...
            {
              email: 'w',
              errors: ['No such customer:cus_abc123'],
