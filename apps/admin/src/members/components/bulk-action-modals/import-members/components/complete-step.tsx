      ...
      <div className="mt-5 space-y-4">
        {importResponse.importedCount === 0 ? (
          <p className="text-sm">
            ...
            {importResponse.errorCount > 0 ? ' due to the following errors:' : '.'}
          </p>
        ) : (
          <p className="text-sm">
            A total of <strong>{formatNumber(importResponse.importedCount)}</strong>{' '}
            {importResponse.importedCount === 1 ? 'person was' : 'people were'} successfully added
            or updated in your list of members, and now have access to your site.
          </p>
        )}
        ...
        {importResponse.errorCount > 0 ? (
          <>
            ...
            {importResponse.importedCount === 0 ? (
              ...
              <Button onClick={onClose}>View members</Button>
            )}
          </>
        ) : (
          <>
