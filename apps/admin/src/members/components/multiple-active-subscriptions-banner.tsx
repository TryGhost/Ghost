...
import { useMultipleActiveSubscriptionsBanner } from '@/members/hooks/use-multiple-active-subscriptions-banner';
  ...
  return (
    ...
    >
      <div className="flex flex-col items-baseline gap-3 pr-8 sm:flex-row">
        We found {formatNumber(banner.count)} {banner.count === 1 ? 'member' : 'members'} with more
        than one active paid subscription.{' '}
