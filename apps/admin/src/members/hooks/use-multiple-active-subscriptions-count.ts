import { MULTIPLE_ACTIVE_STRIPE_CUSTOMERS_FILTER } from '@/members/multiple-active-subscriptions';
 ...
 */
export function useMultipleActiveSubscriptionsCount({
  enabled,
}: UseMultipleActiveSubscriptionsCountOptions) {
