...
const MembersPage: React.FC<MembersPageProps> = ({
    ...
    const {newsletters, customFields} = useMemberFilterSources(filterSearchParams.get('filter') ?? undefined);
...
const Members: React.FC = () => {
    ...
    const {newsletters: gateNewsletters, customFields: gateCustomFields} = useMemberFilterSources(filterParam);
