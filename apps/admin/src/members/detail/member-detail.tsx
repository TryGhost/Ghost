...
const MemberDetailPage: React.FC<MemberDetailPageProps> = ({
  ...
  const [committedIdentity, setCommittedIdentity] = React.useState<{ name: string; email: string }>(
    { name: '', email: '' },
  );
  React.useEffect(() => {
    if (isCreating) {
          ...
          <DetailPage.Body>
            {loadError && (
              <div
                ...
                data-testid="member-detail-load-error"
              >
            ...
            {showEditor && draft && (
              <div className="flex flex-1 flex-col gap-8 lg:flex-row lg:items-start lg:gap-12">
                <MemberDetailSidebar
                  draftEmail={committedIdentity.email}
                ...
                <div className="flex min-w-0 flex-1 flex-col gap-8">
                  ...
                  {paidMembersEnabled && (
                    <section
                      aria-labelledby="member-subscriptions-heading"
                      className="flex flex-col gap-3"
                    >
                      <h3 className="text-base font-semibold" id="member-subscriptions-heading">
                        Subscriptions
                      </h3>
          ...
          >
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Your changes will be lost if you leave this member.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
