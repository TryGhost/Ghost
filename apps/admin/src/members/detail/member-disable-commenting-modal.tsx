 ...
 */
const MemberDisableCommentingModal: React.FC<MemberDisableCommentingModalProps> = ({
  open,
  onOpenChange,
  member,
}) => {
    ...
    >
      <DialogContent data-testid="disable-commenting-modal">
        <DialogHeader>
          ...
          <DialogDescription>
            <strong>{displayName}</strong> won’t be able to comment in the future. You can re-enable
            commenting anytime.
          </DialogDescription>
        </DialogHeader>
