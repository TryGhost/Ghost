 ...
 */
const MemberSubscriptionActions: React.FC<MemberSubscriptionActionsProps> = ({
  memberId,
  subscription,
}) => {
        ...
        {!isCanceled &&
          (isSetToCancel ? (
            <DropdownMenuItem
              ...
              onSelect={() =>
                runToggleCancel(false, 'Subscription continued', 'Couldn’t continue subscription')
              }
            >
            ...
            <DropdownMenuItem
              ...
              onSelect={() =>
                runToggleCancel(true, 'Subscription canceled', 'Couldn’t cancel subscription')
              }
            >
              Cancel subscription
            </DropdownMenuItem>
