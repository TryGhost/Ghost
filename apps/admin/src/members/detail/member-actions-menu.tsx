...
const MemberActionsMenu: React.FC<MemberActionsMenuProps> = ({
  ...
  const commentingBusy =
    enableCommenting.isPending || (enableCommenting.isSuccess && membersRefetching);
  ...
  return (
    <>
      ...
      />
      <MemberLogoutModal member={member} open={showLogout} onOpenChange={setShowLogout} />
