  ...
  return (
    <>
      ...
      {visibleLabels.length > 0 && (
        <CommandGroup className={cn('[&_[cmdk-group-heading]]:hidden', isAdmin7Design && 'p-0')}>
    ...
    <div ref={containerRef} className="relative">
      <div
        className={cn(
          ...
          isAdmin7Design ? 'gap-1 rounded-control p-1' : 'gap-1.5 rounded-md px-3 py-1',
        )}
        role="combobox"
        onClick={() => {
      ...
      {open && (
        <div
          className={cn(
            ...
            isAdmin7Design ? 'rounded-menu' : 'rounded-md',
          )}
        >
