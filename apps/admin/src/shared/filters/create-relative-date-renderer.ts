...
export function createRelativeDateRenderer(
  fallbackDate: string,
): NonNullable<FilterFieldConfig['customRenderer']> {
  const renderer = (props: CustomRendererProps) =>
    React.createElement(RelativeDateFilter, {
      ...props,
      fallbackDate,
    });
