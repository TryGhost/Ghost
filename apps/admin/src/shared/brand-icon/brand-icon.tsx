import Beehiiv from './assets/beehiiv.svg';
import Facebook from './assets/facebook.svg';
import FirstPromoter from './assets/firstpromoter.svg';
import Linkedin from './assets/linkedin.svg';
import Mailchimp from './assets/mailchimp.svg';
import Medium from './assets/medium.svg';
import Pintura from './assets/pintura.svg';
import PortalIcon1 from './assets/portal-icon-1.svg';
import PortalIcon2 from './assets/portal-icon-2.svg';
import PortalIcon3 from './assets/portal-icon-3.svg';
import PortalIcon4 from './assets/portal-icon-4.svg';
import PortalIcon5 from './assets/portal-icon-5.svg';
