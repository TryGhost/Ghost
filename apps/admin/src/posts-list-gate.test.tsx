...
vi.mock('./gift-link-modal-host', () => ({
  EmberListWithGiftLinks: () =>
    React.createElement('div', { 'data-testid': 'ember-list-with-gift-links' }),
}));
...
vi.mock('./posts/list/posts-route', () => ({
  default: () =>
    React.createElement('div', { 'data-testid': 'react-screen', 'data-resource': 'posts' }),
}));

vi.mock('./posts/list/pages-route', () => ({
  default: () =>
    React.createElement('div', { 'data-testid': 'react-screen', 'data-resource': 'pages' }),
}));
