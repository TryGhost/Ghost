import { configResponse, settingsResponse, type ConfigResponse, type TinybirdPipeName, type TinybirdPipeRows } from "@tryghost/test-data";
 ...
 */
export function fakeTinybirdPipe<Pipe extends TinybirdPipeName>(pipe: Pipe, rows: Array<TinybirdPipeRows[Pipe]>): TinybirdPipeCapture {
