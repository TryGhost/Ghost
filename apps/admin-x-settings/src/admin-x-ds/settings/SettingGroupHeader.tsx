        ...
        <div className="flex items-start justify-between gap-4">
            {(title || description) &&
                <div>
                    ...
                    {description && <p className="mt-1 hidden max-w-lg text-sm group-[.is-not-editing]/setting-group:!visible group-[.is-not-editing]/setting-group:!block md:!visible md:!block">{highlightKeywords(description)}</p>}
                </div>
            }
