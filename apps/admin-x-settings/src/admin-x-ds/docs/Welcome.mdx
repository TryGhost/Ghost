...
<section className="main-structure-container">
    <div>
        ...
        [Read more &rarr;](/docs/foundations-style-guide--docs)
    </div>
    <div>
...
<div className="highlight purple"><strong>Work in progress: </strong>As of today, the Storybook system is part of <a href="https://github.com/TryGhost/Ghost/tree/main/apps/admin-x-settings">AdminX Settings app</a> but it's about to be a separated into its own package.</div>


### Feedback

Hit us on #design in Slack.
