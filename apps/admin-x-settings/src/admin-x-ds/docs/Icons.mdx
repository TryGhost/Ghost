...
<p className='excerpt'>We use the massive [Streamline icon library](https://www.streamlinehq.com/) in Ghost Admin. Here are some iconography best practices.</p>

### Overview
The icons are part of the AdminX design system so they can be reusable by any app in Ghost Admin. Use the [Icon](/docs/global-icon--docs) component to display available icons in standard icon sizes.
