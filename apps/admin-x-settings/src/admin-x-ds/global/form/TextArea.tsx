...
const TextArea: React.FC<TextAreaProps> = ({
    ...
    let styles = clsx(
        ...
        error ? 'border-red bg-white' : 'border-transparent placeholder:text-grey-500 hover:bg-grey-100 focus:border-green focus:bg-white focus:shadow-[0_0_0_1px_rgba(48,207,67,1)] dark:placeholder:text-grey-800 dark:hover:bg-grey-950 dark:focus:bg-grey-950',
        title && 'mt-1.5',
