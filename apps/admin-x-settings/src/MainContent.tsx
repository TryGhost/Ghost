...
const MainContent: React.FC = () => {
    ...
    return (
        <Page>
            ...
            <div className="scrollbar-hidden fixed inset-x-0 top-[52px] z-[999] flex-1 basis-[320px] bg-white px-8 pb-8 tablet:relative tablet:inset-x-auto tablet:top-auto tablet:h-full tablet:overflow-y-scroll tablet:bg-grey-50 tablet:pb-0" id="admin-x-settings-sidebar-scroller">
