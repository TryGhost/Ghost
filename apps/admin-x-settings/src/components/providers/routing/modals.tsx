...
import EmailCustomizationModal from '../../settings/email/customization/email-customization-modal';
...
import VerifiedEmailVerifyModal from '../../settings/email/verified-email-verify-modal';
