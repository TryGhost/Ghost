...
const GeneralTab: React.FC<GeneralTabProps> = ({generalSettings, onGeneralChange, siteTitle, emailDomain}) => (
    <div className="flex flex-col gap-6 pt-6">
        <section>
            <h4 className="mb-4 text-xs font-semibold tracking-wide text-gray-500 uppercase">Email info</h4>
        ...
        <section>
            <h4 className="mb-4 text-xs font-semibold tracking-wide text-gray-500 uppercase">Content</h4>
            <div className="flex flex-col gap-4">
                <HeaderImageField
...
const DesignTab: React.FC = () => (
    <div className="flex flex-col gap-6 pt-6">
        <section>
            <h4 className="mb-4 text-xs font-semibold tracking-wide text-gray-500 uppercase">Global</h4>
            <div className="flex flex-col gap-4">
                <BackgroundColorField />
                <HeadingFontField />
                <HeadingWeightField />
        ...
        <section>
            <h4 className="mb-4 text-xs font-semibold tracking-wide text-gray-500 uppercase">Header</h4>
            <div className="flex flex-col gap-4">
                <HeaderBackgroundField />
            </div>
        </section>
        ...
        <section>
            <h4 className="mb-4 text-xs font-semibold tracking-wide text-gray-500 uppercase">Body</h4>
            <div className="flex flex-col gap-4">
                <ButtonColorField />
                <ButtonStyleField />
                <ButtonCornersField />
