                                    ...
                                    <div className="flex flex-col gap-4">
                                            ...
                                            {generalSettings.headerImage ? (
                                                <div className="relative overflow-hidden rounded-md border border-gray-200 dark:border-gray-800">
                                                    ...
                                                    <button
                                                        ...
                                                        type="button"
                                                        onClick={() => handleGeneralChange({headerImage: ''})}
                                                    >
                                                        Remove
                                                    </button>
                                                </div>
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Switch
                                                ...
                                                onCheckedChange={checked => handleGeneralChange({showPublicationTitle: checked})}
                                            />
                                        </div>
                                        <div className="flex flex-col gap-1.5">
                                            ...
                                            <Textarea
                                                ...
                                                onChange={e => handleGeneralChange({emailFooter: e.target.value})}
                                            />
                                        </div>
                                    </div>
                                </section>
