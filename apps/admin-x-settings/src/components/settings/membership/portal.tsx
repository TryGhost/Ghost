...
const Portal: React.FC<{ keywords: string[] }> = ({keywords}) => {
    ...
    return (
        <TopLevelGroup
            ...
            title="Signup portal"
        >
            <div className="sm:visible! sm:flex! relative isolate -mx-5 -mb-5 hidden flex-col items-center justify-end overflow-hidden rounded-b-xl bg-grey-50 px-5 pt-6 text-black md:-mx-7 md:-mb-7">
