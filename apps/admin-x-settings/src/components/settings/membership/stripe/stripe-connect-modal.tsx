    ...
    return (
        <section>
            ...
            <div className='flex flex-col items-center'>
                ...
                <a className='w-100 border-grey-200 hover:border-grey-400 dark:border-grey-900 mt-5 flex flex-col items-stretch justify-between rounded-sm border transition-all md:flex-row' href="https://ghost.org/resources/managing-your-stripe-account/?ref=admin" rel="noopener noreferrer" target="_blank">
                    <div className='order-2 p-4 md:order-1'>
                        <div className='font-bold'>How to setup and manage your Stripe account</div>
                        <div className='text-grey-800 dark:text-grey-500 mt-1 text-sm'>Learn how to configure your Stripe account to work with Ghost, from custom branding to payment receipt emails.</div>
                        <div className='text-grey-800 dark:text-grey-500 mt-3 flex items-center gap-1 text-sm'>
