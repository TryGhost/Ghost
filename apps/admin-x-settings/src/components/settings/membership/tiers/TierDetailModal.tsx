                    ...
                    <div className='-mt-3'>
                        <SortableList
                            ...
                            renderItem={({id, item}) => <div className='relative flex w-full items-center gap-5'>
                                <div className='absolute left-[-32px] top-[7px] flex h-6 w-6 items-center justify-center bg-white dark:bg-black group-hover:hidden'><Icon name='check' size='sm' /></div>
                                <TextField
