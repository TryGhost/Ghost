            ...
            <div className='mt-7'>
                ...
                {enabled &&
                    <div className='mt-5 flex flex-col items-center'>
                        <a className='w-100 bg-grey-75 hover:border-grey-400 hover:bg-grey-100 dark:bg-grey-925 dark:hover:bg-grey-950 flex flex-col items-stretch justify-between overflow-hidden rounded-md transition-all md:flex-row' href="https://ghost.org/integrations/transistor/" rel="noopener noreferrer" target="_blank">
                            <div className='order-2 px-7 py-5 md:order-1'>
                                <div className='font-semibold'>How to use Transistor in Ghost</div>
                                <div className='text-grey-800 dark:text-grey-500 mt-1 text-sm'>Learn more about connecting Transistor with Ghost to offer members access to private podcasts in Portal or as an embed in posts and pages with a custom Transistor card.</div>
                            </div>
