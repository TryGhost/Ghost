...
export const DEFAULT_NEWSLETTER_DESIGN_VALUES: BaseEmailDesignDraft & NewsletterDesignDraft = {
...
export const DEFAULT_AUTOMATION_DESIGN_VALUES: BaseEmailDesignDraft = {
    background_color: 'light',
    header_background_color: 'transparent',
    header_image: '',
    title_font_category: 'sans_serif',
