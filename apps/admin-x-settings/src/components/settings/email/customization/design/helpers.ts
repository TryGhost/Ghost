...
import type {BaseEmailDesignDraft, EmailFontCategory, EmailTitleFontWeight, NewsletterDesignDraft} from '../types';
...
type ResolveSharedPreviewColorsInput = {
    backgroundColorValue: BaseEmailDesignDraft['background_color'];
    headerBackgroundColorValue: BaseEmailDesignDraft['header_background_color'];
    sectionTitleColorValue: BaseEmailDesignDraft['section_title_color'];
    buttonColorValue: BaseEmailDesignDraft['button_color'];
    linkColorValue: BaseEmailDesignDraft['link_color'];
    dividerColorValue: BaseEmailDesignDraft['divider_color'];
    accentColor: string;
};
...
type ResolveNewsletterPreviewColorsInput = ResolveSharedPreviewColorsInput & {
    postTitleColorValue: NewsletterDesignDraft['post_title_color'];
};
