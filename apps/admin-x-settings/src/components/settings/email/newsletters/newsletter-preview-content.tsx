...
import HeaderBrandingBlock from '../customization/previews/shared/header-branding-block';
                    ...
                    <div className="overflow-y-auto text-sm" style={{backgroundColor}}>
                        <div className="px-[7rem]" style={{backgroundColor: headerBackgroundColor}}>
                            <HeaderBrandingBlock
                                ...
                                subtitleColor={secondaryHeaderTextColor || '#738a94'}
                                testIds={{
                                    image: 'newsletter-preview-header-image',
                                    title: 'newsletter-preview-publication-title',
                                    subtitle: 'newsletter-preview-publication-subtitle'
                                }}
                                titleColor={headerTextColor || '#15171a'}
                            />
                            {showPostTitleSection && (
