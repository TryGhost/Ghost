                ...
                <div className="mx-auto my-0 flex max-h-full w-full max-w-[700px] flex-col overflow-hidden rounded-[4px] text-black shadow-sm">
                    ...
                    <div className="overflow-y-auto text-sm" style={{backgroundColor}}>
                        <div className="px-[7rem]" style={{backgroundColor: headerBackgroundColor}}>
                            ...
                            {showHeader && (
                                <div className="py-3">
                                    ...
                                    {headerTitle && <h4 className="text-grey-900 mb-1 text-center text-[1.6rem] font-bold uppercase leading-tight tracking-tight" style={{color: headerTextColor}}>{headerTitle}</h4>}
                                    {headerSubtitle && <h5 className="text-grey-700 mb-1 text-center text-[1.3rem] font-normal" style={{color: secondaryHeaderTextColor}}>{headerSubtitle}</h5>}
                                </div>
                            )}
                            {showPostTitleSection && (
                            ...
                            {showFeatureImage && (
                                <>
                                    ...
                                    <div className="text-grey-700 mt-1 w-full max-w-[600px] pb-8 text-center text-[1.3rem]" style={{color: secondaryHeaderTextColor}}>Feature image caption</div>
                                </>
                            )}
                        </div>
                        ...
                        <div className={clsx('px-[7rem]', headerBackgroundColor !== 'transparent' && 'pt-10')}>
                            <div className={clsx(
                                'border-grey-200 max-w-[600px] border-b pb-[52px] leading-[27.2px] text-black',
                                ...
                                <h3
                                    className={clsx(
                                        'leading-supertight mb-[13px] text-[2.6rem]',
                                        titleFontCategory === 'serif' && 'font-serif',
