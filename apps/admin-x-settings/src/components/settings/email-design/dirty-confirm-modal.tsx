// NOTE: this has been copy-pasted into apps/posts/src/views/Automations/components/email-design/dirty-confirm-modal.tsx because we need to support the email design modal in both the settings app and the posts app until Automations GAs
