...
const Recommendations: React.FC<{ keywords: string[] }> = ({keywords}) => {
    ...
    const buttons = (
        <Button className='hidden md:!visible md:!block' color='grey' label='Add recommendation' link={true} onClick={() => {
    ...
    return (
        ...
        >
            <div className='flex justify-center rounded border border-green px-4 py-2 md:hidden'>
                <Button color='grey' label='Add recommendation' link onClick={() => {
                    openAddNewRecommendationModal();
                }} />
            </div>
