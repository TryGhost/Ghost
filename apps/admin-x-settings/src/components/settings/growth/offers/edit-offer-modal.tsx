                        ...
                        <section>
                            <div className='border-grey-300 dark:border-grey-800 flex flex-col gap-5 rounded-md border p-4 pb-3.5'>
                                <div className='flex flex-col gap-1.5'>
                                    <span className='text-grey-700 text-xs font-semibold leading-none'>Created on</span>
                                ...
                                <div className='flex items-end justify-between'>
                                    ...
                                    {offer?.redemption_count > 0 ? <a className='text-green font-semibold' href={createOfferRedemptionFilterUrl(offer?.id)}>See members →</a> : null}
                                </div>
                            </div>
                        </section>
                        <section className='mt-2'>
                            ...
                            <div className='flex flex-col gap-6'>
                                ...
                                <TextField
                                    ...
                                    hint={errors.code || (offer?.code !== '' ? <span className='text-grey-700 truncate'>{homepageUrl}<span className='font-bold text-black dark:text-white'>{offer?.code}</span></span> : null)}
                                    placeholder='black-friday'
