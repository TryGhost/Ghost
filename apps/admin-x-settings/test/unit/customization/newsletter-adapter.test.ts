...
describe('newsletterAdapter', function () {
    ...
    it('maps entity newsletter fields to formState', function () {
        const entity = {
        ...
        const formState = newsletterAdapter.createFormState({id: 'newsletter-1', entity});
    ...
    it('saves formState fields with normalized payload values', async function () {
        const entity = {
            background_color: 'light',
            header_background_color: 'transparent',
            header_image: null,
        ...
        await newsletterAdapter.saveFormState({
            id: entity.id,
            entity,
    ...
    it('builds newsletter preview model from formState', function () {
    ...
    it('validates required newsletter name', function () {
        const errors = newsletterAdapter.validateFormState?.({
            background_color: 'light',
            header_background_color: 'transparent',
            header_image: '',
            title_font_category: 'sans_serif',
