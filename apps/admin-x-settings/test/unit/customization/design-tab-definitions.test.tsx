...
import type {BaseEmailDesignFormState, EmailCustomizationFormState, NewsletterDesignFormState} from '@src/components/settings/email/customization/types';

type NewsletterFormState = EmailCustomizationFormState & BaseEmailDesignFormState & NewsletterDesignFormState;
type AutomationFormState = EmailCustomizationFormState & BaseEmailDesignFormState;

describe('design tab definitions', function () {
    it('renders newsletter-specific header controls', function () {
        const definition = buildDesignTabDefinition<unknown, NewsletterFormState>();
    ...
    it('renders automation design controls without newsletter-only fields', function () {
        const definition = buildAutomationDesignTabDefinition<unknown, AutomationFormState>();
