...
// import {Photo, UnsplashAPIOutput} from '../../../src/utils/unsplash/UnsplashTypes';
...
//     public async fetchNextPage(): Promise<UnsplashAPIOutput | null> {
//         if (this.searchTerm) {
//             return null; // Simulate no next page when search is active
//         }

//         const photos = await this.fetchPhotos();
//         const response: UnsplashAPIOutput = {
//             results: photos,
//             total: this.photos.length,
//             total_pages: Math.ceil(this.photos.length / 30)
//         };
