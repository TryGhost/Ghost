...
test.describe('Tips and donations', () => {
    ...
    test('Is not shown when Stripe is disabled', async ({page}) => {
        ...
        expect(page.locator('[data-setting-nav-item] #tips-and-donations')).not.toBeVisible();
        expect(page.getByTestId('tips-and-donations')).not.toBeVisible();
    });
    ...
    test('Shows suggested amount and shareable link when Stripe is enabled', async ({page}) => {
        ...
        expect(page.locator('[data-setting-nav-item] #tips-and-donations')).toBeVisible();
