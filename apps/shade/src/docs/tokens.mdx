...
<p className="excerpt">Tokens are the smallest unit of the design system — a color, a size, a duration. Every other layer (primitives, components, patterns) ultimately resolves down to tokens. This page explains how they're defined, which families exist, and how to consume them.</p>
