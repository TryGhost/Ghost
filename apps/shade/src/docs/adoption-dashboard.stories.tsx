    ...
    return (
        <div className='shade' style={{padding: '32px', maxWidth: '1240px', margin: '0 auto'}}>
            ...
            <section className='mb-8'>
                <Card>
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4'>
                        <KpiCardHeader>
                            <KpiCardHeaderLabel>Shade adoption (breadth)</KpiCardHeaderLabel>
                            <KpiCardHeaderValue
                                diffDirection='hidden'
                                value={`${summary.shadeAdoptionPct}%`}
                            />
                            <span className='text-xs text-muted-foreground'>
                                {summary.adminReactFilesUsingShade} of {summary.adminReactFilesTotal} Admin React files
                                import Shade
                            </span>
                        </KpiCardHeader>
                        <KpiCardHeader>
            ...
            <section className='mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2'>
                <Card>
                    <CardHeader>
                        <CardTitle>Top Shade exports used</CardTitle>
                        <CardDescription>
                            Most-imported names from <code>@tryghost/shade*</code> across admin, posts, stats, and
                            activitypub. Includes components, hooks, and utilities.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
            ...
            <footer className='mt-12 border-t border-border pt-6 text-xs text-muted-foreground'>
                <p className='mb-2'>
                    <strong>How adoption is measured.</strong> The extraction script scans every <code>.ts/.tsx</code>{' '}
                ...
                <p>
                    <strong>Limitations.</strong> A file appears in &quot;Neither&quot; if it doesn&apos;t import a
                    design system at all (utilities, hooks, types, contexts). The Ember and public-apps numbers use
                    different measurement models and aren&apos;t directly comparable to the Shade adoption %.
                </p>
            </footer>
        </div>
    );
...
const meta = {
    title: 'Overview / Design System Adoption',
    component: Dashboard,
    tags: ['autodocs'],
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component:
                    'Snapshot of how Ghost\'s admin surfaces consume design systems. Tracks Shade adoption vs. admin-x-design-system across the Admin React apps, with Ember legacy and public apps for context. Data is generated by `pnpm --filter @tryghost/shade run adoption:extract` and committed as `adoption-data.json`.'
            }
        }
    }
