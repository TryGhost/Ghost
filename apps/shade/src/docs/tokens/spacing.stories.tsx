...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A single base unit (`--spacing`, 0.4rem) drives every Tailwind spacing utility and the semantic gap scale used by primitives.',
      },
    },
  },
} satisfies Meta;
...
export const SemanticGaps: Story = {
  render: () => (
    <div className="flex flex-col gap-4 text-sm text-text-secondary">
      <p>
        Primitives (`Stack`, `Inline`, `Box`, `Grid`) accept a semantic gap scale instead of raw
        numbers. The named values map to the same base unit but make intent readable.
      </p>
