...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Durations, easings, and named animations. Compose `--duration-*` with `--ease-*` for custom transitions; reuse named animations for common entrances.',
      },
    },
  },
} satisfies Meta;
...
export const NamedAnimations: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Pre-built animations for common entrances. Click any card to replay.',
      },
    },
  },
};
