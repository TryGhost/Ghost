...
<Meta title="Overview / Migration" />

<div className="sb-doc">

# Migration

<p className="excerpt">Active migration guides for Shade consumers. Each entry below describes a change in progress, what's required, and the cutoff date by which it should land. When a migration is complete, its section is removed.</p>

## Root imports → layered subpaths
...
| `@tryghost/shade` (product compositions) | `@tryghost/shade/patterns` |
