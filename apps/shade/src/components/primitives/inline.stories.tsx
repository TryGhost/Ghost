...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Horizontal layout primitive for actions, controls, and inline composition with explicit spacing.',
      },
    },
  },
...
export const Default: Story = {
  args: {
    ...
    children: (
      <>
        <button
          className="rounded-md border border-border-default bg-surface-panel px-3 py-2 text-sm"
          type="button"
        >
          Cancel
        </button>
        <button
          className="rounded-md border border-border-default bg-primary px-3 py-2 text-sm text-primary-foreground"
          type="button"
        >
          Save
        </button>
