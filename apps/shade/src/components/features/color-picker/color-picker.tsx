...
export const ColorPickerHue = ({
    ...
    return (
        ...
        >
            ...
            <Slider.Thumb className="border-primary/50 focus-visible:outline-hidden block size-4 rounded-full border bg-background shadow transition-colors focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50" />
        </Slider.Root>
    );
};
