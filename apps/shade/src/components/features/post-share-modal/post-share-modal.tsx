                    ...
                    {emailOnly ?
                        ...
                        <>
                            <div className='flex items-center gap-2'>
                                ...
                                <a aria-label='Share on LinkedIn' className='hover:bg-muted-foreground/20 flex h-[34px] w-14 items-center justify-center rounded-xs bg-muted px-3 [&_svg]:h-4' href={`http://www.linkedin.com/shareArticle?mini=true&title=${encodedPostTitle}&url=${encodedPostURL}`} rel="noopener noreferrer" target='_blank'>
