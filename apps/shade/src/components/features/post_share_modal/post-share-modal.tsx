            ...
            <DialogContent className='max-w-[600px] p-8'>
                <DialogHeader>
                    <DialogTitle className='text-3xl font-bold leading-[1.15em]'>
                        <span className='text-green-500'>Boom! It&apos;s out there.</span><br />
                        <span>Your post is published.</span>
                    </DialogTitle>
                    <DialogDescription className='pt-1 text-lg text-foreground'>
                        Your post was published on your site and sent to <strong>3 subscribers</strong> of <strong>Handcrafted questioner</strong>, on <strong>June 13th at 12:02</strong>.
                    </DialogDescription>
                </DialogHeader>
                <a className='flex flex-col items-stretch overflow-hidden rounded-md border transition-all hover:border-muted-foreground/40' href="https://ghost.org">
                    <div className='aspect-video bg-cover bg-center' style={{
                        backgroundImage: 'url(https://loremflickr.com/i/width-800/height-600)'
                    }}></div>
                    <div className='p-6'>
                        <H3>Post title</H3>
                        <p>Post excerpt</p>
