...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Chart components built on ShadCN/UI and Recharts for data visualization. Provides consistent theming and responsive containers for various chart types including pie, bar, and line charts.',
      },
    },
  },
  argTypes: {
