...
interface BannerBaseProps
    ...
    /** @default 'status' */
    bannerRole?: 'status' | 'alert' | 'region';
...
type NonDismissibleBannerProps = BannerBaseProps & {
    /** @default false */
    dismissible?: false;
    onDismiss?: never;
};
...
/**
 * Discriminated union: when dismissible is true, onDismiss is required
 */
type DismissibleBannerProps = BannerBaseProps & {
    dismissible: true;
    onDismiss: () => void;
};

export type BannerProps = NonDismissibleBannerProps | DismissibleBannerProps;
