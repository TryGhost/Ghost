...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Rows of related settings or resources with optional leading visuals and actions. Use Table for genuinely tabular data.',
      },
    },
  },
        ...
        <ActionListItem hover={false}>
          <ActionListItemContent className="py-3">
            ...
            <span className="block text-sm text-muted-foreground">
              Permanently delete all posts and tags.
            </span>
          </ActionListItemContent>
          <ActionListItemActions>
