...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Text input field for forms and user data entry. Supports all standard HTML input attributes and types.',
      },
    },
  },
  decorators: [
...
export const Invalid: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Use `aria-invalid` when validation fails so the input displays the standard destructive border and focus ring.',
      },
    },
  },
};
...
export const MatchingControlHeight: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Use this comparison to verify Input aligns with other controls powered by the shared control-height token.',
      },
    },
  },
};
