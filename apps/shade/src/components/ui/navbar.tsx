  ...
  ({ children, className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          `grid grid-cols-[1fr] justify-between gap-x-5 gap-y-2 border-b [grid-template-areas:'navigation''actions''subactions'] lg:grid-cols-[1fr_auto] lg:[grid-template-areas:'navigation_actions''subactions_subactions']`,
          className,
        )}
        data-navbar="navbar"
        {...props}
...
export { NavbarActions, NavbarNavigation, Navbar };
