...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Group of toggle buttons. Supports single or multiple selection modes for mutually exclusive or independent options.',
      },
    },
  },
  decorators: [
...
export const TextFormatting: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Single selection toggle group for text formatting options like bold, italic, and underline.',
      },
    },
  },
};
...
export const ButtonSized: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Toggle group with button-sized variant for a more prominent appearance, suitable for primary navigation controls.',
      },
    },
  },
};
