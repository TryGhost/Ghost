...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Navigation bar component for page-level navigation. Provides flexible layout with menu items and actions. Uses CSS Grid with named areas for responsive layout that adapts from mobile (stacked) to desktop (side-by-side).',
      },
    },
  },
...
export const WithNavbarNavigation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Navbar using the explicit NavbarNavigation wrapper for navigation content. Both navigation and actions are properly positioned using grid areas.',
      },
    },
  },
};
...
export const Minimal: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Minimal navbar with custom navigation content (page title) and a single action button.',
      },
    },
  },
};
