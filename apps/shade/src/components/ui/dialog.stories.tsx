      ...
      <>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Dialog positions are handled internally; no size prop is required.
            </DialogDescription>
          </DialogHeader>
...
export const NestedOverlayEscape: Story = {
      ...
      <DialogContent>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Popover>
            ...
            <PopoverContent className="w-64">Supplementary content</PopoverContent>
          </Popover>
        </div>
      </DialogContent>
    </Dialog>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'DropdownMenu, Select, and Popover consume their first Escape before the parent dialog.',
      },
    },
  },
};
