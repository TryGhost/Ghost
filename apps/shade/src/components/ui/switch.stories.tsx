...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'A control that allows users to toggle between checked and unchecked states. Built on Radix UI Switch primitive.',
      },
    },
  },
  decorators: [
...
export const Controlled: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center space-x-2">
          <Switch checked={checked} id="controlled-switch" onCheckedChange={setChecked} />
          <Label htmlFor="controlled-switch">{checked ? 'Enabled' : 'Disabled'}</Label>
        </div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Controlled switch with state managed in React. The label text updates based on the switch state.',
      },
    },
  },
};
...
export const FormIntegration: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Switch components integrated with react-hook-form for managing notification preferences. This example demonstrates a common use case for switches in settings forms.',
      },
    },
  },
};
...
export const MultipleSettings: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Multiple switches arranged in a settings list layout with labels aligned to the left and switches to the right.',
      },
    },
  },
};
