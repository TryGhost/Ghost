...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Use `Skeleton` for simple loading lines (supports multiple lines and optional width randomization). `SkeletonTable` provides a ready-made list/table placeholder with varied line widths.',
      },
    },
  },
...
export const Randomized: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Enable `randomize` to simulate natural text line length. Control range with `minWidth`/`maxWidth`.',
      },
    },
  },
};
...
export const TableDefault: SkeletonTableStory = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'A skeleton table component that renders multiple skeleton lines representing table rows or list items.',
      },
    },
  },
};
