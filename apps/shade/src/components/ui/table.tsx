...
>(({className, ...props}, ref) => (
    <th
        ref={ref}
        className={cn(
            'relative h-[34px] px-2 first-of-type:pl-0 last-of-type:pr-0 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
            className
        )}
        {...props}
    />
