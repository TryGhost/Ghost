...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Display structured data with visual bars for comparison. Ideal for analytics dashboards, leaderboards, and any data requiring visual ranking or comparison.',
      },
    },
  },
      ...
      <DataListBody key="body" className="group/datalist">
          ...
          <DataListItemContent>
            <div className="flex items-center space-x-4 overflow-hidden">
              ...
              <div className="truncate font-medium">
                Clean Monochrome Workspace in Düsseldorf, Germany A Designer’s Dual Apple Studio
                Display Workspace in Canada
              </div>
            </div>
          </DataListItemContent>
          <DataListItemValue>
        ...
        <DataListRow>
          ...
          <DataListItemContent>
            <div className="flex items-center space-x-4 overflow-hidden">
              <div>🇺🇸</div>
              <div className="truncate font-medium">No percentage value, no animation</div>
            </div>
          </DataListItemContent>
          <DataListItemValue>
        ...
        <DataListRow>
          <DataListItemContent>No bar, no animation, no nothing</DataListItemContent>
          <DataListItemValue>
      ...
      <DataListBody key="body" className="group/datalist">
        <DataListRow>
          ...
          <DataListItemContent>
            <div className="flex items-center space-x-4 overflow-hidden">
              <div>🏆</div>
              <div className="truncate font-medium">Top Performer</div>
            </div>
          </DataListItemContent>
          <DataListItemValue>
        ...
        <DataListRow>
          ...
          <DataListItemContent>
            <div className="flex items-center space-x-4 overflow-hidden">
              <div>🥈</div>
              <div className="truncate font-medium">Second Place</div>
            </div>
          </DataListItemContent>
          <DataListItemValue>
