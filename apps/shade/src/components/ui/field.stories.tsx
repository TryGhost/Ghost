...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Composable form field components for building accessible forms. Provides consistent structure for labels, descriptions, validation messages, and field grouping.',
      },
    },
  },
  decorators: [
...
export const CompleteExample: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Complete form example demonstrating fieldsets, field groups, separators, and horizontal button layout.',
      },
    },
  },
};
...
export const ResponsiveLayout: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Responsive layout that stacks vertically on mobile and arranges horizontally on larger screens using orientation="responsive".',
      },
    },
  },
};
  ...
  render: () => (
    <div className="w-full max-w-md">
      <Field orientation="vertical">
        ...
        <FieldDescription>A brief description that appears on your profile.</FieldDescription>
      </Field>
    </div>
  ),
  parameters: {
...
export const WithFieldContent: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Using FieldContent to group FieldTitle and FieldDescription for richer field layouts.',
      },
    },
  },
};
...
export const TitleDescriptionSpacing: Story = {
    ...
    <div className="w-full max-w-xl">
      <Field orientation="horizontal">
        <FieldContent>
          ...
          <FieldDescription>
            Enabling this will use your revenue and member growth data to rank your site more
            highly.
          </FieldDescription>
        </FieldContent>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'FieldContent keeps titles and supporting descriptions in the standard compact vertical rhythm.',
      },
    },
  },
};
...
export const LegendVariants: Story = {
  render: () => (
    <div className="w-full max-w-md space-y-6">
      <FieldSet>
        ...
        <FieldDescription>Legend variant uses larger text for section headings.</FieldDescription>
        <FieldGroup>
          <Field>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Different legend variants for section headings: "legend" for larger headings, "label" for smaller ones.',
      },
    },
  },
};
