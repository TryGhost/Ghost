...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Collapsible sidebar navigation component with support for nested menus, actions, and responsive behavior. Built with context for state management.',
      },
    },
  },
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Full sidebar layout with header, navigation groups, and footer. Includes collapsible behavior and tooltips.',
      },
    },
  },
};
