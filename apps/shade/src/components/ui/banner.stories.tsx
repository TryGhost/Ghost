...
export const Dismissible: Story = {
  render: () => {
    ...
    return (
      <Banner variant="info" dismissible onDismiss={() => setIsVisible(false)}>
        <div className="flex items-start gap-3 pr-8">
          <Info className="mt-0.5 size-5 text-blue-600" />
          <div className="text-sm">
            <strong className="mb-1 block">Pro tip</strong>
            <p>
              You can dismiss this banner by clicking the × button. Parent component manages
              visibility state.
            </p>
          </div>
        </div>
    ...
    children: (
      <div className="flex items-start gap-3">
        ...
        <div className="text-sm">
          ...
          <p>
            This uses role=&quot;alert&quot; which has implicit aria-live=&quot;assertive&quot; for
            screen readers.
          </p>
        </div>
      </div>
