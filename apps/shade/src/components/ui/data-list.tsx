    ...
    return (
        <div
            ...
            className={cn(
                ...
                // Apply animation styles when there are multiple children
                hasMultipleChildren && '[&>[data-type="value-abs"]]:transition-transform [&>[data-type="value-abs"]]:duration-300 [&>[data-type="value-abs"]]:group-hover:-translate-x-14',
                hasMultipleChildren && '[&>[data-type="value-perc"]]:invisible [&>[data-type="value-perc"]]:absolute [&>[data-type="value-perc"]]:right-0 [&>[data-type="value-perc"]]:translate-x-14 [&>[data-type="value-perc"]]:opacity-0 [&>[data-type="value-perc"]]:transition-all [&>[data-type="value-perc"]]:duration-300 [&>[data-type="value-perc"]]:group-hover:visible [&>[data-type="value-perc"]]:group-hover:translate-x-0 [&>[data-type="value-perc"]]:group-hover:opacity-100',
                className
            )}
            {...props}
        >
