...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Lightweight spinner for inline and page-level loading. Supports `sm`/`md`/`lg` sizes and `current`/`dark`/`light` color for contrast on different backgrounds.',
      },
    },
  },
...
export const CurrentColor: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Use the `current` variant when a spinner should inherit the foreground color of its parent surface.',
      },
    },
  },
};
...
export const BarChartVariant: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Alternative loading indicator styled like a bar chart, useful for data-heavy views.',
      },
    },
  },
};
