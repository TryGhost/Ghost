...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'A searchable command list with consistent control typography for queries and results.',
      },
    },
    layout: 'centered',
  },
...
export const MatchingSearchTypography: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Search text and placeholders use the same control typography as the result options.',
      },
    },
  },
};
