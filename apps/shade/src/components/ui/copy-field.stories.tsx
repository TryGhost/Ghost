...
export const WithAdditionalAction: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Compose other row actions beside the copy action when the value supports more workflows.',
      },
    },
  },
};
...
export const ActionsVisible: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Hovering the value or focusing an action reveals the available controls on larger screens.',
      },
    },
  },
};
