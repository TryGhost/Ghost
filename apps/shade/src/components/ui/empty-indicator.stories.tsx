...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Communicates an empty state for lists or sections. Pair with a short title, one-line description, and optional follow-up actions.',
      },
    },
  },
...
export const TitleOnly: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Use title-only when the context is self-explanatory and no additional description is needed.',
      },
    },
  },
};
...
export const TitleWithAction: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Combine a title with actions when the next step is clear without needing additional explanation.',
      },
    },
  },
};
