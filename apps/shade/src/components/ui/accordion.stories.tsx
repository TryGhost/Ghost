  ...
  args: {
    ...
    children: [
      <AccordionItem key="item-1" value="item-1">
        ...
        <AccordionContent>
          Ghost is a powerful platform for building modern online publications. It&apos;s designed
          for professional publishers, bloggers, and content creators who want to focus on creating
          great content.
        </AccordionContent>
      </AccordionItem>,
      <AccordionItem key="item-2" value="item-2">
        ...
        <AccordionContent>
          Getting started with Ghost is easy. You can either use Ghost(Pro) for a hosted solution or
          self-host Ghost on your own server. Both options come with comprehensive documentation and
          support.
        </AccordionContent>
      </AccordionItem>,
      <AccordionItem key="item-3" value="item-3">
        <AccordionTrigger>What features does Ghost offer?</AccordionTrigger>
        <AccordionContent>
          Ghost offers a wide range of features including a powerful editor, built-in SEO tools,
          membership and subscription management, email newsletters, analytics, and much more.
        </AccordionContent>
      </AccordionItem>,
    ],
  },
...
export const CustomStyling: Story = {
    ...
    children: [
      ...
      >
        ...
        <AccordionContent className="rounded-b-lg bg-white px-4 py-3">
          This accordion item has custom styling with colored borders and backgrounds.
        </AccordionContent>
      </AccordionItem>,
      <AccordionItem key="item-2" className="rounded-lg border-2 border-green-200" value="item-2">
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Tailor borders, padding, and hover states via `className` on the wrapper and subcomponents.',
      },
    },
  },
};
