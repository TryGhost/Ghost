...
export const ErrorState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Error state indicated by aria-invalid attribute. The entire group displays error styling for clear feedback.',
      },
    },
  },
};
...
export const Disabled: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Disabled groups use the shared disabled field surface while keeping their value readable. Add data-disabled="true" to the InputGroup for consistent wrapper styling.',
      },
    },
  },
};
