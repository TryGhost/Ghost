...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Right-click menu for object-specific actions. Use when commands are secondary to the main surface and need pointer or long-press access.',
      },
    },
  },
...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Includes groups, separators, submenus, disabled items, checkbox and radio states, destructive styling, icons, and keyboard shortcuts.',
      },
    },
  },
  args: {
