...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'A set of mutually exclusive options built on the Radix UI Radio Group primitive.',
      },
    },
  },
...
export const CheckIndicator: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Use the check indicator when preserving an established checked-circle treatment for a mutually exclusive choice.',
      },
    },
  },
};
