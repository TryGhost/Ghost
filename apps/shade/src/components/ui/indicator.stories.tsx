...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'A simple status dot primitive for showing status with small colored dots. Lighter weight than Badge component, designed for notification dots, connection status, and other minimal indicators.',
      },
    },
  },
  argTypes: {
