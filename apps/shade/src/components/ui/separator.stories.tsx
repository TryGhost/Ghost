...
export const Vertical: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Vertical orientation for inline grouping (e.g., toolbar items). Adjust height with Tailwind classes.',
      },
    },
  },
};
...
export const NonDecorative: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Set `decorative=false` when the separator conveys meaning. Include an accessible label.',
      },
    },
  },
};
