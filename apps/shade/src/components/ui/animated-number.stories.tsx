...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Animated numeric transitions using `@number-flow/react`. Pass any `Intl.NumberFormat` options via the `format` prop.',
      },
    },
  },
...
export const WithFormatting: Story = {
  render: () => {
    const FormattingExample = () => {
      ...
      const values = [1234567.89, 2500000.5, 999.99, 150000.75];
