...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Display country flags using ISO country codes. Built on country-flag-icons with customizable sizing and fallback support for invalid or missing country codes.',
      },
    },
  },
  argTypes: {
