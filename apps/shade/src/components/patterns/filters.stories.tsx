...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Advanced filtering component with support for multiple field types, operators, and customizable UI. Built for complex data filtering scenarios.',
      },
    },
  },
  decorators: [
...
const FilterDemo = ({
  ...
  return (
    <div>
      <Filters fields={fields} filters={filters} onChange={setFilters} {...props} />
      <div className="mt-6">
  ...
  },
  {
    ...
    options: [
      { value: 'urgent', label: 'Urgent', icon: <AlertCircle className="size-3.5 text-red-500" /> },
      {
        value: 'important',
        label: 'Important',
        icon: <Circle className="size-3.5 text-orange-500" />,
      },
    ...
    fields: [
      {
        ...
        options: [
          ...
          },
          {
            value: 'pending',
            label: 'Pending',
            icon: <Clock className="size-3.5 text-yellow-500" />,
          },
          {
            value: 'inactive',
            label: 'Inactive',
...
export const WithValidation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Filters with built-in validation for email, URL, and phone fields. Try entering invalid values and pressing Enter or clicking away.',
      },
    },
  },
};
...
export const AddButtonAtStart: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Add button positioned at the start (left side) of the filter list using CSS order property. By default, the add button appears at the end. This is achieved with the className prop: `className="[&>button]:order-first"`',
      },
    },
  },
};
...
export const WithClearButton: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Filters with an integrated clear button that appears when filters are active. The clear button removes all filters with a single click.',
      },
    },
  },
};
...
export const MobileFriendlyLayout: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Mobile-optimized layout with clear button. The add button appears at the end of the filter list by default. On mobile, the clear button flows with the filters. On larger screens (sm+), it positions absolutely at the top-right. The container is constrained to mobile width (max-w-md) to demonstrate responsive behavior.',
      },
    },
  },
};
...
export const FullWidthResponsiveLayout: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Full-width responsive layout demonstrating the clear button behavior. Resize your browser to see how the clear button repositions: flows inline on mobile, moves to top-right on desktop.',
      },
    },
  },
};
    ...
    <div>
      ...
      <div className="mt-6">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          Clear button clicked: <span className="font-medium text-foreground">{clearCount}</span>{' '}
          times
        </p>
      </div>
    </div>
...
export const ClearButtonCustomHandler: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Custom clear handler using the `onClear` prop. This allows you to perform additional actions when filters are cleared, such as analytics tracking or side effects.',
      },
    },
  },
};
...
export const ComposedSegments: Story = {
  render: () => (
    <FilterDemo
      ...
      initialFilters={[createFilter('address', 'contains', ['city', 'York'])]}
    />
  ),
  parameters: {
    docs: {
...
export const ReadOnlyFilter: Story = {
  render: () => (
    <FilterDemo
      ...
      initialFilters={[createFilter('archived_field', 'is', ['London'])]}
    />
  ),
  parameters: {
    docs: {
      description: {
        story:
          'A read-only filter keeps its operator and value visible as static text and can only be removed — for a filter on a source no longer offered, such as an archived field.',
      },
    },
  },
};
...
export const GroupPreviewLimit: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'A group can preview a subset of its fields with `previewLimit`, revealing the rest behind "Show more". Every field stays resolvable and findable by search.',
      },
    },
  },
};
