...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Groups related Ghost settings into a consistent card with composable header, actions, content, and value regions.',
      },
    },
  },
...
export const Plain: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Use the plain variant when a parent modal already provides the surrounding surface.',
      },
    },
  },
  render: () => (
