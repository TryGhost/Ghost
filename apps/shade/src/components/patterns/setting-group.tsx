...
interface SettingGroupProps
  extends React.ComponentPropsWithoutRef<'div'>, VariantProps<typeof settingGroupVariants> {
  editing?: boolean;
}

const SettingGroup = React.forwardRef<HTMLDivElement, SettingGroupProps>(
  ({ className, variant, highlighted, editing = false, ...props }, ref) => (
    <div
      ref={ref}
...
const SettingGroupHeader = React.forwardRef<
  HTMLElement,
  React.ComponentPropsWithoutRef<typeof Inline>
>(({ className, ...props }, ref) => (
  <Inline
    ref={ref}
    align="start"
...
const SettingGroupDetails = React.forwardRef<
  HTMLDivElement,
...
const SettingGroupTitle = React.forwardRef<
  HTMLElement,
...
>(({ className, ...props }, ref) => (
  <Text
    ref={ref}
    as="h5"
    className={cn('md:text-lg', className)}
    leading="supertight"
    weight="semibold"
    {...props}
  />
...
const SettingGroupDescription = React.forwardRef<
  HTMLElement,
  React.ComponentPropsWithoutRef<typeof Text>
>(({ className, ...props }, ref) => (
  <Text
    ref={ref}
    className={cn(
      'mr-5 hidden text-pretty group-data-[editing=false]/setting-group:block md:block',
      className,
    )}
    {...props}
  />
...
const SettingGroupActions = React.forwardRef<HTMLDivElement, React.ComponentPropsWithoutRef<'div'>>(
  ({ className, ...props }, ref) => (
...
const SettingGroupContent = React.forwardRef<HTMLDivElement, SettingGroupContentProps>(
  ({ children, className, columns = 1, ...props }, ref) => {
    if (columns === 2) {
      return (
        <Grid
          ref={ref}
          className={cn('grid-cols-1 gap-x-8 gap-y-6 md:grid-cols-2', className)}
          columns={1}
          gap="none"
          {...props}
        >
...
const SettingGroupValue = React.forwardRef<
  HTMLDivElement,
  React.ComponentPropsWithoutRef<typeof Stack>
>(({ className, ...props }, ref) => (
...
const SettingGroupValueTitle = React.forwardRef<
  HTMLElement,
  React.ComponentPropsWithoutRef<typeof Text>
>(({ className, ...props }, ref) => (
...
const SettingGroupValueContent = React.forwardRef<
  HTMLElement,
  React.ComponentPropsWithoutRef<typeof Inline>
>(({ className, ...props }, ref) => (
