...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Ghost-specific area charts for analytics dashboards. Built on Recharts with custom tooltips, trend indicators, and optimized date formatting for time-series data visualization.',
      },
    },
  },
  argTypes: {
