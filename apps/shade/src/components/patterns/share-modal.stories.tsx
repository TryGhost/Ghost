...
const encodedPostTitleAndUrl = encodeURIComponent(
  `Copy to Clipboard in React: Complete Guide ${postUrl}`,
);
...
const postPreview = {
  description:
    'A comprehensive guide to implementing copy-to-clipboard functionality in React applications with proper error handling and user feedback.',
  ...
  meta: (
    <div className="mt-2 flex items-start gap-2">
      <div
        ...
        style={{
          backgroundImage: 'url(https://www.google.com/s2/favicons?domain=ghost.org&sz=64)',
        }}
      ></div>
...
function PublicationPreview() {
  return (
    <ShareModal.Preview className="rounded-lg bg-card" href={publicationPreview.url}>
      <div
        className="aspect-video bg-cover bg-center"
        style={{ backgroundImage: `url(${publicationPreview.imageURL})` }}
      ></div>
      <div className="p-5">
        ...
        <ShareModal.Root open={isOpen} onOpenChange={setIsOpen}>
          ...
          <ShareModal.Content>
            ...
            <ShareModal.Header className="relative -mt-5">
              ...
              <ShareModal.Description className="mb-0 pt-1 pb-0 text-lg text-foreground">
                Your post was published on your site and sent to <strong>3 subscribers</strong> of{' '}
                <strong>Ghost Blog</strong>, on <strong>June 13th</strong> at <strong>12:02</strong>
                .
              </ShareModal.Description>
            </ShareModal.Header>
            <PostPreview />
        ...
        <ShareModal.Root open={isOpen} onOpenChange={setIsOpen}>
          ...
          <ShareModal.Content data-testid="publication-share-modal">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <Button
                className="h-auto p-0 align-baseline text-sm text-green hover:text-green/90"
                variant="link"
                asChild
              >
