...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "KPI tabs for analytics dashboards. Each trigger renders a metric label, value, and optional trend badge. Wraps the generic Tabs primitive with `variant='kpis'` styling.",
      },
    },
  },
  decorators: [
...
export const Basic: Story = {
    ...
    <Tabs defaultValue="signups" variant="kpis">
      <TabsList>
        <KpiTabTrigger value="signups">
          <KpiTabValue diffDirection="up" diffValue="+12.5%" label="Signups" value="1,247" />
        </KpiTabTrigger>
        <KpiTabTrigger value="revenue">
          <KpiTabValue diffDirection="up" diffValue="+8.2%" label="Revenue" value="$54,890" />
        </KpiTabTrigger>
        <KpiTabTrigger value="engagement">
          <KpiTabValue diffDirection="down" diffValue="-2.1%" label="Engagement" value="68.4%" />
        </KpiTabTrigger>
      </TabsList>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'KPI tabs displaying metrics with trend indicators - perfect for dashboard analytics.',
      },
    },
  },
};
...
export const WithColors: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'KPI tabs with color-coded indicators to categorize different data sources or types.',
      },
    },
  },
};
...
export const WithoutTrends: Story = {
    ...
    <Tabs defaultValue="subscribers" variant="kpis">
      <TabsList>
        ...
        <KpiTabTrigger value="posts">
          <KpiTabValue diffDirection="hidden" icon="FileText" label="Published Posts" value="89" />
        </KpiTabTrigger>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'KPI tabs showing absolute values without trend indicators - useful for cumulative or static metrics.',
      },
    },
  },
};
