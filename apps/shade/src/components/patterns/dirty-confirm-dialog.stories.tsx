...
} from '@/components/patterns/dirty-confirm-dialog';
  ...
  return (
    <>
      <Inline align="center" gap="md">
        <Button onClick={() => confirm(true, () => setStatus('Left the dirty surface'))}>
          Leave page
        </Button>
...
export const Interactive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Use when an action would discard unsaved changes; Stay preserves the current surface and Leave runs the pending action.',
      },
    },
  },
};
...
export const Open: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'The open state shows the standard unsaved-changes title, supporting copy, and safe/destructive actions.',
      },
    },
  },
};
