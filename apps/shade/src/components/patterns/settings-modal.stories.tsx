...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Consumer-controlled shell for the legacy full-page settings dialogs. New modal flows should use Shade Dialog primitives directly.',
      },
    },
  },
...
export const StickyChrome: Story = {
  args: {
    ...
    stickyFooter: true,
    children: (
      <Box className="h-[720px] py-4">Scroll to verify the header and footer remain visible.</Box>
    ),
    onOk: () => undefined,
  },
};
