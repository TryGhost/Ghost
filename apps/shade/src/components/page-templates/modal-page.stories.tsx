...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Content layout for full-width and full-bleed modals that present a complete page.',
      },
    },
  },
...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Use inside a full-width or full-bleed modal when its content needs page-level spacing and an optional title.',
      },
    },
  },
  render: () => (
