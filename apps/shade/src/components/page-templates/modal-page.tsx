...
const ModalPageTitle = React.forwardRef<HTMLElement, ModalPageTitleProps>(function ModalPageTitle(
  { className, ...props },
  ref,
) {
  return (
...
const ModalPageRoot = React.forwardRef<HTMLDivElement, ModalPageProps>(function ModalPage(
  { className, ...props },
  ref,
) {
  return (
