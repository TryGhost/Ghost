...
const TopPosts: React.FC<TopPostsProps> = ({
    ...
    const metricClass = `flex items-center justify-end gap-1 rounded-md px-2 py-1 font-mono text-sm font-semibold text-gray-800 transition-colors duration-150 ease-in-out dark:text-white hover:bg-muted-foreground/10 group-hover:text-foreground`;
