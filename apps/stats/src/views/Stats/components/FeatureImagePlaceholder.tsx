...
const FeatureImagePlaceholder:React.FC<FeatureImagePlaceholderProps> = ({
    ...
    return (
        <div className={cn('rounded-sm bg-muted flex flex-col items-stretch justify-start gap-1', className)}>
            <div className='h-1/2 rounded-t-sm bg-muted-foreground/20'></div>
            <div className='flex flex-col items-stretch gap-0.5 px-[20%]'>
