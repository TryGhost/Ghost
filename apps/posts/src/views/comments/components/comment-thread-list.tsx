                ...
                <div className="grow">
                    ...
                    >
                                    ...
                                    {hasReplies ? (
                                        <TooltipProvider>
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <button
                                                        className='flex items-center gap-1 text-xs text-gray-800 hover:opacity-70 cursor-pointer'
                                                        onClick={(e) => {
                                                            e.stopPropagation();
                        ...
                        {hasReplies && comment.replies && (
                            <div className="-ml-2 mb-4 mt-7 md:-ml-3 md:mb-0 md:mt-8 pl-2 md:pl-3">
