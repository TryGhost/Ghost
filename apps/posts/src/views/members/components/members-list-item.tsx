...
function MembersListItem({
    ...
    return (
        ...
        >
            <TableCell className='min-w-0 bg-background px-4 py-3 group-hover:bg-[var(--members-sticky-hover-bg)] max-sm:!w-full max-sm:!min-w-0 max-sm:rounded-lg sm:rounded-l-lg lg:sticky lg:left-0 lg:z-20' style={memberCellStyle}>
