...
const MemberSubscriptionCompActions: React.FC<MemberSubscriptionCompActionsProps> = ({member, tierId}) => {
    ...
    const membersRefetching = useIsFetching(['MembersResponseType']) > 0;
    const busy = editMember.isLoading || (editMember.isSuccess && membersRefetching);
        ...
        <>
            ...
            <AlertDialog open={confirmOpen} onOpenChange={(open) => {
                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        <AlertDialogCancel disabled={editMember.isLoading}>Cancel</AlertDialogCancel>
