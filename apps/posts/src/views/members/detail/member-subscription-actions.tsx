...
import {useEditMemberSubscription} from '@tryghost/admin-x-framework/api/members';
...
const MemberSubscriptionActions: React.FC<MemberSubscriptionActionsProps> = ({memberId, subscription}) => {
    ...
    const busy = editSubscription.isLoading || (editSubscription.isSuccess && membersRefetching);
