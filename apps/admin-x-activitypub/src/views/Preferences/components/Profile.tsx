            ...
            <div className='relative flex flex-col items-center overflow-hidden rounded-2xl bg-gray-50'>
                ...
                <div className='relative z-10 flex w-full items-center justify-between px-6 pb-6'>
                    <div className='flex items-center gap-2'>
                        <a className='flex h-[34px] w-10 items-center justify-center rounded-sm bg-white px-3 shadow-xs hover:bg-gray-50 [&_svg]:size-4' href={`https://twitter.com/intent/tweet?text=${account?.handle}%0A${account?.handle}`} rel="noopener noreferrer" target='_blank'>
                        ...
                        <a className='flex h-[34px] w-10 items-center justify-center rounded-sm bg-white px-3 shadow-xs hover:bg-gray-50 [&_svg]:size-4' href={`https://threads.net/intent/post?text=${account?.handle}`} rel="noopener noreferrer" target='_blank'>
                        ...
                        <a className='flex h-[34px] w-10 items-center justify-center rounded-sm bg-white px-3 shadow-xs hover:bg-gray-50 [&_svg]:size-4' href={`https://www.facebook.com/sharer/sharer.php?u=${account?.handle}`} rel="noopener noreferrer" target='_blank'>
                        ...
                        <a className='flex h-[34px] w-10 items-center justify-center rounded-sm bg-white px-3 shadow-xs hover:bg-gray-50 [&_svg]:size-4' href={`http://www.linkedin.com/shareArticle?mini=true&title=${account?.handle}&url=${account?.handle}`} rel="noopener noreferrer" target='_blank'>
