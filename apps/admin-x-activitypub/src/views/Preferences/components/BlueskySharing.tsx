            ...
            <div className='mx-auto max-w-[620px] px-6 py-12'>
                ...
                {!enabled ?
                    <div className='mt-3 flex flex-col gap-5'>
                        <p className='text-base'>Connect your account to Bluesky to share your content directly to your Bluesky profile. When enabled, new posts you create can be automatically shared to your Bluesky account, expanding your reach across platforms.</p>
                        <p className='-mt-2 text-base'>Bluesky doesn’t support username changes. Make sure you’re happy with your social web handle before connecting.</p>
