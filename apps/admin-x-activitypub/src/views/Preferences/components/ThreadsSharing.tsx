            ...
            <div className='mx-auto max-w-[620px] px-6 py-12'>
                ...
                {!enabled ?
                    <div className='mt-3 flex flex-col gap-5'>
                        ...
                        <p className='-mt-2 text-base'>Threads doesn’t support username changes. Make sure you’re happy with your social web handle before connecting.</p>
                    ...
                    <>
                        <p className='mt-3 text-base'>Your content is now being shared to Threads. Allow a few minutes for your Threads profile to activate before posts appear.</p>
                        <p className='mt-3 text-base'>To view your Threads profile, you&apos;ll need to enable the <a className='text-purple' href="https://www.threads.net/settings/fediverse" rel="noreferrer" target="_blank">Fediverse beta</a> feature in your Threads account. Please note that Thread&apos;s Fediverse features are not available for users in the EU.</p>
