    ...
    return (
        <MainHeader>
            <div className='col-[1/2] flex gap-8 px-8'>
                ...
                />
                <Button className={`${page === 'notifications' ? 'font-bold text-grey-975' : 'text-grey-700 hover:text-grey-800'}`} label='Notifications' unstyled onClick={() => updateRoute('notifications')} />
