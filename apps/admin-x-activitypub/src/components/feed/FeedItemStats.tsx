...
const FeedItemStats: React.FC<FeedItemStatsProps> = ({
    ...
    const buttonClassName = `transition-color flex p-2 ap-action-button items-center justify-center ${layout === 'feed' ? 'rounded-full' : 'rounded-md'} bg-white text-gray-900 leading-none hover:bg-gray-100 dark:bg-black dark:hover:bg-gray-950 dark:text-gray-600`;
