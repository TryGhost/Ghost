    ...
    updateAccount(
      {
        ...
        username:
          getHandleParts(account.handle).username || account.handle.replace(/^@/, '').split('@')[0],
        bio: data.bio ?? '',
    ...
    <Form {...form}>
      ...
      >
        <div className="relative mb-2">
          ...
          >
            {coverImagePreview ? (
              <>
                <img
                  className={`size-full object-cover ${isCoverImageUploading && 'opacity-10'}`}
          ...
          >
            {profileImagePreview ? (
              <>
                <img
                  className={`size-full rounded-full object-cover ${isProfileImageUploading && 'opacity-10'}`}
        ...
        <DialogFooter className="max-sm:gap-2">
          ...
          <Button
            disabled={isSubmitting || isProfileImageUploading || isCoverImageUploading}
            type="submit"
          >
            Save
          </Button>
