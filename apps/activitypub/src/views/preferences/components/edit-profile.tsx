                ...
                <div className='relative mb-2'>
                    <div className='group relative flex h-[180px] cursor-pointer items-center justify-center bg-gray-100 dark:bg-gray-950' onClick={triggerCoverImageInput}>
                        {coverImagePreview ?
                            ...
                            <Button className='bg-gray-250 pointer-events-none absolute right-3 bottom-3 group-hover:bg-gray-300' variant='secondary'>Upload cover image</Button>
                        }
                    </div>
                ...
                <FormField
                    ...
                    render={({field}) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <div className='bg-gray-150 relative flex items-center justify-stretch gap-1 rounded-md border border-transparent px-3 transition-colors focus-within:border-green focus-within:bg-transparent focus-within:shadow-[0_0_0_2px_rgba(48,207,67,.25)] focus-within:outline-hidden dark:bg-gray-900'>
