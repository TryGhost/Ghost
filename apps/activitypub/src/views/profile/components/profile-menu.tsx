      ...
      <AlertDialogContent onClick={(e) => e.stopPropagation()}>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {dialogType === 'user' ? (
              <>
                <span className="font-semibold text-black">{handle}</span> will be able to see your
                public posts, but will no longer be able follow you or interact with your content on
                the social web.
              </>
            ) : (
              <>
                All users from <span className="font-semibold text-black">{domain}</span> will be
                able to see your public posts, but won&apos;t be able to follow you or interact with
                your content.
              </>
            )}
          </AlertDialogDescription>
