        ...
        <PopoverContent align='end' className='w-[224px]' onCloseAutoFocus={e => e.preventDefault()} onOpenAutoFocus={e => e.preventDefault()}>
            <div className='flex flex-col gap-4'>
                <div className='flex items-center justify-between gap-[6px]'>
                    <Button
                        className={`hover:bg-gray-250 dark:bg-gray-925 h-7 flex-1 rounded-[6px] bg-gray-200 p-0 text-[1.1rem] text-black dark:text-white dark:hover:bg-gray-900 [&_svg]:size-[14px] ${isActiveColor('SYSTEM') ? 'outline outline-2 outline-green' : ''}`}
                        variant="secondary"
                    ...
                    />
                    <Button
                        className={`dark:border-gray-925 h-7 flex-1 rounded-[6px] bg-black p-0 hover:bg-black dark:border ${isActiveColor('DARK') ? 'outline outline-2 outline-green' : ''}`}
                        onClick={() => onColorChange('DARK')}
                    />
                </div>
                <div className='flex gap-2'>
                    <Button
                        className={`hover:bg-gray-250 dark:bg-gray-925 flex h-auto w-full flex-col gap-1 rounded-[6px] bg-gray-200 text-black dark:text-white dark:hover:bg-gray-900 ${isActiveFont('sans') && 'outline outline-2 outline-green'}`}
                        variant="secondary"
                    ...
                    <Button
                        className={`hover:bg-gray-250 dark:bg-gray-925 flex h-auto w-full flex-col gap-1 rounded-[6px] bg-gray-200 text-black dark:text-white dark:hover:bg-gray-900 ${isActiveFont('serif') && 'outline outline-2 outline-green'}`}
                        variant="secondary"
