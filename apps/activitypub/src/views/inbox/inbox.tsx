...
const Inbox: React.FC = () => {
  ...
  const { discoveryFeedQuery: discoverQuery } = useDiscoveryFeedForUser({
    enabled: topic !== 'following',
    topic,
  });
