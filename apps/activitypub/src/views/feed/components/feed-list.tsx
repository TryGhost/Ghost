                ...
                <div className="mt-[-128px]">
                  <EmptyViewIndicator>
                    ...
                    <div>
                      ...
                      <span className="text-black dark:text-white">bite-sized updates</span> from
                      people you follow in the Social Web. It&apos;s looking a little empty right
                      now but once the people you follow start posting, their updates will show up
                      here.
                    </div>
                    <NewNoteModal>
