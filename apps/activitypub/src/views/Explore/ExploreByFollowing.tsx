...
const ExploreByFollowing: React.FC = () => {
    ...
    const profiles = exploreProfilesData?.pages.flatMap(page => Object.values(page.results).flatMap(category => category.sites)) || [];
    ...
    return (
        <Layout>
            {!isExplainerClosed &&
                <div className='relative my-6 flex items-start gap-1 rounded-md bg-gradient-to-r from-[#CFB0FF66] to-[#B6E8FF66] p-4 pr-10 dark:from-[#CFB0FF20] dark:to-[#B6E8FF20]'>
...
export default ExploreByFollowing;
