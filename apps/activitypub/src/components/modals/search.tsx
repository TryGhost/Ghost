...
const Search: React.FC<SearchProps> = ({onOpenChange, query, setQuery}) => {
    ...
    return (
        <>
            <div className='sticky -top-6 z-30 -mt-6 flex h-[72px] shrink-0 items-center gap-2 bg-white pt-3 pb-2 before:pointer-events-none before:absolute before:-inset-x-6 before:bottom-0 before:h-0 before:border-b before:border-b-gray-200 before:content-[""] dark:bg-[#101114] dark:before:border-b-gray-950'>
