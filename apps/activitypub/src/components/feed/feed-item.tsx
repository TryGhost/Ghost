...
export function renderFeedAttachment(
    ...
    const renderImagePlaceholder = (className: string, isSingleImage: boolean = false) => {
        ...
        return (
            <div className={`${className} ${minHeight} dark:bg-gray-925/30 flex w-full items-center justify-center bg-gray-100`}>
...
const FeedItem: React.FC<FeedItemProps> = ({
    ...
    if (layout === 'feed') {
        ...
        return (
            <>
                {object && (
                    <div className='group/article hover:bg-gray-75 @container/inbox-item relative -mx-4 -my-px flex min-h-[112px] min-w-0 cursor-pointer items-center justify-between rounded-lg p-6 dark:hover:bg-gray-950/50' data-layout='inbox' data-object-id={object.id} onClick={onClick}>
