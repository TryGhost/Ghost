                  ...
                  <div>
                    ...
                    >
                      ...
                      <div className="flex min-w-0  flex-col">
                        <span className="block max-w-[190px] truncate font-semibold text-black dark:text-white">
                          {!isLoadingSuggested ? actorName : <Skeleton className="w-24" />}
                        </span>
                        <span className="block max-w-[190px] truncate text-sm text-gray-700 dark:text-gray-600">
                          {!isLoadingSuggested ? actorHandle : <Skeleton className="w-40" />}
                        </span>
                      </div>
                    </ActivityItem>
                  </div>
