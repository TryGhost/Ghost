...
import {
  useNotificationsCountForUser,
  useResetNotificationsCountForUser,
  useTopicsForUser,
} from '@src/hooks/use-activity-pub-queries';
      ...
      <div className="flex grow flex-col justify-between">
        <div className="isolate flex w-full flex-col items-start gap-6 pt-5 pl-6">
          ...
          <div className="flex w-full flex-col gap-px">
            ...
            <SidebarMenuLink
              count={
                location.pathname !== `${basePath}/notifications` ? notificationsCount : undefined
              }
              to="/notifications"
