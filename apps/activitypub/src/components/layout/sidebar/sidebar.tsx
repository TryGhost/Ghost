                ...
                <div className='isolate flex w-full flex-col items-start gap-6 pt-6 pl-6'>
                    <div className='flex h-[52px] w-full items-center'>
                        <Dialog open={isSearchOpen} onOpenChange={setIsSearchOpen}>
                            ...
                            <DialogContent className='flex h-full max-h-[452px] flex-col overflow-y-auto pb-0'>
                    ...
                    <div className='flex w-full flex-col gap-px'>
                        ...
                        {showExternalExplore ? (
                            <Button
                                className='dark:hover:bg-gray-925/70 inline-flex w-full items-center gap-2 rounded-sm px-3 py-2.5 text-left text-md font-medium text-gray-800 transition-colors hover:bg-gray-100 dark:text-gray-500'
                                variant='ghost'
                                asChild
                            >
