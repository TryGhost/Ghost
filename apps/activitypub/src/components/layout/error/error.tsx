    ...
    return (
      <Layout>
        <EmptyViewIndicator>
          ...
          <div>
            We couldn&apos;t find the page you were looking for. It may have been moved, deleted, or
  ...
  if (statusCode === 429) {
    return (
      <EmptyViewIndicator className="mt-[50vh] -translate-y-1/2">
        ...
        <Button asChild>
          <a href="https://ghost.org/help/social-web/" rel="noopener noreferrer" target="_blank">
            Learn more &rarr;
          </a>
        </Button>
      </EmptyViewIndicator>
    ...
    if (errorCode === 'ROLE_MISSING' || errorCode === 'SITE_MISSING') {
      return (
        <EmptyViewIndicator className="mt-[50vh] -translate-y-1/2">
          ...
          <div>
            This feature can&apos;t be used because the site isn&apos;t set up correctly. If you
            manage this site, check your settings or server logs, or contact support.
          </div>
          <Button asChild>
            <a href="https://ghost.org/help/social-web/" rel="noopener noreferrer" target="_blank">
              Learn more &rarr;
