      ...
      <div className="flex w-full items-start gap-3">
        ...
        <div className="flex flex-col gap-2 text-sm">
          <div className="mt-0.5 flex flex-col gap-0.5">
            <div className="leading-tighter font-semibold">
              {name} <span className="font-normal text-gray-700 dark:text-gray-600">{handle}</span>
            </div>
...
const Reaction: React.FC<{
  ...
  return (
    <div>
      <div className="flex w-full items-start gap-3">
        <div
          className={`flex size-9 max-h-9 min-h-9 max-w-9 min-w-9 items-center justify-center rounded-full bg-gradient-to-t text-white ${type === 'like' ? 'from-pink-400 to-pink-600' : 'from-blue-400 to-blue-600'}`}
        >
            ...
            <div className="flex flex-col gap-0.5">
              <div className="leading-tighter font-semibold">
                ...
                <span className="font-normal text-gray-700 dark:text-gray-600">
                  {type === 'like' ? 'liked' : 'reposted'} your post
                </span>
              </div>
          ...
          <div className="flex max-w-[680px] flex-col gap-4">
            <p className="tracking-tight text-gray-700 dark:text-gray-600">
              ...
              <span className="font-semibold text-black dark:text-white">
                like, reply, repost and interact
              </span>{' '}
              with your posts. Their followers will see those interactions too, distributing your
              content even more widely, to a brand new audience.
            </p>
            <p className="tracking-tight text-gray-700 dark:text-gray-600">
              Best of all, you get realtime feedback and visibility when something you published is
              spreading fast across the social web.
            </p>
          </div>
        </div>
        <Button
          ...
          <div className="relative mx-auto h-[694px] w-full max-w-xl rounded-2xl border border-gray-200/70 bg-white shadow-xl dark:border-gray-900 dark:bg-[#101114] dark:shadow-xl dark:shadow-[#1e1b4b]/10">
            ...
            <div className="flex h-full flex-col items-stretch gap-6 p-8">
              <Reply
                ...
                timestamp="just now"
              >
                This resonates with me on so many levels. Especially the part about the difficulty
                of challenges that you can&apos;t anticipate!
              </Reply>
              <Separator />
              <Reaction names="The Verge and 22 others" timestamp="Just now" type="like">
                <div className="isolate flex items-center">
                  <Avatar className="z-30 size-9 border border-white">
                    ...
                    <AvatarFallback className="bg-[#BAB890] font-semibold text-white">
                      TV
                    </AvatarFallback>
                  </Avatar>
              ...
              <Reaction names="Flipboard and 4 others" timestamp="Yesterday" type="repost">
                <div className="isolate flex items-center">
                  <Avatar className="z-50 size-9 border border-white">
                    ...
                    <AvatarFallback className="bg-yellow font-semibold text-white">
                      CN
                    </AvatarFallback>
                  </Avatar>
