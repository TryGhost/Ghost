...
export const EmptyViewIcon: React.FC<{children?: ReactNode}> = ({children}) => {
    return (
        <div className='dark:bg-gray-925/70 flex max-h-12 max-w-12 grow-0 items-center justify-center rounded-full bg-gray-100 p-3 text-gray-700 [&_svg]:size-8 [&_svg]:stroke-1'>
            {children}
        </div>
    );
};
