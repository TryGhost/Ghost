...
const APAvatar: React.FC<APAvatarProps> = ({
  author,
  size,
  isLoading = false,
  disabled = false,
  ...
  let imageClass =
    'z-10 object-cover rounded-full outline-[0.5px] outline-offset-[-0.5px] outline-black/10';
  ...
  if (iconUrl) {
    return (
      <div className={containerClass} onClick={size === 'lg' || disabled ? undefined : handleClick}>
        <img
  ...
  return (
    <div className={containerClass} onClick={disabled ? undefined : handleClick}>
