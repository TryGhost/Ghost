...
export default Model.extend(Comparable, ValidationEngine, {
    ...
    paywallPitch: attr('string'),
    paywallHeading: attr('string'),
    paywallButtonText: attr('string'),
    paywallButtonUrl: attr('string'),
    emailBypassPaywall: attr('boolean', {defaultValue: false}),
    html: attr('string'),
