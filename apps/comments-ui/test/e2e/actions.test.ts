...
test.describe('Actions', async () => {
    ...
    // Note: Tests for "loads all replies when opening form" were removed.
    // We now refetch replies on submit instead of on form open,
    // ensuring concurrent replies from other users are visible after submission.
