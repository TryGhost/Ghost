...
test.describe('Threads', async () => {
  test('links to a focused thread at the maximum depth', async ({ page }) => {
  ...
  test('uses a lower maximum thread depth on mobile', async ({ page }) => {
    const mockedApi = new MockedApi({});
    mockedApi.setMember({});
  ...
  test('highlights a nested comment in the main list when linked', async ({ page }) => {
    const mockedApi = new MockedApi({});
    mockedApi.setMember({});
