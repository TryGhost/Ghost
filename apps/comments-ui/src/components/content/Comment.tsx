        ...
        <CommentLayout avatar={avatar} hasReplies={hasReplies}>
            <div className="mt-[-3px] flex items-start">
                <div className="flex h-10 flex-row items-center gap-4 pb-[8px] pr-4">
                    <p className="text-md mt-[4px] font-sans italic leading-normal text-[rgba(0,0,0,0.2)] sm:text-[1.6rem] dark:text-[rgba(255,255,255,0.35)]">{notPublishedMessage}</p>
...
const AuthorName: React.FC<{comment: Comment}> = ({comment}) => {
    ...
    return (
        <h4 className="text-[rgb(23,23,23] font-sans text-base font-bold leading-snug sm:text-[1.35rem] dark:text-[rgba(255,255,255,0.85)]">
            {name}
        </h4>
    );
};
    ...
    return (
        <div className="mb-2 mt-[-3px] flex items-start">
            <div>
                ...
                <div className="flex items-baseline pr-4 font-sans text-base leading-snug text-[rgba(0,0,0,0.5)] sm:text-[1.35rem] dark:text-[rgba(255,255,255,0.5)]">
                    <span>
...
const CommentBody: React.FC<{html: string}> = ({html}) => {
    ...
    return (
        <div className="mt mb-2 flex flex-row items-center gap-4 pr-4">
            <p dangerouslySetInnerHTML={dangerouslySetInnerHTML} className="gh-comment-content text-md text-pretty font-sans leading-normal text-neutral-900 [overflow-wrap:anywhere] sm:text-[1.6rem] dark:text-[rgba(255,255,255,0.85)]" data-testid="comment-content"/>
        </div>
    );
};
