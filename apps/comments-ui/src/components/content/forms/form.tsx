...
const FormWrapper: React.FC<FormWrapperProps> = ({
    ...
    return (
        <div className={`${replyLayout ? '' : '-mx-2 mt-[-10px]'} rounded-md transition duration-200 ${isOpen ? 'cursor-default' : 'cursor-pointer'}`}>
            <div className="relative w-full" onClick={focusEditor}>
                ...
                <div className={`absolute left-0 flex h-11 w-full items-start justify-start sm:h-12 ${replyLayout ? 'top-0' : 'top-1'}`}>
