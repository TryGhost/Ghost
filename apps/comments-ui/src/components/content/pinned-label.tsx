  ...
  if (isAdmin) {
    ...
    return (
      <button
        ...
        className={`${labelClassName} group hover:border-amber-400 hover:bg-amber-100 dark:hover:border-amber-400/50 dark:hover:bg-amber-400/20`}
        data-testid="pinned-comment-label"
        type="button"
      ...
      >
        <span className="grid size-3 shrink-0">
          <PinIcon
            aria-hidden="true"
            className="col-start-1 row-start-1 size-3 group-hover:opacity-0 group-focus-visible:opacity-0"
          />
          <PinOffIcon
            aria-hidden="true"
            className="col-start-1 row-start-1 size-3 opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100"
          />
        </span>
