    ...
    <button
      ...
      className={`duration-50 group flex cursor-pointer items-center gap-1.5 font-sans text-base outline-0 transition-all ease-linear sm:text-sm ${
        comment.liked
          ...
          : 'text-black/50 hover:text-black/75 dark:text-white/60 dark:hover:text-white/75'
      }`}
        ...
        className={
          ...
          ` h-4 w-4 ${
            comment.liked
              ...
              : 'stroke-black/50 group-hover:stroke-black/75 dark:stroke-white/60 dark:group-hover:stroke-white/75'
