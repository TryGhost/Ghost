...
import {isLastComment} from '../../../utils/helpers';
...
const MoreButton: React.FC<Props> = ({comment, toggleEdit}) => {
    ...
    const lastComment = isLastComment(pagination, comments, comment);
    ...
    return (
        <div data-testid="more-button">
            ...
            {isContextMenuOpen ? <CommentContextMenu close={closeContextMenu} comment={comment} isLastComment={lastComment} toggleEdit={toggleEdit} /> : null}
        </div>
    );
};
