  ...
  return (
    ...
    >
      <div className="flex h-full flex-col justify-center pt-10 sm:justify-normal sm:pt-0">
        ...
        <p className="px-4 font-sans text-md leading-9 text-black sm:pl-0 sm:pr-4">
          {t('Once deleted, this comment can’t be recovered.')}
        </p>
        <div className="mt-auto flex flex-col items-center justify-start gap-4 sm:mt-8 sm:flex-row">
          ...
          >
            <span className="invisible whitespace-nowrap">
              {defaultButtonText}
              <br />
              <span className="flex h-[44px] items-center justify-center whitespace-nowrap">
                {buttonIcon1}
                {t('Deleting')}
              </span>
              <br />
            ...
            <span className="absolute flex h-[44px] items-center justify-center whitespace-nowrap">
              {buttonIcon}
              {buttonText}
            </span>
          </button>
          <button
            className="h-[44px] w-full px-2 font-sans text-md font-medium text-neutral-500 dark:text-neutral-400 sm:w-fit"
            type="button"
            onClick={close}
          >
            {t('Cancel')}
