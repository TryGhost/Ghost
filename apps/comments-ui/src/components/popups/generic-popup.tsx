    ...
    <Transition appear={true} show={show}>
      <PopupFrame title={title}>
        <div>
          ...
          >
            <div
              className="to-rgba(0,0,0,0.1) fixed left-0 top-0 flex h-screen w-screen justify-center overflow-hidden bg-gradient-to-b from-[rgba(0,0,0,0.2)] pt-0 backdrop-blur-[2px] sm:pt-[4vmin]"
              onMouseDown={close}
            >
              <Transition.Child
