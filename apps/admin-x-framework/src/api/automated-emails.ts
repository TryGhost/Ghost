...
export const useAddAutomatedEmail = createMutation<
  AutomatedEmailsResponseType,
  Partial<AutomatedEmail>
>({
  method: 'POST',
  path: () => '/automated_emails/',
...
export const useEditAutomatedEmailSenders = createMutation<
  AutomatedEmailsEditSendersResponseType,
  EditAutomatedEmailSendersPayload
>({
  method: 'PUT',
...
export const useVerifyAutomatedEmailSender = createMutation<
  AutomatedEmailsVerifyResponseType,
  { token: string }
>({
  method: 'PUT',
...
export const useSendTestWelcomeEmail = createMutation<
  unknown,
...
export const usePreviewWelcomeEmail = createMutation<
  AutomatedEmailsPreviewResponseType,
