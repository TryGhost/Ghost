...
import { Meta, createQueryWithId, createMutation, createInfiniteQuery } from '../utils/api/hooks';
...
export type TagEditableData = Partial<
  Omit<Tag, 'id' | 'url' | 'count' | 'created_at' | 'updated_at'>
>;
