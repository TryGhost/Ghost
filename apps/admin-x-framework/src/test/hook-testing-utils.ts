 ...
 */
export const mockLoading = <T>(mockFn: any): UseQueryResult<T> =>
  mockApiHook<T>(mockFn, undefined, true);
 ...
 * @returns The configured mock result
 */
export const mockSuccess = <T>(mockFn: any, data: T): UseQueryResult<T> =>
  mockApiHook<T>(mockFn, data, false);
 ...
 * @returns The configured mock result
 */
export const mockError = <T>(mockFn: any, error: Error): UseQueryResult<T> =>
 ...
 * @returns The configured mock result
 */
export const mockNull = <T>(mockFn: any): UseQueryResult<T> =>
  mockApiHook<T>(mockFn, undefined, false);
