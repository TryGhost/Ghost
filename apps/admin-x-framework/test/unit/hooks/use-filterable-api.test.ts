...
describe('useFilterableApi', () => {
  ...
  it('loads data without filter', async () => {
    ...
    const { result } = renderHook(() =>
      useFilterableApi<TestData, 'users', 'name'>({
        path: '/users',
        filterKey: 'name',
        responseKey: 'users',
      }),
  ...
  it('loads data with filter', async () => {
    const mockData: TestData[] = [{ id: '1', name: 'John Doe', email: 'john@example.com' }];
  ...
  it('loads initial values', async () => {
    ...
    const specificData: TestData[] = [{ id: '3', name: 'Bob Johnson', email: 'bob@example.com' }];
  ...
  it('handles missing values in loadInitialValues', async () => {
    const allData: TestData[] = [{ id: '1', name: 'John Doe', email: 'john@example.com' }];
    ...
    expect(initialValues).toEqual([{ id: '1', name: 'John Doe', email: 'john@example.com' }]);
  });
  ...
  it('handles case-insensitive filtering', async () => {
    ...
    expect(filteredData).toEqual([{ id: '2', name: 'jane smith', email: 'jane@example.com' }]);
  });

  it('makes new API call when filter changes', async () => {
    const mockData1: TestData[] = [{ id: '1', name: 'John Doe', email: 'john@example.com' }];

    const mockData2: TestData[] = [{ id: '2', name: 'Jane Smith', email: 'jane@example.com' }];
  ...
  describe('concurrent requests', () => {
    it('handles concurrent loadData calls correctly', async () => {
      const mockData1: TestData[] = [{ id: '1', name: 'First Result' }];
      const mockData2: TestData[] = [{ id: '2', name: 'Second Result' }];
