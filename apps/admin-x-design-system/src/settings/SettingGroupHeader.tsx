        ...
        <div className="flex items-start justify-between gap-4">
            {(title || description) &&
                <div>
                    ...
                    {description && <p className="mt-1 hidden max-w-md text-pretty group-[.is-not-editing]/setting-group:!visible group-[.is-not-editing]/setting-group:!block md:!visible md:!block">{description}</p>}
                </div>
            }
            <div>
                {children}
