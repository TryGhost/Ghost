...
const SettingNavItem = forwardRef<HTMLLIElement, SettingNavItemProps>(function SettingNavItem({
    ...
    const classNames = clsx(
        'mt-px flex h-[32px] w-100 cursor-pointer items-center rounded-md px-3 py-2 text-left font-medium transition-all hover:bg-grey-200 focus:bg-grey-100 dark:text-grey-600 dark:hover:bg-grey-950 dark:focus:bg-grey-925',
