        ...
        <div className="flex items-start justify-between gap-4">
            {(title || description) &&
                <div>
                    ...
                    {description && <p className="group-[.is-not-editing]/setting-group:visible! group-[.is-not-editing]/setting-group:block! md:visible! md:block! mr-5 mt-1 hidden text-pretty">{description}</p>}
                </div>
            }
            <div>
                {children}
