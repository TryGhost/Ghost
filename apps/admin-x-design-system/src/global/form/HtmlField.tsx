...
const HtmlField: React.FC<HtmlFieldProps> = ({
    ...
    const textFieldClasses = unstyled ? '' : clsx(
        ...
        error ? `border-red` : `hover:bg-grey-100 focus:border-green focus:shadow-[0_0_0_1px_rgba(48,207,67,1)] peer-focus:border-green dark:selection:bg-[rgba(88,101,116,0.99)] dark:hover:bg-grey-925`,
