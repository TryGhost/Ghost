...
const Popover: React.FC<PopoverProps> = ({
    ...
    return (
        <PopoverPrimitive.Root open={open} onOpenChange={setOpen}>
            ...
            <PopoverPrimitive.Content align={position} className="focus:outline-hidden z-[9999] origin-top-right rounded bg-white shadow-md ring-1 ring-[rgba(0,0,0,0.01)] dark:bg-grey-900 dark:text-white"
