...
const Toast: React.FC<ToastProps> = ({
    ...
    const classNames = clsx(
        'relative z-[90] mb-[14px] ml-[6px] flex min-w-[272px] items-start justify-between gap-3 rounded-lg bg-white p-4 text-black shadow-md dark:bg-grey-925 dark:text-white',
