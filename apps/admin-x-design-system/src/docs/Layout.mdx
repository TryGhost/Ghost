...
It's not mandatory but it's advised to use this structure to maintain consistency as much as possible. The components have a bunch of parameters which allows customisation to be used in the current Admin and in future developments.
