...
/** LinkedIn logo with brand-blue square background. Verbatim from share-linkedin.svg. */
export function LinkedInIcon({className}: Props): ReactElement {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 5 2490 2490"
            aria-hidden="true"
            focusable="false"
            className={className}
        >
