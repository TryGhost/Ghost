...
const GhTextHost = createRemoteComponentRenderer(
  forwardRef<HTMLElement, GhTextHostProps>(function GhTextHost(
    { tone = 'default', weight = 'normal', children },
    ref,
  ) {
    return (
      <Text
        ref={ref}
        as="span"
        tone={TEXT_TONES[tone] ?? 'primary'}
        weight={TEXT_WEIGHTS[weight] ?? 'regular'}
      >
        {children}
      </Text>
    );
...
const GhInlineHost = createRemoteComponentRenderer(
  forwardRef<HTMLElement, GhInlineHostProps>(function GhInlineHost(
    { gap = 'sm', justify = 'start', children },
    ref,
  ) {
    return (
      <Inline ref={ref} align="center" className="w-full" gap={gap} justify={justify} wrap>
        {children}
      </Inline>
    );
  }),
...
const GhBadgeHost = createRemoteComponentRenderer(
  forwardRef<HTMLDivElement, GhBadgeHostProps>(
...
const GhHeadingHost = createRemoteComponentRenderer(
  forwardRef<HTMLHeadingElement, GhHeadingHostProps>(function GhHeadingHost(
    { level = 3, children },
    ref,
  ) {
...
const GhSeparatorHost = createRemoteComponentRenderer(
  forwardRef<HTMLDivElement, { className?: string }>(function GhSeparatorHost(_, ref) {
...
const GhStatHost = createRemoteComponentRenderer(
  forwardRef<HTMLDivElement, GhStatHostProps>(function GhStatHost(
...
const GhSparklineHost = createRemoteComponentRenderer(
  forwardRef<HTMLDivElement, GhSparklineHostProps>(function GhSparklineHost(
    { points, label, color = 'blue' },
    ref,
  ) {
...
const GhTabsHost = createRemoteComponentRenderer(
  forwardRef<HTMLDivElement, GhTabsHostProps>(function GhTabsHost(
...
const GhTabHost = createRemoteComponentRenderer(
  forwardRef<HTMLButtonElement, GhTabHostProps>(function GhTabHost({ value, children }, ref) {
    return (
...
const GhButtonHost = createRemoteComponentRenderer(
  forwardRef<HTMLButtonElement, GhButtonHostProps>(function GhButtonHost(
    { variant = 'primary', disabled, onPress, children },
    ref,
  ) {
    return (
      <Button
