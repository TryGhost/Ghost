...
export function AddonInstallPage() {
  ...
  const records = parseInstallRecords(
    getSettingValue<string>(settingsData.settings, ADDONS_SETTING_KEY) ?? '[]',
  );
        ...
        <Card className="w-full max-w-lg">
          <CardHeader className="flex-row items-start gap-4 space-y-0">
            ...
            <div className="flex min-w-0 flex-col gap-1">
              ...
              <Text size="sm" tone="secondary">
                {manifest.publisher ?? 'Unknown publisher'} · from{' '}
          ...
          <CardContent>
            ...
            <Text as="p" size="sm" tone="secondary">
              Only install add-ons from providers you trust. Ghost verifies the code it downloads
              against this release, but the provider controls what future releases do.
            </Text>
