...
You can also deploy a self-hosted version in one-click with [Dome](https://app.trydome.io/signup?package=ghost):

[![Deploy to Dome](https://trydome.io/button.svg)](https://app.trydome.io/signup?package=ghost)
